    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-3">
            <button id="bulkGenerateBtn" type="button"
                    class="inline-flex items-center px-6 py-2 border border-indigo-600 rounded-md shadow-sm text-sm font-medium text-indigo-600 bg-white hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
        ...
        <div class="p-6">
            <form method="GET" action="{{ route('financial.recurring.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end">
                    <button type="submit" 
                            class="w-full inline-flex justify-center items-center px-6 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Apply Filters
                    </button>
                </div>
            </form>
...
<div id="bulkGenerateModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden" style="z-index: 1000;">
    <div class="relative top-20 mx-auto p-8 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-6 text-center">
            <h3 class="text-lg font-medium text-gray-900 mb-6">Bulk Generate Invoices</h3>
            <form id="bulkGenerateForm" method="POST" action="{{ route('financial.recurring.bulk-generate') }}">
                ...
                <div class="px-6 py-6 sm:px-6 sm:flex sm:flex-flex flex-wrap -mx-4-reverse">
                    <button type="submit"
