...
<div class="max-w-7xl mx-auto space-y-6" x-data="templateViewer(@json($template))">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div class="xl:flex-1 px-6-span-2 space-y-6">
            <!-- Tab Navigation -->
            <div class="bg-white border border-gray-200 rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <div x-show="activeTab === 'preview'" class="space-y-6">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <button @click="updatePreview()" 
                                    class="px-6 py-1 text-sm bg-blue-600 text-white rounded hover:bg-blue-700">
                                Update Preview
                            </button>
                        </div>
                    ...
                    <div x-show="activeTab === 'source'">
                        <h3 class="text-lg font-medium text-gray-900 mb-6">Template Clauses</h3>
                        ...
                        @if($template->getVariableFields())
                            <div class="mt-6">
                                <h4 class="font-medium text-gray-900 mb-6">Available Variables</h4>
                    ...
                    <div x-show="activeTab === 'billing'" class="space-y-6">
                        ...
                        @if($template->supportsAssetBilling() && $template->asset_billing_rules)
                            <div>
                                <h4 class="font-medium text-gray-900 mb-6">Asset Billing Rules</h4>
                                <div class="bg-white border border-gray-200 rounded-lg divide-y">
                        ...
                        @if($template->supportsContactBilling() && $template->contact_access_tiers)
                            <div>
                                <h4 class="font-medium text-gray-900 mb-6">Contact Access Tiers</h4>
                                <div class="bg-white border border-gray-200 rounded-lg divide-y">
                        ...
                        @if($template->billing_model !== 'fixed')
                            <div class="bg-gray-50 rounded-lg p-6">
                                <h4 class="font-medium text-gray-900 mb-6">Pricing Calculator</h4>
                    ...
                    <div x-show="activeTab === 'automation'" class="space-y-6">
                        ...
                        <div class="bg-purple-50 border border-purple-200 rounded-lg p-6">
                            ...
                            <p class="text-sm text-purple-700 mb-6">This template includes automated behaviors that trigger when contracts are activated or when new assets/contacts are added to clients.</p>
                        </div>
                        ...
                        <!-- Automation Workflow -->
                        <div class="bg-gray-50 rounded-lg p-6">
                            <h4 class="font-medium text-gray-900 mb-6">Automation Workflow</h4>
                            <div class="space-y-3">
                        ...
                        <div class="bg-gray-50 rounded-lg p-6">
                            ...
                            <div class="bg-gray-800 text-gray-100 p-6 rounded font-mono text-sm overflow-x-auto">
        ...
        <div class="space-y-6">
            <!-- Template Stats -->
            <div class="bg-white border border-gray-200 rounded-lg p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-6">Template Statistics</h3>
                <div class="space-y-3">
            ...
            @if($template->contracts()->count() > 0)
                <div class="bg-white border border-gray-200 rounded-lg p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-6">Recent Contracts</h3>
                    <div class="space-y-3">
                        @foreach($template->contracts()->latest()->take(5)->get() as $contract)
                            <div class="flex items-center justify-between p-6 bg-gray-50 rounded">
                                <div>
            ...
            <!-- Template Info -->
            <div class="bg-white border border-gray-200 rounded-lg p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-6">Template Information</h3>
