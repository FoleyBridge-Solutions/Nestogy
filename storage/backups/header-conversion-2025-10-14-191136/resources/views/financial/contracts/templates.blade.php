                        ...
                        @foreach($templates as $template)
                            <div class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                                <div class="p-6">
                                    ...
                                    <p class="text-sm text-gray-500 mb-6">{{ $template['description'] }}</p>
                                    <div class="flex space-x-2">
                                        <button onclick="alert('Template preview coming soon!')" 
                                                class="flex-1 inline-flex justify-center items-center px-6 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                        ...
                                        <button onclick="alert('Template creation coming soon!')" 
                                                class="flex-1 inline-flex justify-center items-center px-6 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                                            </svg>
                                            Use Template
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="bg-gray-50 border border-gray-200 rounded-lg">
                        <div class="p-6">
                            ...
                            <p class="text-sm text-gray-500 mb-6">Standard MSP service agreement template for general IT services</p>
                            <div class="flex space-x-2">
                                <button onclick="alert('Template preview coming soon!')" 
                                        class="flex-1 inline-flex justify-center items-center px-6 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                    </svg>
                                ...
                                <button onclick="alert('Template creation coming soon!')" 
                                        class="flex-1 inline-flex justify-center items-center px-6 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                                    </svg>
                                    Use Template
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg">
                        <div class="p-6">
                            ...
                            <p class="text-sm text-gray-500 mb-6">IT maintenance and support contract for ongoing services</p>
                            <div class="flex space-x-2">
                                <button onclick="alert('Template preview coming soon!')" 
                                        class="flex-1 inline-flex justify-center items-center px-6 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg">
                        <div class="p-6">
                            ...
                            <p class="text-sm text-gray-500 mb-6">Service level agreement with performance metrics and guarantees</p>
                            <div class="flex space-x-2">
                                <button onclick="alert('Template preview coming soon!')" 
                                        class="flex-1 inline-flex justify-center items-center px-6 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
