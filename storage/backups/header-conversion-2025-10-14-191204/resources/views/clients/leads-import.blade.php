...
@section('content')
<div class="container mx-auto mx-auto px-6 sm:px-6 lg:px-8 py-8">
    <!-- Header -->
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-3">
                    <a href="{{ route('clients.leads.import.template') }}" 
                       class="inline-flex items-center px-6 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700">
        ...
        <form method="POST" action="{{ route('clients.leads.import') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="px-6 py-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <!-- Import Settings -->
                    <div class="flex-1 px-6-span-2 mt-8">
                        <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-6">Import Settings</h4>
                    </div>
            ...
            <!-- Form Actions -->
            <div class="px-6 py-6 bg-gray-50 dark:bg-gray-700 text-right rounded-b-lg">
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('clients.leads') }}" class="inline-flex items-center px-6 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700">
                        Cancel
                    </a>
