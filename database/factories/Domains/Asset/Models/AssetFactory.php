...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Domains\Asset\Models\Asset>
 */
class AssetFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return ['company_id' => Company::factory(),
            ...
            'type' => $type,
            'name' => fn (array $attributes) => $this->generateAssetName($attributes['type']),
            'description' => $this->faker->optional()->sentence(),
            'serial' => strtoupper($this->faker->bothify('??###??###')),
            'make' => fn (array $attributes) => $this->getManufacturer($attributes['type']),
            'model' => fn (array $attributes) => $this->getModel($attributes['type']),
