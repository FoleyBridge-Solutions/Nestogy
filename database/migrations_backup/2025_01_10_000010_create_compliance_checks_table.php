...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('compliance_checks', function (Blueprint $table) {
            ...
            $table->index(['company_id', 'status', 'risk_level'], 'comp_stat_risk_idx');
            $table->index(['contract_id', 'status', 'checked_at'], 'cont_stat_chec_idx');
            $table->index(['compliance_requirement_id', 'status', 'checked_at'], 'compliance_req_status_check_idx');
        });
    }
