...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('subscription_plans', function (Blueprint $table) {
            ...
            // Rename user_limit to match expected column name
            $table->renameColumn('user_limit', 'temp_user_limit');
        });
        
        // Second schema call to handle the rename properly
        Schema::table('subscription_plans', function (Blueprint $table) {
            $table->renameColumn('temp_user_limit', 'user_limit');
        });
    }
