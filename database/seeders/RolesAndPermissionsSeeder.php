...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    private function createAbilities(): void
    {
        ...
        $abilities = [
            ...
            'clients.contacts.create' => 'Create client contacts',
            'clients.contacts.edit' => 'Edit client contacts',
            'clients.contacts.delete' => 'Delete client contacts',
            ...
            'financial.quotes.delete' => 'Delete quotes',
            ...
            'create-campaigns' => 'Create marketing campaigns',
            'edit-campaigns' => 'Edit marketing campaigns',
            'delete-campaigns' => 'Delete marketing campaigns',
            'manage-campaigns' => 'Full campaign management',
            'control-campaigns' => 'Start/stop campaigns',
            'enroll-campaigns' => 'Enroll leads/contacts in campaigns',
            'view-campaign-analytics' => 'View campaign analytics',
            'test-campaigns' => 'Send test campaign emails',
