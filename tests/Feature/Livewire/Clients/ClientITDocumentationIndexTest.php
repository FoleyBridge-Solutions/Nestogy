...
use App\Livewire\Clients\ClientITDocumentationIndex;
...
class ClientITDocumentationIndexTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        Livewire::test(ClientITDocumentationIndex::class)
            ->assertStatus(200);
    }
