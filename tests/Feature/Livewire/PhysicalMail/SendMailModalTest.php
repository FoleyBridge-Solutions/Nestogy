...
namespace Tests\Feature\Livewire\PhysicalMail;

use App\Livewire\PhysicalMail\SendMailModal;
...
class SendMailModalTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        Livewire::test(SendMailModal::class)
            ->assertStatus(200);
    }
