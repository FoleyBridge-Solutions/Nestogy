...
namespace Tests\Feature\Livewire\ContractsTraits;

use App\Livewire\ContractsTraits\HandlesUndoRedo;
...
class HandlesUndoRedoTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        Livewire::test(HandlesUndoRedo::class)
            ->assertStatus(200);
    }
