...
namespace Tests\Feature\Livewire\Email;

use App\Livewire\Email\EmailAccountsIndex;
...
class EmailAccountsIndexTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        Livewire::test(EmailAccountsIndex::class)
            ->assertStatus(200);
    }
