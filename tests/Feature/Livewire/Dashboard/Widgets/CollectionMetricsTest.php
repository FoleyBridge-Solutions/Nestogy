...
namespace Tests\Feature\Livewire\DashboardWidgets;

use App\Livewire\DashboardWidgets\CollectionMetrics;
...
class CollectionMetricsTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        Livewire::test(CollectionMetrics::class)
            ->assertStatus(200);
    }
