...
namespace Tests\Feature\Livewire\Knowledge;

use App\Livewire\Knowledge\KbArticleShow;
...
class KbArticleShowTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        Livewire::test(KbArticleShow::class)
            ->assertStatus(200);
    }
