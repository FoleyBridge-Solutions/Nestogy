...
class ClientRackTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_isolates_by_company(): void
    {
        ...
        $myModel = ClientRack::factory()->create(['company_id' => $this->company->id]);
        $otherModel = ClientRack::factory()->create(['company_id' => $otherCompany->id]);
