...
class EmailMessagePolicyTest extends TestCase
{
    use RefreshDatabase;

    protected EmailMessagePolicy $policy;
    ...
    protected function setUp(): void
    {
        ...
        $this->policy = new EmailMessagePolicy;
    }

    public function test_policy_exists(): void
    {
        $this->assertInstanceOf(EmailMessagePolicy::class, $this->policy);
    }
