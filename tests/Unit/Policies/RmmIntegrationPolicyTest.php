...
use App\Policies\RmmIntegrationPolicy;
use App\Domains\Company\Models\Company;
use App\Domains\Core\Models\User;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Tests\TestCase;

class RmmIntegrationPolicyTest extends TestCase
{
    use RefreshDatabase;

    protected RmmIntegrationPolicy $policy;
    ...
    protected function setUp(): void
    {
        ...
        $this->policy = new RmmIntegrationPolicy;
    }

    public function test_policy_exists(): void
    {
        $this->assertInstanceOf(RmmIntegrationPolicy::class, $this->policy);
    }
