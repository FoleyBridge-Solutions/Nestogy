...
use App\Policies\ClientITDocumentationPolicy;
use App\Domains\Company\Models\Company;
use App\Domains\Core\Models\User;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Tests\TestCase;

class ClientITDocumentationPolicyTest extends TestCase
{
    use RefreshDatabase;

    protected ClientITDocumentationPolicy $policy;
    ...
    protected function setUp(): void
    {
        ...
        $this->policy = new ClientITDocumentationPolicy;
    }
