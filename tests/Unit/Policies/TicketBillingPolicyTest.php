...
use App\Policies\TicketBillingPolicy;
use App\Domains\Company\Models\Company;
use App\Domains\Core\Models\User;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Tests\TestCase;

class TicketBillingPolicyTest extends TestCase
{
    use RefreshDatabase;

    protected TicketBillingPolicy $policy;
    ...
    protected function setUp(): void
    {
        ...
        $this->policy = new TicketBillingPolicy;
    }

    public function test_policy_exists(): void
    {
        $this->assertInstanceOf(TicketBillingPolicy::class, $this->policy);
    }
