...
use App\Policies\PlaidItemPolicy;
use App\Domains\Company\Models\Company;
use App\Domains\Core\Models\User;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Tests\TestCase;

class PlaidItemPolicyTest extends TestCase
{
    use RefreshDatabase;

    protected PlaidItemPolicy $policy;
    ...
    protected function setUp(): void
    {
        ...
        $this->policy = new PlaidItemPolicy;
    }

    public function test_policy_exists(): void
    {
        $this->assertInstanceOf(PlaidItemPolicy::class, $this->policy);
    }
