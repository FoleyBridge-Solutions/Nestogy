...
<div id="loading-overlay" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 z-50 flex items-center justify-center">
    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-xl">
        <div class="flex items-center">
            ...
            <span class="text-gray-700 dark:text-gray-300">Loading reports data...</span>
        </div>
    </div>
</div>
...
<div class="mb-8">
    ...
    <p class="text-gray-600 dark:text-gray-400 mt-2">Comprehensive business intelligence and analytics across all domains</p>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <div class="flex items-center mt-2">
                    <span id="kpi-revenue" class="text-2xl font-bold text-gray-900 dark:text-white">$0</span>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Active Tickets</p>
                <div class="flex items-center mt-2">
                    <span id="kpi-tickets" class="text-2xl font-bold text-gray-900 dark:text-white">0</span>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <div class="flex items-center mt-2">
                    <span id="kpi-sla" class="text-2xl font-bold text-gray-900 dark:text-white">0%</span>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <div class="flex items-center mt-2">
                    <span id="kpi-projects" class="text-2xl font-bold text-gray-900 dark:text-white">0</span>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Ticket Volume</h3>
            <div class="flex items-center space-x-2">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
    ...
    <!-- User Productivity -->
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Team Productivity</h3>
        <div class="h-48">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <a href="{{ route('reports.financial') }}" class="group block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center">
            <div class="p-3 bg-green-100 rounded-full group-hover:bg-green-200 transition-colors duration-200">
                <i class="fas fa-chart-line text-green-600 text-xl"></i>
            </div>
            <div class="ml-4">
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white group-hover:text-indigo-600 transition-colors duration-200">Financial Reports</h4>
                <p class="text-gray-600 dark:text-gray-400 text-sm">Revenue, expenses, and profit analysis</p>
            </div>
        </div>
    </a>

    <a href="{{ route('reports.tickets') }}" class="group block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center">
            <div class="p-3 bg-blue-100 rounded-full group-hover:bg-blue-200 transition-colors duration-200">
                <i class="fas fa-ticket-alt text-blue-600 text-xl"></i>
            </div>
            <div class="ml-4">
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white group-hover:text-indigo-600 transition-colors duration-200">Ticket Analytics</h4>
                <p class="text-gray-600 dark:text-gray-400 text-sm">SLA compliance and performance metrics</p>
            </div>
        </div>
    </a>

    <a href="{{ route('reports.assets') }}" class="group block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white group-hover:text-indigo-600 transition-colors duration-200">Asset Reports</h4>
                <p class="text-gray-600 dark:text-gray-400 text-sm">Maintenance and warranty tracking</p>
            </div>
        </div>
    </a>

    <a href="{{ route('reports.clients') }}" class="group block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center">
            <div class="p-3 bg-purple-100 rounded-full group-hover:bg-purple-200 transition-colors duration-200">
                <i class="fas fa-users text-purple-600 text-xl"></i>
            </div>
            <div class="ml-4">
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white group-hover:text-indigo-600 transition-colors duration-200">Client Reports</h4>
                <p class="text-gray-600 dark:text-gray-400 text-sm">Client analytics and satisfaction</p>
            </div>
        </div>
    </a>

    <a href="{{ route('reports.projects') }}" class="group block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadows duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white group-hover:text-indigo-600 transition-colors duration-200">Project Reports</h4>
                <p class="text-gray-600 dark:text-gray-400 text-sm">Progress and resource utilization</p>
            </div>
        </div>
    </a>

    <a href="{{ route('reports.users') }}" class="group block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white group-hover:text-indigo-600 transition-colors duration-200">User Reports</h4>
                <p class="text-gray-600 dark:text-gray-400 text-sm">Performance and productivity analysis</p>
            </div>
        </div>
    </a>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateRecentActivities(activities) {
        ...
        activities.forEach(activity => {
            ...
            item.className = 'flex items-start space-x-3 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg';
            item.innerHTML = `
