            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-4">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                    <div class="flex flex-wrap -mx-4 items-center">
                        <div class="col">
                            <h3 class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-title mb-0">
                                <i class="fas fa-{{ $asset->icon }} text-gray-600 dark:text-gray-400 mr-2"></i>
                                {{ $asset->name }}
                            </h3>
                            <p class="text-gray-600 dark:text-gray-400 mb-0">{{ $asset->type }} - {{ $asset->make }} {{ $asset->model }}</p>
                        </div>
                        <div class="col-auto">
            ...
            <form action="{{ route('assets.check-in-out', $asset) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3" id="contactSelect" style="{{ $asset->contact_id ? 'display: none;' : '' }}">
                        ...
                        <select name="contact_id" id="contact_id" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="notes" id="notes" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" rows="3" 
