...
<div x-data="pricingSummary()" 
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden border-primary">
        ...
        <div class="p-6">
            ...
            <!-- Total Savings Badge -->
            <div x-show="totalSavings > 0" class="px-4 py-3 rounded bg-green-100 border border-green-400 text-green-700 mt-3 mb-0">
    ...
    <!-- Warning Messages -->
    <div x-show="warnings.length > 0" class="px-4 py-3 rounded bg-yellow-100 border border-yellow-400 text-yellow-700 mt-3">
