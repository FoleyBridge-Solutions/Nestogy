        ...
        'sections' => [
            ...
            [
                ...
                'items' => [
                    ...
                    // [
                    //     'name' => 'Credit Notes',
                    //     'route' => 'financial.credit-notes.index',
                    //     'icon' => 'receipt-refund',
                    //     'key' => 'credit-notes'
                    // ]
                ]
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'route' => 'financial.billing.schedules',
                        'icon' => 'calendar',
                        'key' => 'billing-schedules'
                    ],
                    [
                        'name' => 'Usage Billing',
                        'route' => 'financial.billing.usage',
                        'icon' => 'chart-bar',
                        'key' => 'usage-billing'
                    ]
                ]
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'name' => 'Collections',
                        'route' => 'financial.collections.index',
                        'icon' => 'exclamation-circle',
                        'key' => 'collections',
                        'badge_type' => 'danger'
                    ],
                    [
                        ...
                        'route' => 'financial.invoices.overdue',
                        'icon' => 'clock',
                        'key' => 'overdue',
                        'badge_type' => 'danger'
                    ],
                    [
                        ...
                        'route' => 'financial.reminders.index',
                        'icon' => 'bell',
                        'key' => 'reminders'
                    ]
                ]
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'route' => 'financial.expenses.categories',
                        'icon' => 'tag',
                        'key' => 'expense-categories'
                    ],
                    [
                        'name' => 'Vendors',
                        'route' => 'financial.vendors.index',
                        'icon' => 'building-office',
                        'key' => 'vendors'
                    ],
                    [
                        'name' => 'Purchase Orders',
                        'route' => 'financial.purchase-orders.index',
                        'icon' => 'shopping-cart',
                        'key' => 'purchase-orders'
                    ]
                ]
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'name' => 'Services',
                        'route' => 'financial.services.index',
                        'icon' => 'wrench-screwdriver',
                        'key' => 'services'
                    ],
                    [
                        'name' => 'Pricing Plans',
                        'route' => 'financial.pricing.index',
                        'icon' => 'currency-dollar',
                        'key' => 'pricing'
                    ],
                    [
                        'name' => 'Tax Rates',
                        'route' => 'financial.tax-rates.index',
                        'icon' => 'calculator',
                        'key' => 'tax-rates'
                    ],
                    [
                        'name' => 'Discounts',
                        'route' => 'financial.discounts.index',
                        'icon' => 'receipt-percent',
                        'key' => 'discounts'
                    ]
                ]
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'name' => 'Aging Report',
                        'route' => 'financial.reports.aging',
                        'icon' => 'document-chart-bar',
                        'key' => 'aging-report'
                    ],
                    [
                        'name' => 'Tax Summary',
                        'route' => 'financial.reports.tax',
                        'icon' => 'document-text',
                        'key' => 'tax-summary'
                    ],
                    [
                        'name' => 'Contract Analytics',
                        'route' => 'financial.analytics.contracts',
                        'icon' => 'chart-pie',
                        'key' => 'contract-analytics'
                    ],
                    [
                        'name' => 'Export Data',
                        'route' => 'financial.export.index',
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'route' => 'financial.accounting.chart',
                        'icon' => 'table-cells',
                        'key' => 'chart-accounts'
                    ],
                    [
                        'name' => 'Journal Entries',
                        'route' => 'financial.accounting.journal',
                        'icon' => 'book-open',
                        'key' => 'journal'
                    ],
                    [
                        'name' => 'Bank Reconciliation',
                        'route' => 'financial.accounting.reconciliation',
                        'icon' => 'building-library',
                        'key' => 'reconciliation'
                    ],
                    [
                        'name' => 'QuickBooks Sync',
                        'route' => 'financial.integrations.quickbooks',
                        'icon' => 'arrow-path',
                        'key' => 'quickbooks'
                    ]
                ]
