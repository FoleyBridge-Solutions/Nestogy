        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="relative">
                <button @click="mobileMenuOpen = !mobileMenuOpen" 
                        type="button" 
                        class="w-full flex items-center justify-between py-4 text-sm font-medium text-gray-900 dark:text-gray-100">
                    ...
                    <div class="py-1">
                        @foreach($availableTabs as $key => $tab)
                            <button @click="activeTab = '{{ $key }}'; mobileMenuOpen = false"
                                    ...
                                    class="group flex items-center px-4 py-3 text-sm font-medium w-full text-left hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
