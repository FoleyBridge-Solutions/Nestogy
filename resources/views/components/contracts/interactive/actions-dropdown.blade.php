...
<div class="relative" x-data="{ open: false }">
    <button @click="open = !open" 
            type="button" 
            class="inline-flex items-center px-6 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            aria-expanded="false">
        ...
        <div class="py-1">
            ...
            @if($contract->canBeEdited())
                <a href="{{ route('financial.contracts.edit', $contract) }}" 
                   class="group flex items-center px-6 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
            ...
            @if($contract->status === 'draft' || $contract->status === 'under_negotiation')
                <button type="button" 
                        ...
                        class="group flex w-full items-center px-6 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                    <svg class="mr-3 h-4 w-4 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if($contract->canBeTerminated())
                ...
                <button type="button" 
                        ...
                        class="group flex w-full items-center px-6 py-2 text-sm text-red-700 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors">
