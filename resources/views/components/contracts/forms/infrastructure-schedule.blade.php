<div class="space-y-8">
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="mb-8">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-6">Supported Asset Types</label>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <template x-for="assetType in availableAssetTypes" :key="assetType.value">
                    <div class="relative">
                        <label class="flex items-center p-6 border border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700"
        ...
        <div class="mb-8">
            <h5 class="text-md font-medium text-gray-900 dark:text-white mb-6">Service Level Agreements</h5>
            
            <!-- Service Tier Selection -->
            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-6">Service Tier</label>
            ...
            <div x-show="infrastructureSchedule.sla.serviceTier" class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                <h6 class="text-sm font-medium text-gray-900 dark:text-white mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="text-center p-6 bg-white dark:bg-gray-800 rounded border">
        ...
        <!-- Coverage Rules -->
        <div class="mb-8">
            <h5 class="text-md font-medium text-gray-900 dark:text-white mb-6">Coverage Rules & Conditions</h5>
            <div class="space-y-4">
                ...
                <div>
                    <label class="flex items-center space-x-3">
                        <input type="checkbox" 
                               x-model="slaTerms.auto_assign_new_assets"
        ...
        <div>
            <h5 class="text-md font-medium text-gray-900 dark:text-white mb-6">Exclusions</h5>
            <div class="space-y-3">
                <div>
