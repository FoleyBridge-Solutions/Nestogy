<div class="max-w-6xl mx-auto">
    ...
    <div class="space-y-8">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Automatic Asset Assignment</h4>
            
            <div class="space-y-6">
                <!-- Auto Assignment Settings -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Assignment Options</h5>
                        <div class="space-y-3">
                            <label class="flex items-center space-x-3">
                                <input type="checkbox" x-model="billingConfig.auto_assign_assets" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="text-sm text-gray-700 dark:text-gray-300">Auto-assign existing client assets</span>
                            </label>
                            <label class="flex items-center space-x-3">
                                <input type="checkbox" x-model="billingConfig.auto_assign_new_assets" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                    ...
                    <div>
                        <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Approval Requirements</h5>
                        <div class="space-y-3">
                            <label class="flex items-center space-x-3">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Asset Assignment Preview</h4>
