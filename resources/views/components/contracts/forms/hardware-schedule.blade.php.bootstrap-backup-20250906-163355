...
<div class="space-y-8">
    ...
    <div class="bg-green-50 dark:bg-green-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800">
        ...
        <div class="mt-6 p-4 bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
            <h5 class="font-medium text-gray-900 dark:text-gray-100 mb-3">Installation SLA</h5>
    ...
    <div class="bg-orange-50 dark:bg-orange-900/20 rounded-xl p-6 border border-orange-200 dark:border-orange-800">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select x-model="hardwareSchedule.pricing.markupModel" 
                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-orange-500 mb-4">
                ...
                <div class="mt-4">
                    ...
                    <div class="space-y-2">
                        <template x-for="(tier, index) in hardwareSchedule.pricing.volumeTiers" :key="index">
                            <div class="flex items-center space-x-3 bg-white dark:bg-gray-700 p-3 rounded-lg border border-gray-200 dark:border-gray-600">
        ...
        <!-- Payment Terms -->
        <div class="mt-6 p-4 bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
            <h5 class="font-medium text-gray-900 dark:text-gray-100 mb-3">Payment Terms</h5>
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                <div>
