            ...
            <div>
                ...
                <div class="relative">
                    <input type="number" 
                           ...
                           min="1" max="1000"
                           class="w-full px-6 py-6 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" x-model="telecomSchedule.carrier.primary" 
                       ...
                       class="w-full px-6 py-6 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-purple-500">
            </div>
