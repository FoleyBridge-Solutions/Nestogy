...
<div class="space-y-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <template x-for="framework in complianceFrameworks" :key="framework.value">
                        <div class="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-6">
                            ...
                            <div x-show="complianceSchedule.selectedFrameworks.includes(framework.value)" 
                                 x-transition class="mt-6 pt-3 border-t border-gray-200 dark:border-gray-600">
            ...
            <div>
                ...
                <select x-model="complianceSchedule.scope" 
                        class="w-full px-6 py-6 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 mb-6">
    ...
    <div class="bg-red-50 dark:bg-red-900/20 rounded-xl p-6 border border-red-200 dark:border-red-800">
        <h4 class="text-lg font-semibold text-red-900 dark:text-red-100 mb-6 flex items-center">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select x-model="complianceSchedule.response.criticalTime" 
                                class="w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-red-500">
