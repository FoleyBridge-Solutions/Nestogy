<div class="space-y-8">
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="mb-8">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">Billing Model</label>
        ...
        <div class="mb-8">
            <h5 class="text-md font-medium text-gray-900 dark:text-white mb-4">Base Pricing Structure</h5>
        ...
        <div x-show="getScheduleType() === 'infrastructure' && ['per_asset', 'tiered'].includes(pricingSchedule.billingModel)" class="mb-8">
            <h5 class="text-md font-medium text-gray-900 dark:text-white mb-4">Asset Type Pricing</h5>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Set pricing for asset types configured in Schedule A - Infrastructure coverage.</p>
            <div class="space-y-4">
        ...
        <div x-show="getScheduleType() === 'telecom'" class="mb-8">
            <h5 class="text-md font-medium text-gray-900 dark:text-white mb-4">Telecommunications Service Pricing</h5>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Set pricing for telecommunications services configured in Schedule A.</p>
            ...
            <div class="space-y-4">
                ...
                <div x-show="telecomSchedule.emergencyServices === 'enabled'" class="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
        ...
        <div x-show="getScheduleType() === 'hardware'" class="mb-8">
            <h5 class="text-md font-medium text-gray-900 dark:text-white mb-4">Hardware & Services Pricing</h5>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Set pricing for hardware categories and services configured in Schedule A.</p>
            ...
            <div class="space-y-4">
                ...
                <div x-show="Object.values(hardwareSchedule.services).some(service => service)" class="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                    <h6 class="text-sm font-medium text-gray-900 dark:text-white mb-3">Professional Services Rates</h6>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div x-show="getScheduleType() === 'compliance'" class="mb-8">
            <h5 class="text-md font-medium text-gray-900 dark:text-white mb-4">Compliance Framework Pricing</h5>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Set pricing for compliance frameworks and services configured in Schedule A.</p>
            ...
            <div class="space-y-4">
                ...
                <div x-show="Object.values(complianceSchedule.audits).some(audit => audit)" class="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                    <h6 class="text-sm font-medium text-gray-900 dark:text-white mb-3">Audit Services</h6>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div x-show="['per_user', 'tiered'].includes(pricingSchedule.billingModel)" class="mb-8">
            <h5 class="text-md font-medium text-gray-900 dark:text-white mb-4">User Pricing</h5>
            <div class="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <div>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <input type="number" 
                               ...
                               step="0.01"
                               placeholder="0.00"
                               class="w-24 px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        ...
        <!-- Payment Terms -->
        <div class="mb-8">
            <h5 class="text-md font-medium text-gray-900 dark:text-white mb-4">Payment Terms</h5>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
