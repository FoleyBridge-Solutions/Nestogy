...
<div class="space-y-6">
        ...
        <div x-show="titleSuggestions.length > 0" x-transition class="mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg max-h-48 overflow-y-auto">
            <template x-for="suggestion in titleSuggestions" :key="suggestion">
                <div @click="form.title = suggestion; titleSuggestions = []" 
                     class="px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer text-sm border-b border-gray-100 dark:border-gray-600 last:border-b-0">
    ...
    <div>
        ...
        <select name="contract_type" x-model="form.contract_type" required
                class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">End Date</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">OR Term (Months)</label>
