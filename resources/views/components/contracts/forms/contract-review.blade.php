...
<div class="max-w-6xl mx-auto">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-6">Contract Details</h4>
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-6">
            <h4 class="text-lg font-medium text-blue-900 dark:text-blue-100 mb-6">Contract Schedules Summary</h4>
        ...
        <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-6">Asset Assignment Summary</h4>
            <div class="text-center py-6">
                ...
                <div class="mt-6">
                    ...
                    <span x-show="!slaTerms.auto_assign_new_assets" 
                          class="inline-flex items-center px-6 py-1 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300">
                        Manual assignment
                    </span>
                </div>
                
                <!-- Asset Type Breakdown -->
                <div x-show="typeof getAvailableAssetCount === 'function' && getAvailableAssetCount() > 0 && slaTerms.auto_assign_new_assets" class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-600">
        ...
        <!-- Contract Actions -->
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-6">Contract Creation Options</h4>
            <div class="space-y-4">
                <div class="flex items-center justify-between">
                    ...
                    <select class="px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm dark:bg-gray-700 dark:text-white">
