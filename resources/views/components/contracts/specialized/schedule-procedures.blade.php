...
<div class="space-y-6">
    ...
    @if(!empty($procedures))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Standard Operating Procedures</h4>
            <div class="space-y-4">
    ...
    @if(!empty($protocols))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Communication Protocols</h4>
            <div class="space-y-4">
                @foreach($protocols as $protocolType => $protocol)
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-6">
                        <h5 class="text-lg font-medium text-blue-900 dark:text-blue-100 mb-6">
                            {{ ucwords(str_replace('_', ' ', $protocolType)) }} Protocol
                        </h5>
                        
                        @if(isset($protocol['description']))
                            <p class="text-sm text-blue-700 dark:text-blue-300 mb-6">{{ $protocol['description'] }}</p>
                        @endif
    ...
    @if(!empty($workflowSteps))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Standard Workflows</h4>
            <div class="space-y-6">
                @foreach($workflowSteps as $workflowName => $workflow)
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                        <h5 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-6">
                            {{ ucwords(str_replace('_', ' ', $workflowName)) }}
                        </h5>
                        
                        @if(isset($workflow['description']))
                            <p class="text-sm text-gray-600 dark:text-gray-300 mb-6">{{ $workflow['description'] }}</p>
                        @endif
    ...
    @if(!empty($documentation))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Documentation Requirements</h4>
    ...
    @if(!empty($responsibilities))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Responsibilities Matrix</h4>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach($responsibilities as $task => $responsibility)
                                <tr>
                                    <td class="px-6 py-6 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">
