...
<div class="space-y-6">
    ...
    @if(!empty($pricingStructure))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Base Pricing Structure</h4>
    ...
    @if(!empty($tieredPricing))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Volume-Based Pricing Tiers</h4>
            <div class="space-y-3">
    ...
    @if(!empty($usagePricing))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Usage-Based Pricing</h4>
    ...
    @if(!empty($additionalFees))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Additional Fees</h4>
    ...
    @if(!empty($billingTerms))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Billing Terms & Conditions</h4>
    ...
    @if(isset($contract) && $contract)
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Current Billing Summary</h4>
    ...
    @else
        ...
        <div class="space-y-6">
            <div>
                <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Pricing Schedule Preview</h4>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border border-green-200 dark:border-green-600">
            ...
            <div>
                <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Expected Pricing Components</h4>
            ...
            <div>
                <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Automated Billing Configuration</h4>
                <div class="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-700 rounded-lg p-6">
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-6 flex items-center space-x-4 text-xs text-indigo-600 dark:text-indigo-400">
