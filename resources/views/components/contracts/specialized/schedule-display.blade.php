...
<div class="bg-white dark:bg-gray-800 rounded-lg border {{ $config['borderClass'] }} shadow-sm" 
    ...
    <!-- Schedule Header -->
    <div class="{{ $config['bgClass'] }} px-6 py-4 border-b {{ $config['borderClass'] }}">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                @if($editable && $schedule)
                    <button type="button" 
                            class="inline-flex items-center px-3 py-1.5 border border-transparent text-sm font-medium rounded {{ $config['textClass'] }} hover:bg-white hover:bg-opacity-20 transition-colors">
