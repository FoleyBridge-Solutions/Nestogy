...
<div class="space-y-6">
    ...
    @if(!empty($slaMetrics))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Service Level Metrics</h4>
    ...
    @if(!empty($responseTimeRequirements))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Response Time Requirements</h4>
            <div class="space-y-4">
    ...
    @if(!empty($availabilityRequirements))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Availability Requirements</h4>
    ...
    @if(!empty($escalationProcedures))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Escalation Procedures</h4>
            <div class="space-y-4">
    ...
    @if(!empty($performanceTargets))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Performance Targets</h4>
    ...
    @if($contract)
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Current SLA Compliance</h4>
