<div class="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-700 rounded-lg p-6">
    <h4 class="text-lg font-medium text-purple-900 dark:text-purple-100 mb-4">Additional Terms & Conditions</h4>
    
    <!-- Custom Clauses -->
    <div class="mb-6">
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Custom Contract Clauses</label>
    ...
    <div class="mb-6">
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Compliance Requirements</label>
        <div class="space-y-2">
    ...
    <!-- Termination Terms -->
    <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Termination Notice Period</label>
        <select class="w-full max-w-xs px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 dark:text-white">
