...
<div class="space-y-6">
    ...
    @if(!empty($supportedAssetTypes))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Supported Asset Types</h4>
    ...
    @if(!empty($serviceLevels))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Service Level Definitions</h4>
            <div class="space-y-4">
    ...
    @if(!empty($coverageRules))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Coverage Rules</h4>
    ...
    @if(!empty($excludedAssetTypes))
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Excluded from Support</h4>
    ...
    @if(isset($contract) && $contract)
        <div>
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Current Asset Assignments</h4>
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-right">
                        ...
                        @if($contract->canBeEdited())
                            <button type="button" 
                                    class="mt-2 inline-flex items-center px-3 py-1.5 border border-transparent text-sm font-medium rounded text-blue-700 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/20 hover:bg-blue-200 dark:hover:bg-blue-800/20 transition-colors">
    ...
    @else
        ...
        <div class="space-y-6">
            <div>
                <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Infrastructure Schedule Preview</h4>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="bg-white dark:bg-gray-800 rounded-lg p-3 border border-blue-200 dark:border-blue-600">
            ...
            <div>
                <h4 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Asset Assignment Configuration</h4>
                <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4">
                    <div class="flex items-start space-x-3">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-3 flex items-center space-x-4 text-xs text-yellow-600 dark:text-yellow-400">
