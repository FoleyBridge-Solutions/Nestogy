...
<div x-data="productSelectorAdvanced()" 
     class="product-selector-container w-full"
    ...
    <div x-show="activeTab === 'products'" class="bg-white rounded-lg shadow-sm mb-6">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-1">
                    <button type="button"
                            ...
                            class="inline-flex items-center px-3 py-1 border border-gray-300 text-gray-600 bg-white rounded hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 text-sm"
        ...
        <div class="p-6">
                ...
                <template x-for="product in paginatedProducts" :key="product.id">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow relative">
                        ...
                        <div class="p-4">
                            ...
                            <div class="text-sm text-gray-600 mb-3" x-text="product.description"></div>
                            ...
                            <div class="flex gap-2">
                                <button type="button" @click="showProductDetails(product)"
                                        class="flex-1 inline-flex justify-center items-center px-3 py-2 border border-gray-300 text-gray-600 bg-white rounded hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 text-sm">
                                    <i class="fas fa-info-circle mr-1"></i>Details
                                </button>
                                
                                <button type="button" @click="toggleItem(product, 'product')"
                                        class="flex-1 inline-flex justify-center items-center px-3 py-2 rounded text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2"
            ...
            <div x-show="viewMode === 'list'" class="divide-y divide-gray-200">
                <template x-for="product in paginatedProducts" :key="product.id">
                    {{-- Product List Item --}}
                    <div class="bg-white border-b hover:bg-gray-50 px-4 py-3">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-right ml-4">
                                ...
                                <div class="flex gap-2 mt-2">
                                    ...
                                    <button type="button" @click="toggleItem(product, 'product')"
                                            class="inline-flex items-center px-3 py-1 rounded text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2"
                                            :class="isSelected(product.id, 'product') ? 'bg-blue-600 text-white focus:ring-blue-500' : 'border border-blue-300 text-blue-600 bg-white hover:bg-blue-50 focus:ring-blue-500'">
                                        <i class="fas fa-plus mr-1" x-show="!isSelected(product.id, 'product')"></i>
                                        <i class="fas fa-check mr-1" x-show="isSelected(product.id, 'product')"></i>
                                        <span x-show="!isSelected(product.id, 'product')">Add</span>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow h-full">
                        <div class="p-4">
                            ...
                            <button type="button" @click="toggleItem(service, 'service')"
                                    class="w-full inline-flex justify-center items-center px-4 py-2 rounded text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2"
                    ...
                    <div class="bg-white border-b hover:bg-gray-50 px-4 py-3">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-right ml-4">
                                ...
                                <button type="button" @click="toggleItem(service, 'service')"
                                        class="inline-flex items-center px-3 py-1 rounded text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 mt-2"
                                        :class="isSelected(service.id, 'service') ? 'bg-blue-600 text-white focus:ring-blue-500' : 'border border-blue-300 text-blue-600 bg-white hover:bg-blue-50 focus:ring-blue-500'">
    ...
    {{-- Pagination --}}
    <div x-show="totalPages > 1" class="flex justify-center mt-4">
