        ...
        <div class="p-6">
            ...
            <div x-show="pricing.recurring && (pricing.recurring.monthly > 0 || pricing.recurring.annual > 0)" 
                ...
                <div x-show="pricing.recurring?.monthly > 0" 
                    ...
                    <span class="text-info" x-text="formatCurrency(pricing.recurring.monthly)"></span>
                </div>
                
                <div x-show="pricing.recurring?.annual > 0" 
                     class="d-flex justify-content-between small">
                    <span class="text-muted">Annual (ARR):</span>
                    <span class="text-info" x-text="formatCurrency(pricing.recurring.annual)"></span>
                </div>
            </div>
    ...
    <div x-show="totalSavings > 0" 
        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <span class="text-muted ml-2" x-show="pricing.subtotal > 0">
