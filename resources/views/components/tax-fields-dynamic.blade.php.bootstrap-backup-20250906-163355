...
<div id="tax-fields-container" class="tax-fields-dynamic">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden border-info mb-4">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 bg-gray-100">
            <div class="flex items-center justify-between">
                ...
                <span class="badge bg-gray-600" id="tax-confidence-badge" style="display: none;">Estimated</span>
            </div>
        </div>
        <div class="p-6">
            <div class="flex flex-wrap -mx-4">
                <div class="md:w-2/3 px-4">
                    ...
                    <select class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="tax_customer_select" name="tax_customer_id" required>
                    ...
                    <div class="invalid-feedback">Please select a customer for tax calculation</div>
                </div>
                <div class="md:w-1/3 px-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tax Jurisdiction</label>
                    <div class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-plaintext" id="tax-jurisdiction-display">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden border-primary mb-4" id="tax-profile-card" style="display: none;">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 bg-blue-600 text-white">
            <div class="flex items-center justify-between">
                ...
                <span class="badge bg-gray-100 text-dark" id="tax-engine-badge">Standard</span>
            </div>
        </div>
        <div class="p-6">
            <p class="card-text text-muted mb-3" id="tax-profile-description">
    ...
    <div class="card border-success mb-4" id="tax-calculation-display" style="display: none;">
        <div class="card-header bg-success text-white">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <span class="badge bg-light text-dark" id="tax-engine-type">Calculating...</span>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="tax-summary p-3 bg-light rounded">
            ...
            <div id="tax-breakdown-section" class="mt-4" style="display: none;">
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <h6 class="text-muted mb-0">
                        <i class="fas fa-chart-pie"></i>
                        Tax Breakdown
                    </h6>
                    <button type="button" class="btn btn-sm btn-outline-secondary" id="toggle-breakdown">
...
class DynamicTaxFields {
    ...
    updateJurisdictionDisplay() {
        ...
        if (!customerSelect.value) {
            jurisdictionDisplay.innerHTML = '<span class="text-muted">Select customer first</span>';
        ...
        if (state) {
            ...
            jurisdictionDisplay.innerHTML = '<span class="text-warning">Address incomplete</span>';
            confidenceBadge.style.display = 'inline-block';
    ...
    createFieldHtml(field) {
        ...
        switch (fieldType) {
                ...
                return `
                    <div class="col-md-6 mb-3">
                        <label for="${fieldId}" class="form-label">
                            ...
                            ${fieldHelp ? `<i class="fas fa-info-circle text-muted ml-1" x-data x-tooltip title="${fieldHelp}"></i>` : ''}
                        </label>
                        <input type="number" 
                               class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm tax-field" 
                               id="${fieldId}" 
                        ...
                        <div class="invalid-feedback">Please enter a valid ${fieldLabel.toLowerCase()}</div>
                        ${fieldHelp && !field.tooltip ? `<small id="${fieldId}_help" class="form-text text-muted">${fieldHelp}</small>` : ''}
                    </div>
                `;
                ...
                return `
                    <div class="col-md-12 mb-3">
                        <label class="form-label">
                            ...
                            ${fieldHelp ? `<i class="fas fa-info-circle text-muted ms-1" x-data x-tooltip title="${fieldHelp}"></i>` : ''}
                        </label>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" 
                                       class="form-control tax-field mb-2" 
                                       placeholder="City"
                                       id="${fieldId}_city" 
                        ...
                        ${fieldHelp && !field.tooltip ? `<small class="form-text text-muted">${fieldHelp}</small>` : ''}
                    </div>
                `;
            ...
            default:
                return `
                    <div class="col-md-6 mb-3">
                        <label for="tax_field_${fieldName}" class="form-label">${fieldLabel}</label>
                        <input type="text" 
                               class="form-control tax-field" 
    ...
    showCalculationError(error) {
        ...
        if (engineType) {
            ...
            engineType.className = 'badge bg-light text-danger';
        }
