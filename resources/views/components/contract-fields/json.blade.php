...
<div class="form-group mb-3">
    <label for="{{ $fieldSlug }}" class="form-label">
        ...
        <div class="json-controls float-end">
            <div class="btn-group btn-group-sm">
                <button type="button" class="btn btn-outline-secondary json-mode-btn" data-mode="tree" title="Tree View">
                    <i class="fas fa-sitemap"></i>
                </button>
                <button type="button" class="btn btn-outline-secondary json-mode-btn" data-mode="code" title="Code View">
                    <i class="fas fa-code"></i>
                </button>
                <button type="button" class="btn btn-outline-secondary json-mode-btn" data-mode="form" title="Form View">
                    <i class="fas fa-list"></i>
                </button>
            </div>
            @unless($readonly)
                <button type="button" class="btn btn-outline-success btn-sm ms-2" id="{{ $fieldSlug }}_format" title="Format JSON">
                    <i class="fas fa-indent"></i>
                </button>
                <button type="button" class="btn btn-outline-primary btn-sm" id="{{ $fieldSlug }}_validate" title="Validate JSON">
    ...
    <div class="{{ $containerClass }}" @if($height !== 'auto') style="height: {{ $height }};" @endif>
        ...
        <div class="json-visual-editor" id="{{ $fieldSlug }}_visual" style="{{ $mode === 'code' ? 'display: none;' : '' }}">
            <div class="json-tree-container" id="{{ $fieldSlug }}_tree"></div>
        </div>
            ...
            if (isComplex) {
                ...
                html += `
                    <div class="json-complex-header">
                        ...
                        <span class="json-type-info text-muted">${type}(${count})</span>
                `;
                
                if (!readonly && !isRoot) {
                    html += `<button type="button" class="json-remove-button" title="Remove"><i class="fas fa-times"></i></button>`;
                }
                ...
                if (isArray) {
                    ...
                    if (!readonly) {
                        html += `<button type="button" class="json-add-button" data-type="array" title="Add Item"><i class="fas fa-plus"></i> Add Item</button>`;
                    }
                } else {
                    ...
                    if (!readonly) {
                        html += `<button type="button" class="json-add-button" data-type="object" title="Add Property"><i class="fas fa-plus"></i> Add Property</button>`;
                    }
                }
