...
<div class="form-group mb-3">
    <label for="{{ $fieldSlug }}" class="form-label">
        ...
        @endif
        @if($maxFileSize)
            <small class="text-muted">(Max {{ $maxFileSize }}MB{{ $multiple ? ' each' : '' }})</small>
        @endif
    </label>
    ...
    <div class="file-input-container">
        @if($dragDrop)
            ...
            <div class="file-drop-zone" id="{{ $fieldSlug }}_dropzone">
                <div class="drop-zone-content">
                    ...
                    <button type="button" class="btn btn-outline-primary" id="{{ $fieldSlug }}_browse">
        ...
        @else
            ...
            <div class="input-group">
                <input 
                    ...
                    @if($field['is_required']) required @endif
                />
                <button type="button" class="btn btn-outline-secondary" onclick="document.getElementById('{{ $fieldSlug }}').click()">
        ...
        {{-- File List --}}
        <div class="file-list mt-3" id="{{ $fieldSlug }}_list">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function addFileToList(file, isExisting = false) {
            ...
            fileItem.innerHTML = `
                ...
                <div class="file-actions">
                    ${isExisting && file.url ? `<a href="${file.url}" target="_blank" class="btn btn-sm btn-outline-primary" title="View"><i class="fas fa-eye"></i></a>` : ''}
        ...
        function showError(message) {
            ...
            if (!errorDiv) {
                ...
                errorDiv.className = 'file-upload-error alert alert-danger alert-dismissible fade show mt-2';
