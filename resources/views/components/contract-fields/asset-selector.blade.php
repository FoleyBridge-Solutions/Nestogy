...
<div class="mb-4 mb-6">
    ...
    <div class="asset-selector-container mx-auto">
        <select 
            id="{{ $fieldSlug }}"
            ...
            render: {
                option: function(item, escape) {
                    return `<div class="flex items-center">
                        ...
                        <div class="text-end">
                            ${item.is_online ? '<span class="badge inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium-success">Online</span>' : '<span class="badge inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium-secondary">Offline</span>'}
                        </div>
                    </div>`;
                },
