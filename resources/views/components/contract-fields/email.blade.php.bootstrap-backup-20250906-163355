    ...
    <div class="email-input-container position-relative">
        ...
        @else
            <div class="input-group">
                ...
                />
                @if($showValidation)
                    <span class="input-group-text email-validation-indicator">
                        <i class="fas fa-circle text-muted" id="{{ $fieldSlug }}_indicator"></i>
                    </span>
                @endif
            </div>
        @endif
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateIndicator(valid, hasWarnings = false) {
            ...
            if (valid && !hasWarnings) {
                ...
                indicator.className = 'fas fa-exclamation-triangle text-warning';
            } else {
                indicator.className = 'fas fa-times-circle text-danger';
            }
        }
        ...
        @else
            ...
            function validateSingleEmail() {
                ...
                if (!email) {
                    messagesContainer.innerHTML = '';
                    if (indicator) indicator.className = 'fas fa-circle text-muted';
                    return;
                }
