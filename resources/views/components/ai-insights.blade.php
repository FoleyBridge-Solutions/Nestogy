                ...
                @if(isset($insights['priority']) && $insights['priority'])
                    <div class="ai-section">
                        ...
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                            @if($insights['priority'] === 'high') bg-red-100 text-red-600 dark:bg-red-900 dark:text-red-200
                            @elseif($insights['priority'] === 'medium') bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200
                            @else bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-200
                            @endif">
