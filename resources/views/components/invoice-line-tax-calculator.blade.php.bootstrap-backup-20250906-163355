...
<div id="line-tax-calculator-{{ $lineItem->id ?? 'new' }}" class="line-tax-calculator">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden border-info">
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 bg-gray-100">
                    <h6 class="mb-0">
                        ...
                        Tax Jurisdiction
                        <span class="badge bg-info ml-2" id="tax-jurisdiction-confidence">{{ $customer ? 'Calculated' : 'Unknown' }}</span>
                    </h6>
                </div>
                <div class="p-6 py-2">
                    @if($customer)
    ...
    @if($product && $product->requiresTaxData())
        <div class="bg-white rounded-lg shadow-md overflow-hidden border-primary mb-3">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 bg-blue-600 text-white">
                <h6 class="mb-0">
                    <i class="fas fa-list-check"></i>
                    Tax Calculation Information
                    <span class="badge bg-gray-100 text-dark ml-2">{{ $product->taxProfile->name ?? 'Standard' }}</span>
                </h6>
            </div>
            <div class="p-6">
                    ...
                    @foreach($product->getRequiredTaxFields() as $field)
                        ...
                        @if($fieldType === 'number')
                            <div class="md:w-1/2 px-4 mb-3">
                                ...
                                <input type="number" 
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm line-tax-field" 
                                       id="{{ $fieldId }}" 
