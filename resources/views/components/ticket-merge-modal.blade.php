                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input x-ref="searchInput"
                                   ...
                                   class="block w-full px-3 py-2 pr-10 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:text-white"
                        ...
                        <div x-show="searchQuery.length >= 2 && searchResults.length === 0 && !isSearching" 
                             class="mt-2 text-sm text-gray-500 dark:text-gray-400 text-center py-3">
                    ...
                    <div>
                        ...
                        <textarea x-ref="commentInput"
                                  ...
                                  class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:text-white"></textarea>
