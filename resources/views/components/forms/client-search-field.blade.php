...
<div class="mb-6 {{ $class }}">
    ...
    <div x-data="clientSearchField(@js($selected))" 
         x-init="init()"
         @client-selected.window="$event.detail.source !== '{{ $name }}' || $event.stopPropagation()"
         class="relative">
        ...
        <div x-show="open"
            ...
            <div x-show="loading && !showRecentClients" class="p-8">
                <div class="flex flex-flex-1 px-6 items-center justify-center text-gray-500 dark:text-gray-400">
                    <svg class="animate-spin h-8 w-8 mb-2" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                    <span class="text-sm">Searching clients...</span>
                </div>
            </div>
            ...
            <div x-show="showEmpty" class="p-8">
                <div class="text-center text-gray-500 dark:text-gray-400">
                    ...
                    <p class="text-xs mt-1">or select from recent clients</p>
                </div>
            </div>
            
            <!-- Footer Actions -->
            <div x-show="clients.length > 0 || recentClients.length > 0" 
                 class="border-t border-gray-100 dark:border-gray-600 px-6 py-2 bg-gray-50 dark:bg-gray-700 rounded-b-lg">
