            ...
            <div x-show="showFilters" x-transition class="mt-6">
                <div class="flex flex-wrap -mx-4">
                    ...
                    <div class="flex-1 px-6-md-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="price-range-min">Price Range</label>
    ...
    <div x-show="!loading && activeTab === 'products'">
        ...
        <div x-show="viewMode === 'list'" class="min-w-full divide-y divide-gray-200-responsive">
            <table class="min-w-full divide-y divide-gray-200 [&>tbody>tr:hover]:bg-gray-100">
                <thead>
                    <tr>
                        <th width="30" scope="col-span-12"></th>
                        <th scope="col-span-12">Product</th>
                        <th scope="col-span-12">SKU</th>
                        <th scope="col-span-12">Category</th>
                        <th scope="col-span-12">Billing</th>
                        <th scope="col-span-12">Price</th>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 min-w-full divide-y divide-gray-200 dark:divide-gray-700-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col-span-12">Price</th>
                                    <th scope="col-span-12">Discount</th>
                                </tr>
                            </thead>
                            <tbody>
