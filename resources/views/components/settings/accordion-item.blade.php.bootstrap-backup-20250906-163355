...
<div class="border border-gray-200 rounded-lg" 
    ...
    <button type="button"
            ...
            class="w-full px-4 py-3 flex items-center justify-between hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 rounded-t-lg"
