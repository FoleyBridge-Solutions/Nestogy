        ...
        <div x-show="{{ $show }}"
                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-6 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            ...
                            <div x-show="{{ $results }} && {{ $results }}.details" class="mt-6 text-sm text-gray-600">
                                <dl class="space-y-1">
            ...
            <div class="bg-gray-50 px-6 py-6 sm:px-6 sm:flex sm:flex-flex flex-wrap -mx-4-reverse">
                <button type="button" 
                        ...
                        class="w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-6 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                    Close
                </button>
            </div>
        </div>
