        ...
        <div class="portal-flex-1 px-6-12">
            <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden portal-shadow">
                <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                    <form method="GET" action="{{ route('client.invoices') }}" class="portal-flex portal-items-center space-x-4">
                        <div class="portal-flex-1 px-6-auto">
                        ...
                        <div class="portal-flex-1 px-6-auto">
                            ...
                            <select name="year" id="year" class="portal-block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" onchange="this.form.submit()">
                        ...
                        <div class="portal-flex-1 px-6-auto">
                            <a href="{{ route('client.invoices') }}" class="portal-px-6 py-2 font-medium rounded-md transition-colors portal-border border-gray-600 text-gray-600 hover:bg-gray-50 portal-px-6 py-2 font-medium rounded-md transition-colors-sm">
                                Clear Filters
                            </a>
                        </div>
                        @endif
            ...
            <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden portal-shadow">
                ...
                <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                        ...
                        <table class="portal-min-w-full divide-y divide-gray-200 dark:divide-gray-700 portal-min-w-full">
                            ...
                            <tbody class="portal-divide-y portal-divide-gray-200">
                                ...
                                <tr class="portal-min-w-full divide-y divide-gray-200 dark:divide-gray-700-flex flex-wrap -mx-4">
                                    ...
                                    <td class="px-6 py-6 portal-text-sm portal-font-medium">
                                    ...
                                    <td class="px-6 py-6 portal-text-sm">
                                        <div class="portal-flex space-x-2">
                                            ...
                                            <button type="button" 
                                                    class="portal-px-4 py-2 font-medium rounded-md transition-colors portal-px-6 py-1 text-sm portal-px-6 py-2 font-medium rounded-md transition-colors-outline-success"
                                                    title="Mark as Paid">
                    ...
                    <div class="text-center py-8">
                        ...
                        @if(request('status') || request('year'))
                        <a href="{{ route('client.invoices') }}" class="portal-px-6 py-2 font-medium rounded-md transition-colors portal-px-6 py-2 font-medium rounded-md transition-colors-outline-primary">
                            Clear Filters
                        </a>
                        @endif
                    </div>
