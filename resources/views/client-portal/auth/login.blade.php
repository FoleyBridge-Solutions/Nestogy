...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen flex flex-flex-1 px-6 sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
        <div>
            <a href="/">
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-6 bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            @if ($errors->any())
                <div class="mb-6">
                    ...
                    <ul class="mt-6 list-disc list-inside text-sm text-red-600">
            ...
            <form method="POST" action="{{ route('client.login.submit') }}">
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <button type="submit" class="ml-3 inline-flex items-center px-6 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                        Log in
                    </button>
                </div>
            </form>
