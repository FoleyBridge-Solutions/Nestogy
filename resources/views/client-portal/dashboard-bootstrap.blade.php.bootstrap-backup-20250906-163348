...
<div class="w-full px-4">
    ...
    <div class="flex flex-wrap -mx-4 mb-4">
        <div class="col-12">
            <div class="px-4 py-3 rounded bg-yellow-100 border border-yellow-400 text-yellow-700 alert-dismissible fade show" role="alert">
    ...
    <!-- Statistics Cards -->
    <div class="row mb-4">
        <div class="col-xl-3 md:w-1/2 px-4 mb-4">
    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 py-3 flex justify-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-blue-600">Recent Contracts</h6>
        ...
        <div class="col-xl-4 col-lg-5">
            <!-- Upcoming Milestones -->
            <div class="card shadow mb-4">
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 py-3">
