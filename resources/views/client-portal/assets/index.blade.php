        ...
        <div class="portal-col-12">
            <div class="portal-card portal-shadow">
                <div class="portal-card-body">
                    <form method="GET" action="{{ route('client.assets') }}" class="portal-d-flex portal-align-items-center space-x-4">
                        <div class="portal-col-auto">
                        ...
                        <div class="portal-col-auto">
                            <a href="{{ route('client.assets') }}" class="portal-btn portal-btn-outline-secondary portal-btn-sm">
                                Clear Filters
                            </a>
                        </div>
                        @endif
            ...
            <div class="portal-card portal-shadow">
                ...
                <div class="portal-card-body">
                    ...
                    <div class="text-center py-8">
                        ...
                        @if(request('status') || request('type'))
                        <a href="{{ route('client.assets') }}" class="portal-btn portal-btn-outline-primary">
                            Clear Filters
                        </a>
                        @endif
                    </div>
