...
<body class="font-sans bg-gray-50 dark:bg-gray-900 antialiased" 
    ...
    <nav class="fixed top-0 left-0 h-screen w-64 bg-gradient-to-b from-indigo-600 to-indigo-800 dark:from-gray-800 dark:to-gray-900 overflow-y-auto z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300" 
        ...
        <div class="p-6">
            ...
            <div class="bg-white bg-opacity-10 rounded-lg p-6 mb-6">
                <div class="text-center">
                    <div class="w-12 h-12 bg-white bg-opacity-20 rounded-full mx-auto mb-6 flex items-center justify-center">
            ...
            <nav class="space-y-1">
                ...
                <a class="flex items-center px-6 py-6 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-colors duration-200 {{ request()->routeIs('client.dashboard') ? 'bg-white bg-opacity-20' : '' }}" 
                ...
                <a class="flex items-center px-6 py-6 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-colors duration-200 {{ request()->routeIs('client.contracts*') ? 'bg-white bg-opacity-20' : '' }}" 
                ...
                <a class="flex items-center px-6 py-6 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-colors duration-200 {{ request()->routeIs('client.invoices*') ? 'bg-white bg-opacity-20' : '' }}" 
                ...
                <a class="flex items-center px-6 py-6 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-colors duration-200 {{ request()->routeIs('client.tickets*') ? 'bg-white bg-opacity-20' : '' }}" 
                ...
                <a class="flex items-center px-6 py-6 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-colors duration-200 {{ request()->routeIs('client.quotes*') ? 'bg-white bg-opacity-20' : '' }}" 
                ...
                <a class="flex items-center px-6 py-6 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-colors duration-200 {{ request()->routeIs('client.assets*') ? 'bg-white bg-opacity-20' : '' }}" 
                ...
                <a class="flex items-center px-6 py-6 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-colors duration-200 {{ request()->routeIs('client.projects*') ? 'bg-white bg-opacity-20' : '' }}" 
                ...
                <a class="flex items-center px-6 py-6 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-colors duration-200 {{ request()->routeIs('client.reports*') ? 'bg-white bg-opacity-20' : '' }}" 
                ...
                <a class="flex items-center px-6 py-6 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-colors duration-200 {{ request()->routeIs('client.profile*') ? 'bg-white bg-opacity-20' : '' }}" 
        ...
        <div class="absolute bottom-0 left-0 right-0 p-6">
            <hr class="border-indigo-400 mb-6">
            <div class="text-center">
                <form action="{{ route('client.logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="w-full px-6 py-2 bg-transparent border border-white text-white rounded-lg hover:bg-white hover:text-indigo-600 transition-colors duration-200 touch-manipulation">
    ...
    <div class="lg:ml-64 min-h-screen">
                            ...
                            <div x-show="notificationsOpen"
                                ...
                                <div class="p-6">
                                    @if(isset($notifications) && $notifications->count() > 0)
                                        ...
                                        <a class="block p-6 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors touch-manipulation {{ $notification->is_read ? '' : 'bg-blue-50 dark:bg-blue-900/20' }}" 
        ...
        <main class="p-6">
            <!-- Flash Messages -->
            @if(session('success'))
            <div class="portal-px-6 py-6 rounded mb-6 portal-bg-green-100 border border-green-400 text-green-700 portal-px-6 py-6 rounded mb-6-dismissible portal-fade show" role="alert">
                <i class="fas fa-check-circle"></i> {{ session('success') }}
                <button type="button" class="portal-px-6 py-6 rounded mb-6-close" onclick="this.parentElement.style.display='none'">&times;</button>
            </div>
            @endif

            @if(session('error'))
            <div class="portal-px-6 py-6 rounded mb-6 portal-bg-red-100 border border-red-400 text-red-700 portal-px-6 py-6 rounded mb-6-dismissible portal-fade show" role="alert">
            ...
            @if(session('info'))
            <div class="portal-px-6 py-6 rounded mb-6 portal-bg-cyan-100 border border-cyan-400 text-cyan-700 portal-px-6 py-6 rounded mb-6-dismissible portal-fade show" role="alert">
        ...
        <!-- Footer -->
        <footer class="mt-8 py-6 bg-gray-100 dark:bg-gray-800">
            <div class="w-full px-6">
                <div class="portal-flex flex-wrap -mx-4">
                    <div class="portal-flex-1 px-6-6">
                        <small class="text-gray-600 dark:text-gray-400">
                            © {{ date('Y') }} {{ config('app.name') }}. All rights reserved.
                        </small>
                    </div>
                    <div class="portal-flex-1 px-6-6 portal-md-text-end">
                        <small class="text-gray-600 dark:text-gray-400">
