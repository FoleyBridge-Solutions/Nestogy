...
<div class="portal-container mx-auto mx-auto">
    ...
    <div class="portal-flex flex-wrap -mx-4 portal-mb-6">
        ...
        <!-- Open Tickets -->
        <div class="portal-flex-1 px-6-xl-3 portal-flex-1 px-6-6 portal-mb-6">
            <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-border-danger portal-shadow portal-h-100 portal-py-2">
                <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                    <div class="portal-flex portal-items-center">
                        <div class="portal-flex-1 px-6 portal-mr-2">
                            <div class="portal-text-xs portal-font-bold portal-text-red-600 dark:text-red-400 portal-uppercase portal-mb-1">
                                Open Tickets
                            </div>
                            <div class="portal-h5 portal-mb-0 portal-font-bold portal-text-gray-800">
    ...
    <div class="portal-flex flex-wrap -mx-4 portal-mb-6">
        ...
        <!-- Total Tickets -->
        <div class="portal-flex-1 px-6-xl-3 portal-flex-1 px-6-6 portal-mb-6">
            <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-border-secondary portal-shadow portal-h-100 portal-py-2">
                <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                    <div class="portal-flex portal-items-center">
                        <div class="portal-flex-1 px-6 portal-mr-2">
                            <div class="portal-text-xs portal-font-bold portal-text-gray-600 dark:text-gray-400 portal-uppercase portal-mb-1">
                                Total Tickets
                            </div>
                            <div class="portal-h5 portal-mb-0 portal-font-bold portal-text-gray-800">
        ...
        <div class="portal-w-full px-6 portal-flex-1 px-6-lg-8">
                ...
                <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                    <div class="portal-min-w-full divide-y divide-gray-200 dark:divide-gray-700-responsive">
                        <table class="portal-min-w-full divide-y divide-gray-200 dark:divide-gray-700 portal-min-w-full">
                            <thead>
                                <tr>
                                    <th class="px-6 py-6 text-left portal-text-xs portal-font-medium text-gray-500 portal-uppercase">Contract</th>
                                    <th class="px-6 py-6 text-left portal-text-xs portal-font-medium text-gray-500 portal-uppercase">Type</th>
                                    <th class="px-6 py-6 text-left portal-text-xs portal-font-medium text-gray-500 portal-uppercase">Status</th>
                                    <th class="px-6 py-6 text-left portal-text-xs portal-font-medium text-gray-500 portal-uppercase">Value</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if(isset($contracts) && count($contracts) > 0)
                                    ...
                                    <tr>
                                        <td class="px-6 py-6">
                                            ...
                                            <div class="text-gray-600 dark:text-gray-400 portal-text-xs">{{ $contract->contract_number }}</div>
                                        </td>
                                        ...
                                        <td class="px-6 py-6 portal-text-sm">${{ number_format($contract->contract_value, 2) }}</td>
                                    </tr>
                                    @endforeach
                                @else
                                    <tr><td colspan="4" class="px-6 py-6 text-center text-gray-500 portal-text-sm">No contracts available.</td></tr>
                                @endif
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden portal-shadow portal-mb-6">
                <div class="px-6 py-6 portal-border-b portal-bg-gray-50 py-6 portal-flex portal-justify-between portal-items-center">
                    ...
                    <a href="{{ route('client.tickets') ?? '#' }}" class="portal-px-4 py-2 font-medium rounded-md transition-colors portal-px-6 py-1 text-sm portal-px-6 py-2 font-medium rounded-md transition-colors-primary">
                        View All <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
                <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                    <div class="portal-min-w-full divide-y divide-gray-200 dark:divide-gray-700-responsive">
                        <table class="portal-min-w-full divide-y divide-gray-200 dark:divide-gray-700 portal-min-w-full">
                            <thead>
                                <tr>
                                    <th class="px-6 py-6 text-left portal-text-xs portal-font-medium text-gray-500 portal-uppercase">Ticket</th>
                                    <th class="px-6 py-6 text-left portal-text-xs portal-font-medium text-gray-500 portal-uppercase">Subject</th>
                                    <th class="px-6 py-6 text-left portal-text-xs portal-font-medium text-gray-500 portal-uppercase">Priority</th>
                                    <th class="px-6 py-6 text-left portal-text-xs portal-font-medium text-gray-500 portal-uppercase">Status</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if(isset($tickets) && count($tickets) > 0)
                                    ...
                                    <tr>
                                        <td class="px-6 py-6">
                                            ...
                                            <div class="text-gray-600 dark:text-gray-400 portal-text-xs">{{ $ticket->created_at->format('M j, Y') }}</div>
                                        </td>
                                    ...
                                    @endforeach
                                @else
                                    <tr><td colspan="4" class="px-6 py-6 text-center text-gray-500 portal-text-sm">No recent tickets.</td></tr>
                                @endif
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden portal-shadow portal-mb-6">
                <div class="px-6 py-6 portal-border-b portal-bg-gray-50 py-6 portal-flex portal-justify-between portal-items-center">
                    ...
                    <a href="{{ route('client.assets') ?? '#' }}" class="portal-px-4 py-2 font-medium rounded-md transition-colors portal-px-6 py-1 text-sm portal-px-6 py-2 font-medium rounded-md transition-colors-primary">
                        View All <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
                <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                    <div class="portal-min-w-full divide-y divide-gray-200 dark:divide-gray-700-responsive">
                        <table class="portal-min-w-full divide-y divide-gray-200 dark:divide-gray-700 portal-min-w-full">
                            <thead>
                                <tr>
                                    <th class="px-6 py-6 text-left portal-text-xs portal-font-medium text-gray-500 portal-uppercase">Asset</th>
                                    <th class="px-6 py-6 text-left portal-text-xs portal-font-medium text-gray-500 portal-uppercase">Type</th>
                                    <th class="px-6 py-6 text-left portal-text-xs portal-font-medium text-gray-500 portal-uppercase">Status</th>
                                    <th class="px-6 py-6 text-left portal-text-xs portal-font-medium text-gray-500 portal-uppercase">Location</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if(isset($assets) && count($assets) > 0)
                                    ...
                                    <tr>
                                        <td class="px-6 py-6">
                                            ...
                                            <div class="text-gray-600 dark:text-gray-400 portal-text-xs">{{ $asset->make }} {{ $asset->model }}</div>
                                        </td>
                                        ...
                                        <td class="px-6 py-6 portal-text-sm">{{ $asset->location->name ?? 'Not assigned' }}</td>
                                    </tr>
                                    @endforeach
                                @else
                                    <tr><td colspan="4" class="px-6 py-6 text-center text-gray-500 portal-text-sm">No assets available.</td></tr>
                                @endif
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden portal-shadow">
                ...
                <div class="portal-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('client.tickets') ?? '#' }}" class="portal-px-6 py-2 font-medium rounded-md transition-colors portal-w-100 portal-px-6 py-2 font-medium rounded-md transition-colors-outline-primary portal-text-sm">
