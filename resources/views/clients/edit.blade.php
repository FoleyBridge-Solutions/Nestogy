...
<div class="space-y-4">
    <!-- Page Header -->
    <x-page-header 
        :title="'Edit ' . ($client->lead ? 'Lead' : 'Client')"
        :subtitle="'Update ' . $client->name . '\'s information'"
        :back-route="$client->lead ? route('clients.leads') : route('clients.index')"
        :back-label="'Back to ' . ($client->lead ? 'Leads' : 'Clients')"
        :compact="true"
    >
        <x-slot name="actions">
            <a href="{{ route('clients.show', $client) }}" class="inline-flex items-center px-2.5 py-1 text-xs border border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded-md font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 bg-white dark:bg-gray-800 dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900 dark:hover:bg-gray-700 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
    ...
    <x-content-card :compact="true" :no-padding="true">
        <form method="POST" action="{{ route('clients.update', $client) }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="p-6 sm:p-8">
                <!-- Basic Information -->
                <div class="mb-8">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white dark:text-white mb-6">Basic Information</h3>
                            ...
                            <fieldset class="mt-6">
                                <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                                    <div class="flex items-center">
                                        <input id="individual" name="type" type="radio" value="individual" {{ old('type', $client->type) == 'individual' ? 'checked' : '' }} class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 dark:border-gray-600 dark:border-gray-600">
                                    ...
                                    <div class="flex items-center">
                                        <input id="business" name="type" type="radio" value="business" {{ old('type', $client->type) == 'business' ? 'checked' : '' }} class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 dark:border-gray-600 dark:border-gray-600">
                ...
                <!-- Address Information -->
                <div class="mb-8">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white dark:text-white mb-6">Address Information</h3>
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <!-- Billing Information -->
                <div class="mb-8">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white dark:text-white mb-6">Billing Information</h3>
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <!-- Status -->
                        <div>
                ...
                <div class="mb-8">
                    ...
                    <textarea name="notes" id="notes" rows="4" placeholder="Add any additional notes about this {{ $client->lead ? 'lead' : 'client' }}..."
                              class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('notes') border-red-300 @enderror">{{ old('notes', $client->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <!-- Form Actions -->
            <div class="px-6 py-6 bg-gray-50 dark:bg-gray-900 dark:bg-gray-900 text-right sm:px-6 space-x-3">
                <a href="{{ route('clients.show', $client) }}" class="inline-flex justify-center py-2 px-6 border border-gray-300 dark:border-gray-600 dark:border-gray-600 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 dark:text-gray-300 bg-white dark:bg-gray-800 dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900 dark:hover:bg-gray-700 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Cancel
                </a>
