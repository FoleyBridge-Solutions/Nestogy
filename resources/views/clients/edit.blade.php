...
<div class="space-y-4">
                ...
                <div class="mb-8">
                    ...
                    <div class="mt-1 flex items-center space-x-5">
                        ...
                        <div>
                            ...
                            @if($client->avatar)
                            <button type="button" onclick="removeAvatar()" class="ml-3 py-2 px-3 border border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900 dark:hover:bg-gray-700 dark:bg-gray-900">
                                Remove
                            </button>
    ...
    <x-content-card :compact="true">
        <div class="border-l-4 border-red-400 pl-4">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white dark:text-white mb-4">Danger Zone</h3>
