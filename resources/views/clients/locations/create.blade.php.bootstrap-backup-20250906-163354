        ...
        <div class="bg-white shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:px-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Add Location for {{ $client->name }}</h3>
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">Create a new location for {{ $client->name }}.</p>
                    </div>
                    <div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea name="description" 
                                          ...
                                          placeholder="Optional description of this location">{{ old('description') }}</textarea>
                            </div>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
