        ...
        <div class="px-4 py-5 sm:px-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-3">
                    ...
                    @if($currentClient)
                        <a href="{{ route('clients.clear-selection') }}" class="inline-flex items-center px-4 py-2 border border-red-300 rounded-md shadow-sm text-sm font-medium text-red-700 bg-white dark:bg-gray-800 hover:bg-red-50">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    @if($currentClient)
        <div class="bg-blue-50 border border-blue-200 rounded-lg">
            <div class="px-4 py-5 sm:px-6">
                ...
                <div class="flex items-center justify-between bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-blue-100">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        ...
        <div class="divide-y divide-gray-200">
            @forelse($clients->where('id', '!=', $currentClient?->id ?? 0) as $client)
                <div class="px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900 cursor-pointer client-flex flex-wrap -mx-4" 
