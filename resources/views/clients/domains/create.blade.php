                        ...
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <select id="tld" 
                                        name="tld" 
                                        required
                                        class="mt-1 block w-full py-2 px-6 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('tld') border-red-300 @enderror">
                    ...
                    <div class="pt-8">
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <select id="registrar" 
                                        name="registrar" 
                                        class="mt-1 block w-full py-2 px-6 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('registrar') border-red-300 @enderror">
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <select id="dns_provider" 
                                        name="dns_provider" 
                                        class="mt-1 block w-full py-2 px-6 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('dns_provider') border-red-300 @enderror">
