    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:px-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Import Clients</h1>
                    <p class="mt-1 text-sm text-gray-500">Upload a CSV file to import multiple clients at once</p>
                </div>
                <div>
                    <a href="{{ route('clients.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
    ...
    <div class="bg-white shadow rounded-lg">
        <form method="POST" action="{{ route('clients.import') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="skip_duplicates" class="font-medium text-gray-700">Skip duplicate emails</label>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="update_existing" class="font-medium text-gray-700">Update existing clients</label>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="import_as_leads" class="font-medium text-gray-700">Import all as leads</label>
                ...
                <!-- Sample CSV Download -->
                <div class="mt-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Need a template?</h3>
                    <p class="text-sm text-gray-500 mb-3">Download our sample CSV file to see the correct format</p>
                    <a href="{{ route('clients.import.template') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6 space-x-3">
                <a href="{{ route('clients.index') }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Cancel
                </a>
