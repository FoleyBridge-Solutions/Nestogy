        ...
        <div class="px-4 py-5 sm:px-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-3">
                    <a href="{{ route('clients.import.form') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 bg-white dark:bg-gray-800 dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900 dark:hover:bg-gray-700 dark:bg-gray-900">
    ...
    <div class="bg-white dark:bg-gray-800 dark:bg-gray-800 shadow rounded-lg">
        <div class="border-b border-gray-200 dark:border-gray-700 dark:border-gray-700">
            <nav class="-mb-px flex space-x-8 px-6" aria-label="Tabs">
                <a href="{{ route('clients.index') }}" class="{{ !request('lead') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600 dark:border-gray-600' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                    Customers
                </a>
                <a href="{{ route('clients.leads') }}" class="{{ request('lead') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600 dark:border-gray-600' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                    Leads
                </a>
            </nav>
        </div>
        ...
        <div class="px-4 py-5 sm:px-6 border-b border-gray-200 dark:border-gray-700 dark:border-gray-700">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    <!-- Export -->
                    <a href="{{ route('clients.export.csv', ['lead' => request('lead')]) }}" class="inline-flex items-center px-3 py-2 border border-gray-300 dark:border-gray-600 dark:border-gray-600 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 dark:text-gray-300 dark:text-gray-300 bg-white dark:bg-gray-800 dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900 dark:hover:bg-gray-700 dark:bg-gray-900">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800 dark:bg-gray-800">
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    @else
                        ...
                        html += '<a href="/clients/' + row.id + '" class="text-gray-600 dark:text-gray-400 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white dark:text-white dark:hover:text-white dark:text-white">View</a>';
                    @endif
