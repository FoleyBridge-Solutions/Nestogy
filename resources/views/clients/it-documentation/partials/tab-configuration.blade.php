            ...
            <div class="bg-white px-6 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    <div class="mt-6 text-center sm:mt-0 sm:text-left w-full">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <button type="button" @click="enabledTabs = ['general']; showTabConfig = false; activeTab = 'general'"
                                        class="px-6 py-1 text-xs bg-gray-100 hover:bg-gray-200 rounded-md">
                                ...
                                <button type="button" @click="enabledTabs = ['general', 'technical', 'procedures']; showTabConfig = false; activeTab = 'general'"
                                        class="px-6 py-1 text-xs bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-md">
                                    Basic Documentation
                                </button>
                                <button type="button" @click="enabledTabs = ['general', 'technical', 'procedures', 'network', 'testing']; showTabConfig = false; activeTab = 'general'"
                                        class="px-6 py-1 text-xs bg-green-100 hover:bg-green-200 text-green-700 rounded-md">
                                    Standard Documentation
                                </button>
                                <button type="button" @click="enabledTabs = Object.keys(availableTabs); showTabConfig = false; activeTab = 'general'"
                                        class="px-6 py-1 text-xs bg-purple-100 hover:bg-purple-200 text-purple-700 rounded-md">
                                    Enable All Tabs
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 p-6 bg-blue-50 rounded-md" x-show="formData.it_category">
