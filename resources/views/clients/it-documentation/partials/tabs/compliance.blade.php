<div class="space-y-6">
    ...
    <div>
        <label class="block text-sm font-medium text-gray-700 mb-6">Applicable Compliance Frameworks</label>
    ...
    <div x-show="complianceRequirements.length > 0">
        ...
        <div class="space-y-2">
            <template x-for="(req, index) in complianceRequirements" :key="index">
                <div class="border border-gray-200 rounded p-6" :class="req.auto_generated ? 'bg-blue-50' : 'bg-white'">
    ...
    <!-- Security Controls -->
    <div>
        <label class="block text-sm font-medium text-gray-700 mb-6">Security Controls</label>
    ...
    <div class="mt-6 p-6 bg-gray-50 rounded-lg">
        <h4 class="text-sm font-medium text-gray-700 mb-6">Compliance Score Overview</h4>
        <div class="space-y-2">
