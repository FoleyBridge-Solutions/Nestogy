...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow rounded-lg mb-6">
            <div class="px-6 py-8 sm:px-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Edit Rack: {{ $rack->name }}</h3>
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">Update the server rack information.</p>
                    </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <form method="POST" action="{{ route('clients.racks.standalone.update', $rack) }}" class="space-y-8 divide-y divide-gray-200">
                @csrf
                @method('PUT')
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <select id="client_id" 
                                    ...
                                    @foreach($clients as $client)
                                        <option value="{{ $client->id }}" {{ (old('client_id', $rack->client_id) == $client->id) ? 'selected' : '' }}>
                                            {{ $client->display_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <input type="number" 
                                       name="rack_number" 
                                       id="rack_number" 
                                       value="{{ old('rack_number', $rack->rack_number) }}"
                                       min="1"
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <select id="status" 
                                    ...
                                    @foreach($statuses as $key => $label)
                                        <option value="{{ $key }}" {{ old('status', $rack->status) === $key ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="sm:flex-1 px-6-span-6">
                                ...
                                <textarea id="description" 
                                          name="description" 
                                          rows="3" 
                                          class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('description') border-red-300 @enderror">{{ old('description', $rack->description) }}</textarea>
                                @error('description')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:flex-1 px-6-span-2">
                                ...
                                <select id="height_units" 
                                        name="height_units" 
                                        required
                                        class="mt-1 block w-full py-2 px-6 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('height_units') border-red-300 @enderror">
                                    <option value="">Select height</option>
                                    @foreach($heights as $value => $label)
                                        <option value="{{ $value }}" {{ old('height_units', $rack->height_units) == $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="sm:flex-1 px-6-span-2">
                                ...
                                <input type="number" 
                                       name="width_inches" 
                                       id="width_inches" 
                                       value="{{ old('width_inches', $rack->width_inches) }}"
                                       min="0"
                                       step="0.01"
                            ...
                            <div class="sm:flex-1 px-6-span-2">
                                ...
                                <input type="number" 
                                       name="depth_inches" 
                                       id="depth_inches" 
                                       value="{{ old('depth_inches', $rack->depth_inches) }}"
                                       min="0"
                                       step="0.01"
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <input type="number" 
                                       name="max_weight_lbs" 
                                       id="max_weight_lbs" 
                                       value="{{ old('max_weight_lbs', $rack->max_weight_lbs) }}"
                                       min="0"
                                       step="0.01"
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <select id="cooling_requirements" 
                                        ...
                                        class="mt-1 block w-full py-2 px-6 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('cooling_requirements') border-red-300 @enderror">
                                    <option value="">Select cooling type</option>
                                    @foreach($coolingRequirements as $key => $label)
                                        <option value="{{ $key }}" {{ old('cooling_requirements', $rack->cooling_requirements) === $key ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('power_capacity_watts', $rack->power_capacity_watts) }}"
                                       required
                                       min="0"
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="power_used_watts" 
                                       value="{{ old('power_used_watts', $rack->power_used_watts) }}"
                                       min="0"
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('temperature_celsius', $rack->temperature_celsius) }}"
                                       min="-50"
                                       max="100"
                                       step="0.1"
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="humidity_percent" 
                                       value="{{ old('humidity_percent', $rack->humidity_percent) }}"
                                       min="0"
                                       max="100"
                                       step="0.1"
                            ...
                            <div class="sm:flex-1 px-6-span-6">
                                ...
                                <textarea id="network_connections" 
                                          ...
                                          class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('network_connections') border-red-300 @enderror">{{ old('network_connections', $rack->network_connections) }}</textarea>
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:flex-1 px-6-span-2">
                                ...
                                <input type="text" 
                                       name="manufacturer" 
                                       id="manufacturer" 
                                       value="{{ old('manufacturer', $rack->manufacturer) }}"
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <input type="date" 
                                       name="purchase_date" 
                                       id="purchase_date" 
                                       value="{{ old('purchase_date', $rack->purchase_date ? $rack->purchase_date->format('Y-m-d') : '') }}"
                            ...
                            <div class="sm:flex-1 px-6-span-3">
                                ...
                                <input type="date" 
                                       ...
                                       id="warranty_expiry" 
                                       value="{{ old('warranty_expiry', $rack->warranty_expiry ? $rack->warranty_expiry->format('Y-m-d') : '') }}"
                            ...
                            <div class="sm:flex-1 px-6-span-6">
                                ...
                                <textarea id="maintenance_schedule" 
                                          ...
                                          class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('maintenance_schedule') border-red-300 @enderror">{{ old('maintenance_schedule', $rack->maintenance_schedule) }}</textarea>
                            ...
                            <div class="sm:flex-1 px-6-span-6">
                                ...
                                <textarea id="notes" 
                                          name="notes" 
                                          rows="3" 
                                          class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('notes') border-red-300 @enderror">{{ old('notes', $rack->notes) }}</textarea>
                                @error('notes')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
