...
@section('title', 'Client Certificates')
        ...
        <div class="bg-white shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:px-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Client Certificates</h3>
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">Manage SSL/TLS certificates and security certificates across your clients.</p>
                    </div>
                    <div class="flex space-x-3">
                        <a href="{{ route('clients.certificates.standalone.export', request()->query()) }}" 
                    ...
                    @foreach($certificates as $certificate)
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow duration-200 
                            ...
                            @if($certificate->description)
                                <p class="text-sm text-gray-600 mb-4 line-clamp-2">{{ $certificate->description }}</p>
                            @endif
