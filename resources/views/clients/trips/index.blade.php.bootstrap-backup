                                        ...
                                        <tr>
                                            <td>
                                                <div>
                                                    ...
                                                    <small class="text-muted">{{ ucfirst(str_replace('_', ' ', $trip->trip_type)) }}</small>
                                                    <div class="small text-muted mt-1">
                                                        <i class="fas fa-car me-1"></i>{{ ucfirst(str_replace('_', ' ', $trip->transportation_mode)) }}
                                                        @if($trip->billable_to_client)
                                                            <span class="badge bg-success ms-2">Billable</span>
                                                        @endif
                                                        @if($trip->reimbursable)
                                                            <span class="badge bg-info ms-1">Reimbursable</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="small">
                                                    ...
                                                    @if($trip->actual_expenses > 0)
                                                        <div class="d-flex justify-content-between">
                                                            <span>Actual:</span>
                                                            <span class="fw-bold text-primary">{{ $trip->formatted_actual_expenses }}</span>
                                                        </div>
            ...
            <form id="completeTripForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="actual_expenses" id="actual_expenses" step="0.01" min="0">
                    </div>
