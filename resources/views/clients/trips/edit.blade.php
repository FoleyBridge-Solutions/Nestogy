        ...
        <div class="flex-1 px-6-12">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="px-6 py-2 font-medium rounded-md transition-colors-group">
                    <a href="{{ route('clients.trips.standalone.show', $trip) }}" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-secondary">
                        ...
                        <div class="p-6">
                            <form method="POST" action="{{ route('clients.trips.standalone.update', $trip) }}">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" class="block w-full px-6 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ $trip->trip_number }}" readonly>
                                ...
                                <!-- Trip Title -->
                                <div class="mb-6">
                                    <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Trip Title <span class="text-red-600">*</span></label>
                                    <input type="text" 
                                           name="title" 
                                           id="title" 
                                    ...
                                    <div class="flex-1 px-6-md-3">
                                        <div class="mb-6">
                                            ...
                                            <input type="number" 
                                                   ...
                                                   id="actual_expenses" 
                                                   class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('actual_expenses') border-red-500 @enderror" 
                                ...
                                @if($trip->isCompleted())
                                    <div class="flex flex-wrap -mx-4">
                                        <div class="flex-1 px-6-md-8">
                                            <div class="mb-6">
                                                ...
                                                <textarea name="client_feedback" 
                                                          id="client_feedback" 
                                                          class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('client_feedback') border-red-500 @enderror" 
                                                          rows="3" 
                                        ...
                                        <div class="flex-1 px-6-md-4">
                                            <div class="mb-6">
                                                <label for="internal_rating" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Internal Rating</label>
                                                <select name="internal_rating" id="internal_rating" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('internal_rating') border-red-500 @enderror">
                ...
                <div class="lg:w-1/3 px-4 flex-1 px-6-xl-6">
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="px-6 py-6 border-b border-gray-200 bg-gray-50">
                            <h5 class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-title mb-0">
                                <i class="fas fa-clock mr-2"></i>Trip History
                            </h5>
                        </div>
                        <div class="p-6">
                    ...
                    @if($trip->expense_variance !== null)
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mt-6">
                            <div class="px-6 py-6 border-b border-gray-200 bg-gray-50">
                                <h5 class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-title mb-0">
                                    <i class="fas fa-calculator mr-2"></i>Expense Analysis
                                </h5>
                            </div>
                                ...
                                <div class="flex flex-wrap -mx-4 g-2 text-center">
                                    <div class="flex-1 px-6-4">
                                        <div class="p-2 bg-gray-100 rounded">
                                            <div class="font-bold text-cyan-600 dark:text-cyan-400">{{ $trip->formatted_estimated_expenses }}</div>
                                            <small class="text-gray-600">Estimated</small>
                                        </div>
                                    </div>
                                    <div class="flex-1 px-6-4">
                                        <div class="p-2 bg-gray-100 rounded">
                                            <div class="font-bold text-blue-600">{{ $trip->formatted_actual_expenses }}</div>
                                            <small class="text-gray-600 dark:text-gray-400">Actual</small>
                                        </div>
                                    </div>
                                    <div class="flex-1 px-6-4">
                                        <div class="p-2 bg-light rounded">
                                            <div class="font-bold {{ $trip->expense_variance > 0 ? 'text-red-600 dark:text-red-400' : ($trip->expense_variance < 0 ? 'text-green-600' : 'text-cyan-600 dark:text-cyan-400') }}">
