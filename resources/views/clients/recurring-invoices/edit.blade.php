        ...
        <div class="flex-1 px-6-12">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="px-6 py-2 font-medium rounded-md transition-colors-group">
                    <a href="{{ route('clients.recurring-invoices.standalone.show', $recurringInvoice) }}" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-secondary">
                            ...
                            <form method="POST" action="{{ route('clients.recurring-invoices.standalone.update', $recurringInvoice) }}">
                                ...
                                <div class="flex flex-wrap -mx-4">
                                    <div class="md:w-1/2 px-6">
                                        <div class="mb-6">
                                            <label for="amount" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Amount <span class="text-red-600 dark:text-red-400">*</span></label>
                                            <input type="number" 
                                                   name="amount" 
                                                   id="amount" 
                                                   ...
                                                   value="{{ old('amount', $recurringInvoice->amount) }}" 
                                                   required 
                                                   min="0" 
                                                   step="0.01"
                                                   placeholder="0.00">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('tax_rate', $recurringInvoice->tax_rate) }}" 
                                           min="0" 
                                           max="100" 
                                           step="0.01"
                                           placeholder="0.00">
                                ...
                                <div class="flex flex-wrap -mx-4">
                                    <div class="flex-1 px-6-md-6">
                                        <div class="mb-6">
                                            <label for="frequency" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Frequency <span class="text-red-600 dark:text-red-400">*</span></label>
                                            <select name="frequency" 
                                                ...
                                                @foreach($frequencies as $key => $value)
                                                    <option value="{{ $key }}" {{ old('frequency', $recurringInvoice->frequency) == $key ? 'selected' : '' }}>
                                                        {{ $value }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="flex-1 px-6-md-6">
                                        <div class="mb-6">
                                            <label for="interval_count" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Interval Count</label>
                                            <input type="number" 
                                                   name="interval_count" 
                                                   id="interval_count" 
                                                   ...
                                                   value="{{ old('interval_count', $recurringInvoice->interval_count) }}" 
                                                   min="1" 
                                                   placeholder="1">
                                    ...
                                    <div class="flex-1 px-6-md-6">
                                        <div class="mb-6">
                                            ...
                                            <input type="date" 
                                                   ...
                                                   value="{{ old('start_date', $recurringInvoice->start_date ? $recurringInvoice->start_date->format('Y-m-d') : '') }}" 
                                                   required>
                                            @error('start_date')
                                                <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="flex flex-wrap -mx-4" id="timing-options">
                                    <div class="flex-1 px-6-md-6">
                                        <div class="mb-6" id="day-of-month-field">
                                            <label for="day_of_month" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Day of Month</label>
                                            <input type="number" 
                                                   name="day_of_month" 
                                                   id="day_of_month" 
                                        ...
                                        <div class="mb-6" id="day-of-week-field">
                                            ...
                                            <select name="day_of_week" id="day_of_week" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('day_of_week') border-red-500 @enderror">
                                                ...
                                                @foreach(['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'] as $day)
                                                    <option value="{{ $day }}" {{ old('day_of_week', $recurringInvoice->day_of_week) == $day ? 'selected' : '' }}>
                                                        {{ $day }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="flex flex-wrap -mx-4">
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <select name="status" 
                                                ...
                                                @foreach($statuses as $key => $value)
                                                    <option value="{{ $key }}" {{ old('status', $recurringInvoice->status) == $key ? 'selected' : '' }}>
                                                        {{ $value }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="flex-1 px-6-md-6">
                                        <div class="mb-6">
                                            <label for="payment_terms_days" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Payment Terms (Days)</label>
                                            <input type="number" 
                                    ...
                                    <div class="flex-1 px-6-md-6">
                                        <div class="mb-6">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{{ old('invoice_prefix', $recurringInvoice->invoice_prefix) }}" 
                                                   maxlength="10"
                                                   placeholder="REC">
                                ...
                                <div class="flex flex-wrap -mx-4">
                                    <div class="flex-1 px-6-md-6">
                                        <div class="mb-6">
                                            <label for="late_fee_percentage" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Late Fee Percentage (%)</label>
                                            <input type="number" 
                                                   ...
                                                   value="{{ old('late_fee_percentage', $recurringInvoice->late_fee_percentage) }}" 
                                                   min="0" 
                                                   max="100" 
                                                   step="0.01"
                                                   placeholder="0.00">
                                    ...
                                    <div class="flex-1 px-6-md-6">
                                        <div class="mb-6">
                                            <label for="late_fee_flat_amount" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Late Fee Flat Amount</label>
                                            <input type="number" 
                                                   ...
                                                   value="{{ old('late_fee_flat_amount', $recurringInvoice->late_fee_flat_amount) }}" 
                                                   min="0" 
                                                   step="0.01"
                                                   placeholder="0.00">
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="line_items" 
                                              ...
                                              rows="4" 
                                              placeholder="Enter line items (one per line)...">{{ old('line_items', is_array($recurringInvoice->line_items) ? implode("\n", array_column($recurringInvoice->line_items, 'description')) : '') }}</textarea>
                                ...
                                <!-- Notes -->
                                <div class="mb-6">
                                    <label for="invoice_notes" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Invoice Notes</label>
                                    <textarea name="invoice_notes" 
                                              ...
                                              rows="3" 
                                              placeholder="Notes to include on generated invoices...">{{ old('invoice_notes', $recurringInvoice->invoice_notes) }}</textarea>
                                    @error('invoice_notes')
                                        <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-6">
                                    <label for="payment_instructions" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Payment Instructions</label>
                                    <textarea name="payment_instructions" 
                                              ...
                                              rows="3" 
                                              placeholder="Payment instructions for clients...">{{ old('payment_instructions', $recurringInvoice->payment_instructions) }}</textarea>
                                ...
                                <div class="flex gap-2">
                                    <button type="submit" class="inline-flex items-center px-6 py-2 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                        <i class="fas fa-save mr-2"></i>Update Recurring Invoice
                                    </button>
                                    <a href="{{ route('clients.recurring-invoices.standalone.show', $recurringInvoice) }}" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-secondary">
                                        Cancel
                                    </a>
                ...
                <div class="lg:w-1/3 px-4 flex-1 px-6-xl-6">
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="px-6 py-6 border-b border-gray-200 bg-gray-50">
                            <h5 class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-title mb-0">
                                <i class="fas fa-clock mr-2"></i>Invoice History
                            </h5>
                        </div>
                        <div class="p-6">
                            <div class="small text-gray-600">
                                <div class="mb-2">
                                    ...
                                    @if($recurringInvoice->creator)
                                        <br><strong>Created by:</strong> {{ $recurringInvoice->creator->name }}
                                    @endif
                                </div>
                                @if($recurringInvoice->updated_at != $recurringInvoice->created_at)
                                    <div class="mb-2">
                                        <strong>Last updated:</strong> {{ $recurringInvoice->updated_at->format('M j, Y g:i A') }}
                                    </div>
                                @endif
                                @if($recurringInvoice->last_invoice_date)
                                    <div class="mb-2">
                                        <strong>Last invoice:</strong> {{ $recurringInvoice->last_invoice_date->format('M j, Y') }}
                                    </div>
                                @endif
                                @if($recurringInvoice->next_invoice_date)
                                    <div>
                                        <strong>Next invoice:</strong> {{ $recurringInvoice->next_invoice_date->format('M j, Y') }}
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mt-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                            <div class="flex flex-wrap -mx-4 g-2 text-center">
                                ...
                                <div class="flex-1 px-6-6">
                                    <div class="p-2 bg-gray-100 rounded">
                                        ...
                                        <small class="text-gray-600 dark:text-gray-400">Total Revenue</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                            <div class="small text-gray-600 dark:text-gray-400">
                                ...
                                <ul class="list-unstyled">
                                    <li>• Changing frequency will recalculate the next invoice date</li>
                                    <li>• Status changes affect invoice generation</li>
                                    <li>• Amount changes only apply to future invoices</li>
                                    <li>• Date changes may affect scheduling</li>
                                </ul>

                                <h6 class="mt-6">Best Practices:</h6>
                                <ul class="list-unstyled">
                                    <li>• Test changes with draft status first</li>
                                    <li>• Notify clients of significant changes</li>
                                    <li>• Keep detailed notes for reference</li>
