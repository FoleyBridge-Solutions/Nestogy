                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex space-x-4">
                        <button type="button" 
                                ...
                                class="view-button px-4 py-2 text-sm font-medium rounded-md {{ $view === 'workflows' ? 'bg-indigo-100 text-indigo-700' : 'text-gray-500 hover:text-gray-700' }}">
                            Workflows
                        </button>
                        <button type="button" 
                                onclick="switchView('transitions')"
                                class="view-button px-4 py-2 text-sm font-medium rounded-md {{ $view === 'transitions' ? 'bg-indigo-100 text-indigo-700' : 'text-gray-500 hover:text-gray-700' }}">
                            Transitions
                        </button>
                        <button type="button" 
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Transitions</th>
