                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-4 space-y-4">
                                <div>
                                    <label for="modal_client_id" class="block text-sm font-medium text-gray-700">Client *</label>
                                ...
                                <div>
                                    <label for="modal_assigned_to" class="block text-sm font-medium text-gray-700">Assignee</label>
                                ...
                                <div>
                                    <label for="modal_scheduled_at" class="block text-sm font-medium text-gray-700">Schedule For</label>
