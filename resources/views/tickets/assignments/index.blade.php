                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="flex space-x-4">
                        <button type="button" 
                                ...
                                class="view-button px-6 py-2 text-sm font-medium rounded-md {{ $view === 'assignments' ? 'bg-indigo-100 text-indigo-700' : 'text-gray-500 hover:text-gray-700' }}">
                            Assignments
                        </button>
                        <button type="button" 
                                onclick="switchView('watchers')"
                                class="view-button px-6 py-2 text-sm font-medium rounded-md {{ $view === 'watchers' ? 'bg-indigo-100 text-indigo-700' : 'text-gray-500 hover:text-gray-700' }}">
                            Watchers
                        </button>
                        <button type="button" 
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col-span-12" class="px-6 py-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Watchers</th>
                                    <th scope="col-span-12" class="px-6 py-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Last Activity</th>
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <div class="bg-white px-6 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    <div class="mt-6 text-center sm:mt-0 sm:text-left w-full">
                        ...
                        <div class="mt-6" id="watcherModalContent">
            ...
            <div class="bg-gray-50 px-6 py-6 sm:px-6 sm:flex sm:flex-flex flex-wrap -mx-4-reverse">
                <button type="button" 
                        ...
                        class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-6 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 sm:ml-3 sm:w-auto sm:text-sm">
                    Save Changes
                </button>
                <button type="button" 
                        onclick="closeWatcherModal()"
                        class="mt-6 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-6 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 sm:mt-0 sm:w-auto sm:text-sm">
                    Cancel
                </button>
            </div>
        </div>
...
function manageWatchers(ticketId) {
    ...
    .then(data => {
        ...
        content += '<div class="text-sm text-gray-600 mb-6">' + data.ticket.subject + '</div>';
