...
<body>
    ...
    <div class="ticket-info">
        <div class="info-section">
            ...
            <p><strong>Status:</strong> <span class="badge inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium-{{ $ticket->getStatusColor() }}">{{ $ticket->status }}</span></p>
            <p><strong>Priority:</strong> <span class="badge inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium-{{ $ticket->getPriorityColor() }}">{{ $ticket->priority }}</span></p>
