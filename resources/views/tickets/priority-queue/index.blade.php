                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="flex space-x-4">
                        <button type="button" 
                                ...
                                class="view-button px-6 py-2 text-sm font-medium rounded-md {{ $view === 'queue' ? 'bg-indigo-100 text-indigo-700' : 'text-gray-500 hover:text-gray-700' }}">
                            Queue View
                        </button>
                        <button type="button" 
                                onclick="switchView('matrix')"
                                class="view-button px-6 py-2 text-sm font-medium rounded-md {{ $view === 'matrix' ? 'bg-indigo-100 text-indigo-700' : 'text-gray-500 hover:text-gray-700' }}">
                            Priority Matrix
                        </button>
                        <button type="button" 
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-3">
                            <button type="button" 
                                    ...
                                    class="inline-flex items-center px-6 py-2 border border-orange-300 shadow-sm text-sm leading-4 font-medium rounded-md text-orange-700 bg-white hover:bg-orange-50">
                                Escalate Selected
                            </button>
                            <button type="button" 
                                    onclick="bulkRemove()"
                                    class="inline-flex items-center px-6 py-2 border border-red-300 shadow-sm text-sm leading-4 font-medium rounded-md text-red-700 bg-white hover:bg-red-50">
                                Remove Selected
                            </button>
                        </div>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col-span-12" class="px-6 py-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Position</th>
                                    ...
                                    <th scope="col-span-12" class="px-6 py-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Score</th>
                                    <th scope="col-span-12" class="px-6 py-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">SLA Status</th>
