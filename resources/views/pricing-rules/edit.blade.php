                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="md:w-1/2">
                                    <div class="mb-3">
                                        ...
                                        <div class="flex">
                                            <span class="flex-text" id="discount-symbol">{{ $pricingRule->discount_type === 'percentage' ? '%' : '$' }}</span>
                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="md:w-1/2">
                                    <div class="mb-3">
                                        ...
                                        <div class="flex">
                                            <span class="flex-text" id="markup-symbol">{{ $pricingRule->markup_type === 'percentage' ? '%' : '$' }}</span>
                                        ...
                                        <div class="pricing-tier-flex flex-wrap mb-3 p-3 border rounded">
                                            <div class="flex flex-wrap">
                                                <div class="md:w-1/4">
                                                    ...
                                                    <input type="number" name="tiers[{{ $index }}][min_quantity]" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" 
                                                ...
                                                <div class="md:w-1/4">
                                                    ...
                                                    <input type="number" name="tiers[{{ $index }}][max_quantity]" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" 
                                                ...
                                                <div class="md:w-1/4">
                                                    ...
                                                    <div class="flex">
                                                        <span class="flex-text">$</span>
                                                        <input type="number" name="tiers[{{ $index }}][price]" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" 
