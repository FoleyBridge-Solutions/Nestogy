            ...
            <x-content-card :compact="true">
                <nav class="space-y-1">
                    <button @click="activeTab = 'profile'" 
                            :class="activeTab === 'profile' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'border-transparent text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900'"
                    ...
                    <button @click="activeTab = 'security'" 
                            :class="activeTab === 'security' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'border-transparent text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900'"
                            class="w-full group border-l-4 px-3 py-2 flex items-center text-sm font-medium transition-colors">
                        <svg class="flex-shrink-0 -ml-1 mr-3 h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button @click="activeTab = 'preferences'" 
                            :class="activeTab === 'preferences' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'border-transparent text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900'"
                            class="w-full group border-l-4 px-3 py-2 flex items-center text-sm font-medium transition-colors">
                        <svg class="flex-shrink-0 -ml-1 mr-3 h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}" required
                                       class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('name') border-red-300 @enderror">
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}" required
                                       class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('email') border-red-300 @enderror">
                                @error('email')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="tel" name="phone" id="phone" value="{{ old('phone', $user->phone ?? '') }}"
                                       class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('phone') border-red-300 @enderror">
                                @error('phone')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" value="{{ $user->company->name ?? 'N/A' }}" readonly
                                       class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-gray-50 dark:bg-gray-900">
                            </div>
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <input type="password" name="current_password" id="current_password" required
                                           class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('current_password') border-red-300 @enderror">
                                ...
                                <div>
                                    ...
                                    <input type="password" name="password" id="password" required
                                           class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('password') border-red-300 @enderror">
                                    @error('password')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="password" name="password_confirmation" id="password_confirmation" required
                                           class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                            ...
                            <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <div class="mt-4">
                                    <div class="flex items-center">
                                        ...
                                        <label for="force_mfa" class="ml-2 block text-sm text-gray-900 dark:text-white">
            ...
            <div x-show="activeTab === 'preferences'" x-transition>
                <x-content-card title="Preferences" :compact="true">
                    <form method="POST" action="{{ route('users.settings.update') }}">
                        ...
                        <div class="space-y-6">
                            <div>
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Display Settings</h3>
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                @if($user->userSetting)
                                <div>
                                    <label for="records_per_page" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Records Per Page</label>
                            ...
                            @if($user->userSetting)
                            <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Dashboard Widgets</h3>
                                ...
                                <div class="mt-4 space-y-4">
                                    <div class="flex items-center">
                                        ...
                                        <input type="checkbox" name="dashboard_financial_enable" id="dashboard_financial_enable" 
                                               ...
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-gray-600 rounded">
                                        <label for="dashboard_financial_enable" class="ml-2 block text-sm text-gray-900 dark:text-white">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <input type="checkbox" name="dashboard_technical_enable" id="dashboard_technical_enable" 
                                               ...
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-gray-600 rounded">
                                        <label for="dashboard_technical_enable" class="ml-2 block text-sm text-gray-900 dark:text-white">
