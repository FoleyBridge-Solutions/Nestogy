...
>
    <!-- Dashboard Header -->
    <header class="sticky top-0 z-50 bg-white dark:bg-gray-800/90 dark:bg-slate-900/90 backdrop-blur-xl shadow-sm border-b border-slate-200/50 dark:border-slate-700/50">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button 
                            @click="open = !open"
                            class="px-4 py-2 bg-white dark:bg-gray-800 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors flex items-center space-x-2"
                        >
                        ...
                        <div 
                            ...
                            class="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 py-2 z-50"
                        >
                    ...
                    <button 
                        ...
                        :class="editMode ? 'bg-blue-500 text-white' : 'bg-white dark:bg-gray-800 dark:bg-slate-800 text-slate-700 dark:text-slate-300'"
                    ...
                    <button 
                        ...
                        class="p-2 bg-white dark:bg-gray-800 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
                    >
                ...
                >
                    ...
                    >
                        <button 
                            ...
                            class="p-1 bg-white dark:bg-gray-800 dark:bg-slate-800 rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity"
                        >
                    ...
                    <!-- Widget Content -->
                    <div 
                        class="h-full bg-white dark:bg-gray-800 dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden"
    ...
    >
        <div class="bg-white dark:bg-gray-800 dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[80vh] overflow-hidden">
    ...
    >
        <div class="bg-white dark:bg-gray-800 dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md">
            <div class="p-6 border-b border-slate-200 dark:border-slate-700">
                <div class="flex items-center justify-between">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <select 
                        ...
                        class="w-full px-3 py-2 border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-gray-800 dark:bg-slate-700 text-slate-900 dark:text-white"
                    >
