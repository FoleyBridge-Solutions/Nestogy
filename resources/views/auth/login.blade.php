    ...
    <div class="row min-vh-100">
        ...
        <div class="col-lg-6 d-none d-lg-flex align-items-center justify-content-center bg-primary">
            <div class="text-center text-white">
                ...
                <h2 class="fw-bold mb-3">Welcome to Nestogy ERP</h2>
                <p class="lead mb-4">Streamline your business operations with our comprehensive ERP solution</p>
                <div class="row text-center">
                    <div class="col-4">
                        <i class="fas fa-users fa-2x mb-2"></i>
                        <p class="small">Client Management</p>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-4">
                        ...
                        <p class="small">Financial Reports</p>
                    </div>
                </div>
            </div>
        </div>
