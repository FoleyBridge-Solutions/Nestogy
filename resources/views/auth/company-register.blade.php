        ...
        <form id="registrationForm" method="POST" action="{{ route('signup.submit') }}" class="mt-8 space-y-6">
            ...
            <div id="step-1" class="form-section active">
                ...
                <div class="flex justify-end mt-6">
                    <button type="button" id="next-1" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Continue
                    </button>
                </div>
            </div>
            ...
            <div id="step-2" class="form-section">
                ...
                <div class="flex justify-between mt-6">
                    <button type="button" id="prev-2" class="group relative flex justify-center py-2 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Back
                    </button>
                    <button type="button" id="next-2" class="group relative flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Continue
                    </button>
                </div>
            </div>
            ...
            <div id="step-3" class="form-section">
                <div class="space-y-4">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Choose Your Plan</h3>
                ...
                <div class="flex justify-between mt-6">
                    <button type="button" id="prev-3" class="group relative flex justify-center py-2 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Back
                    </button>
                    <button type="button" id="next-3" class="group relative flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" disabled>
                        Continue
                    </button>
                </div>
            </div>
            ...
            <div id="step-4" class="form-section">
                ...
                <div class="flex justify-between mt-6">
                    <button type="button" id="prev-4" class="group relative flex justify-center py-2 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Back
                    </button>
                    <button type="submit" id="submit-form" class="group relative flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" disabled>
            ...
            card.innerHTML = `
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <div class="mt-2">
                            <span class="text-2xl font-bold text-gray-900">${plan.formatted_price}</span>
