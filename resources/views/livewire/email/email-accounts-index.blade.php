    ...
    <flux:card class="mb-3">
        <div class="flex items-center justify-between mb-3">
            <div>
                ...
                <flux:text size="sm">{{ $this->accounts->count() }} total accounts</flux:text>
            </div>
                                ...
                                <flux:table.cell class="py-2">
                                    <flux:dropdown align="end">
                                        ...
                                        <flux:menu>
                                            ...
                                            >
                                                <span wire:loading.remove wire:target="testConnection({{ $account->id }})">
                                                    Test Connection
                                                </span>
                                                <span wire:loading wire:target="testConnection({{ $account->id }})" class="flex items-center gap-1">
                                                    <flux:icon.cog class="w-3 h-3 animate-spin" />
                                                    Testing...
                                                </span>
                                            </flux:menu.item>
                                            <flux:menu.item
                                                ...
                                                wire:loading.attr="disabled"
                                            >
                                                <span wire:loading.remove wire:target="syncAccount({{ $account->id }})">
                                                    Sync Now
                                                </span>
                                                <span wire:loading wire:target="syncAccount({{ $account->id }})" class="flex items-center gap-1">
