        ...
        <div class="bg-white shadow rounded-lg p-6">
            <div class="space-y-4">
                ...
                <div class="bg-gray-50 p-6 rounded-md">
                    <h4 class="text-sm font-medium text-gray-900 mb-6">Login Attempt Details</h4>
                ...
                <form method="POST" action="{{ route('security.suspicious-login.approve', $attempt->verification_token) }}">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <button type="submit" class="w-full flex justify-center py-2 px-6 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                ✅ Approve Login
                            </button>
                            
                            <a href="{{ route('security.suspicious-login.deny', $attempt->verification_token) }}" class="w-full flex justify-center py-2 px-6 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                🚫 Deny
                            </a>
                        </div>
                    </div>
