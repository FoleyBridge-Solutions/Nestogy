                                ...
                                <div class="flex flex-wrap items-end">
                                    ...
                                    <div class="md:w-1/4">
                                        ...
                                        <input type="number" name="products[{{ $index }}][quantity]" 
                                               class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ $product->pivot->quantity }}" min="1" required>
                                    </div>
                                    <div class="md:w-1/4">
            ...
            <div class="md:w-1/3">
                <x-content-card>
                    ...
                    <div class="mb-3" id="discount-value-group" style="display: {{ $bundle->discount_type ? 'block' : 'none' }};">
                        ...
                        <div class="flex">
                            <span class="flex-text" id="discount-symbol">{{ $bundle->discount_type === 'percentage' ? '%' : '$' }}</span>
