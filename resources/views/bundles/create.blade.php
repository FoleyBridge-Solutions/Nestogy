            ...
            <div class="col-md-4">
                <x-content-card>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="discount_type" id="discount_type" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('discount_type') is-invalid @enderror">
