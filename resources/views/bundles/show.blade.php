    ...
    <div class="flex flex-wrap -mx-4">
            ...
            <x-content-card>
                ...
                @if($bundle->products->count() > 0)
                    <div class="min-w-full divide-y divide-gray-200-responsive">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 min-w-full divide-y divide-gray-200-sm">
                            <thead>
                                <tr>
                                    <th scope="col-span-12">Product</th>
                                    <th scope="col-span-12">Unit Price</th>
                                    <th scope="col-span-12">Quantity</th>
                                    <th scope="col-span-12">Total</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @foreach($bundle->products as $product)
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            @if($product->sku)
                                                <br><small class="text-gray-600 dark:text-gray-400">SKU: {{ $product->sku }}</small>
                                            @endif
                                        </td>
                            ...
                            <tfoot>
                                <tr class="table-light">
                                    <th scope="flex flex-wrap" colspan="3">Subtotal</th>
                                    <th scope="col-span-12">${{ number_format($bundleTotal, 2) }}</th>
                                </tr>
                                @if($bundle->discount_type)
                                    <tr>
                                        <th scope="flex flex-wrap" colspan="3">
                                            Discount
                                        ...
                                        <th scope="col-span-12" class="text-red-600">
                                            @if($bundle->discount_type === 'percentage')
                                ...
                                <tr class="table-primary">
                                    <th scope="flex flex-wrap" colspan="3">Bundle Price</th>
                                    <th scope="col-span-12">
                ...
                @else
                    <div class="text-center py-4">
                        <i class="fas fa-box-open fa-3x text-gray-600 dark:text-gray-400 mb-3"></i>
                        <h6 class="text-gray-600 dark:text-gray-400">No products in this bundle</h6>
                        <p class="text-gray-600 dark:text-gray-400">Add products to create a complete bundle.</p>
                        @can('update', $bundle)
                            <a href="{{ route('bundles.edit', $bundle) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
        ...
        <div class="md:w-1/3 px-4">
            <x-content-card>
                ...
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 text-gray-600 dark:text-gray-400">Total Products</label>
                    <div class="font-bold">{{ $bundle->products->count() }}</div>
                </div>

                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 text-gray-600 dark:text-gray-400">Pricing Type</label>
                    <div class="font-bold">
                        @if($bundle->fixed_price)
                            Fixed Price
                        @else
                ...
                @if($bundle->discount_type)
                    <div class="mb-3">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 text-gray-600 dark:text-gray-400">Discount</label>
                ...
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 text-gray-600 dark:text-gray-400">Bundle Price</label>
                    <div class="font-bold text-green-600 fs-5">
                        @if($bundle->fixed_price)
                            ${{ number_format($bundle->fixed_price, 2) }}
                        @else
                            @php
                ...
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 text-gray-600 dark:text-gray-400">Status</label>
                    <div>
                        @if($bundle->is_active)
                            <span class="badge bg-success">Active</span>
                        @else
                ...
                <div class="mb-3">
                    ...
                    <div class="font-bold">{{ $bundle->created_at->format('M j, Y') }}</div>
                </div>
                ...
                @if($bundle->updated_at != $bundle->created_at)
                    <div class="mb-3">
                        ...
                        <div class="font-bold">{{ $bundle->updated_at->format('M j, Y') }}</div>
                    </div>
                @endif
                ...
                <div class="grid gap-2">
                    @can('update', $bundle)
                        <a href="{{ route('bundles.edit', $bundle) }}" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
                            <i class="fas fa-edit"></i> Edit Bundle
                        </a>
                    @endcan
