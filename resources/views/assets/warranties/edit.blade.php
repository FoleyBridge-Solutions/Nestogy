    ...
    <div class="flex flex-wrap -mx-4">
        <div class="flex-1 px-6-12">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div>
                    <a href="{{ route('assets.warranties.show', $warranty ?? 1) }}" class="px-6 py-2 font-medium rounded-md transition-colors px-6 py-2 font-medium rounded-md transition-colors-outline-info">
            ...
            <div class="flex flex-wrap -mx-4">
                        ...
                        <div class="p-6">
                            <form action="{{ route('assets.warranties.update', $warranty ?? 1) }}" method="POST" id="warrantyForm">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    @if($status === 'expired')
                                        <button type="submit" name="renew" value="1" class="px-6 py-2 font-medium rounded-md transition-colors px-6 py-2 font-medium rounded-md transition-colors-info">
                                            <i class="fas fa-refresh"></i> Save & Renew
                                        </button>
                                    @endif
                                    @if($status === 'active')
                                        <button type="submit" name="mark_expired" value="1" class="px-6 py-2 font-medium rounded-md transition-colors px-6 py-2 font-medium rounded-md transition-colors-warning">
                ...
                <div class="flex-1 px-6-md-4">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-6">
                        <div class="px-6 py-6 border-b border-gray-200 bg-gray-50">
                            <h6 class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-title mb-0">Warranty Status</h6>
                        </div>
                        <div class="p-6">
                            <div class="mb-6">
                    ...
                    <!-- Asset Information -->
                    <div id="assetInfo" class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-6" style="{{ old('asset_id', $warranty->asset_id ?? '') ? '' : 'display: none;' }}">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                            <div id="assetDetails">
                                @if(isset($warranty->asset))
                                    ...
                                    <div class="mb-2">
                                        <small class="text-gray-600 dark:text-gray-400">Category:</small> {{ $warranty->asset->category }}
                                    </div>
                                    <div class="mb-2">
                                        <small class="text-gray-600 dark:text-gray-400">Location:</small> {{ $warranty->asset->location }}
                                    </div>
                                    <div class="mb-6">
                                        <small class="text-gray-600 dark:text-gray-400">Serial:</small> {{ $warranty->asset->serial_number }}
                                    </div>
                                    <a href="{{ route('assets.show', $warranty->asset->id) }}" class="px-4 py-2 font-medium rounded-md transition-colors px-6 py-1 text-sm px-6 py-2 font-medium rounded-md transition-colors-outline-primary">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                            <div id="warrantyCalc">
                                <small class="text-gray-600 dark:text-gray-400">Duration will be calculated based on start and end dates</small>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                            <div class="grid gap-2">
                                <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-info px-6 py-2 font-medium rounded-md transition-colors-sm" onclick="checkWarrantyStatus()">
                                    <i class="fas fa-search"></i> Check Status Online
                                </button>
                                <button type="button" class="px-6 py-2 font-medium rounded-md transition-colors border border-green-600 text-green-600 hover:bg-green-50 px-6 py-2 font-medium rounded-md transition-colors-sm" onclick="contactSupport()">
                                    <i class="fas fa-phone"></i> Contact Support
                                </button>
                                <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-warning px-6 py-2 font-medium rounded-md transition-colors-sm" onclick="downloadCertificate()">
                                    <i class="fas fa-certificate"></i> Download Certificate
                                </button>
                                @if($status === 'active')
                                    <button type="button" class="px-6 py-2 font-medium rounded-md transition-colors border border-blue-600 text-blue-600 hover:bg-blue-50 px-6 py-2 font-medium rounded-md transition-colors-sm" onclick="renewWarranty()">
