                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="p-6">
                            <form action="{{ route('assets.maintenance.update', $maintenance ?? 1) }}" method="POST" id="maintenanceForm">
                                ...
                                <div class="mb-6">
                                    <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Title <span class="text-red-600 dark:text-red-400">*</span></label>
                                ...
                                <div class="flex flex-wrap -mx-4 mb-6">
                                    <div class="flex-1 px-6-md-6">
                                        <label for="scheduled_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Scheduled Date</label>
                                    ...
                                    <div class="flex-1 px-6-md-6">
                                        <label for="estimated_duration" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Estimated Duration (hours)</label>
                                ...
                                <div class="flex flex-wrap -mx-4 mb-6">
                                    ...
                                    <div class="flex-1 px-6-md-6">
                                        <label for="recurring_interval" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Recurring Interval</label>
                                ...
                                <div id="completionSection" style="{{ old('status', $maintenance->status ?? '') === 'completed' ? '' : 'display: none;' }}">
                                    ...
                                    <div class="flex flex-wrap -mx-4 mb-6">
                                        <div class="flex-1 px-6-md-6">
                                            <label for="completed_at" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Completion Date</label>
                                        ...
                                        <div class="flex-1 px-6-md-6">
                                            <label for="actual_duration" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Actual Duration (hours)</label>
                                    ...
                                    <div class="flex flex-wrap -mx-4 mb-6">
                                        ...
                                        <div class="flex-1 px-6-md-6">
                                            <label for="completed_by" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Completed By</label>
                                    ...
                                    <div class="mb-6">
                                        <label for="completion_notes" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Completion Notes</label>
                                ...
                                <div class="mb-6">
                                    <label for="instructions" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Maintenance Instructions</label>
