    ...
    @if($showFilters)
        <div class="timeline-filters mb-3">
            <div class="flex flex-wrap g-2">
                <div class="md:w-1/3">
                    <select class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" id="timeline-type-{{ $widget['id'] }}">
                ...
                <div class="md:w-1/3">
                    <select class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" id="timeline-user-{{ $widget['id'] }}">
                ...
                <div class="md:w-1/3">
                    <select class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" id="timeline-period-{{ $widget['id'] }}">
    ...
    @else
                ...
                @foreach($groupedData as $date => $events)
                    <div class="timeline-group">
                        <div class="timeline-date-header">
                            ...
                            <small class="text-gray-600 dark:text-gray-400">{{ count($events) }} events</small>
                        </div>
        ...
        @if(count($timelineData) > $maxItems)
            <div class="text-center mt-3">
                <button class="btn px-3 py-1 text-sm  id="load-more-{{ $widget['id'] }}">
                    Load More Events
                </button>
            </div>
        @endif
...
.timeline-filters .block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm {
    font-size: 0.875rem;
}
