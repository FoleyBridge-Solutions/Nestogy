    ...
    <x-content-card>
        <div class="p-6">
            <form method="GET" action="{{ route('services.index') }}" class="grid grid-cols-1 md:grid-cols-6 gap-4">
                ...
                <div class="md:col-span-12-span-1 flex items-end gap-2">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($service->is_active)
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-600">Active</span>
                                    @else
