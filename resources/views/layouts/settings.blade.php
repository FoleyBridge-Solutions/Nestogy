    ...
    <div class="container mx-auto px-4 mx-auto px-4 mx-auto px-4 py-6">
        ...
        <div class="mb-6">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">@yield('settings-title', 'Settings')</h1>
                        <p class="text-gray-600 dark:text-gray-300 mt-1 text-sm lg:text-base">@yield('settings-description', 'Configure your system preferences')</p>
                    </div>
                </div>
        ...
        <div class="lg:flex lg:gap-6">
            ...
            <div x-show="mobileMenuOpen"
                ...
                <!-- Backdrop -->
                <div class="fixed inset-0 bg-black/30 dark:bg-black/50 backdrop-blur-sm" @click="closeMobileMenu()"></div>
...
<div x-data="notifications" 
    ...
    <template x-for="notification in notifications" :key="notification.id">
        <div x-transition:enter="transition ease-out duration-300"
             ...
             :class="{ 'bg-green-100 dark:bg-green-900/20 border-green-400 dark:border-green-600 text-green-700 dark:text-green-300': notification.type === 'success', 'bg-red-100 dark:bg-red-900/20 border-red-400 dark:border-red-600 text-red-700 dark:text-red-300': notification.type === 'error', 'bg-yellow-100 dark:bg-yellow-900/20 border-yellow-400 dark:border-yellow-600 text-yellow-700 dark:text-yellow-300': notification.type === 'warning', 'bg-blue-100 dark:bg-blue-900/20 border-blue-400 dark:border-blue-600 text-blue-700 dark:text-blue-300': notification.type === 'info' }"
             class="border px-4 py-3 rounded relative shadow-md min-w-[300px] max-w-md">
            <span x-text="notification.message"></span>
            <button @click="removeNotification(notification.id)" 
                    class="absolute top-0 right-0 p-2 hover:bg-gray-200 dark:hover:bg-gray-600 rounded transition-colors">
