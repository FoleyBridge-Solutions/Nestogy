    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="md:flex md:items-center md:justify-between mb-8">
            ...
            <div class="mt-4 flex md:mt-0 md:ml-4 space-x-3">
                <div class="relative">
                    <select x-model="selectedPeriod" @change="updateDateRange()" class="btn btn-outline-secondary">
                ...
                <button @click="exportReport('summary')" class="btn btn-outline-primary">
        ...
        <div class="mt-8">
            <div class="bg-gray-50 rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <a href="{{ route('reports.tax.summary') }}" class="btn btn-outline-primary w-full">
                        <i class="fas fa-chart-pie mr-2"></i>
                        Tax Summary
                    </a>
                    <a href="{{ route('reports.tax.jurisdictions') }}" class="btn btn-outline-primary w-full">
                        <i class="fas fa-map-marker-alt mr-2"></i>
                        Jurisdictions
                    </a>
                    <a href="{{ route('reports.tax.compliance') }}" class="btn btn-outline-primary w-full">
                        <i class="fas fa-shield-alt mr-2"></i>
                        Compliance
                    </a>
                    <a href="{{ route('reports.tax.performance') }}" class="btn btn-outline-primary w-full">
