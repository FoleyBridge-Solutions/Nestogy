...
@section('title', 'API & Webhooks Settings - Nestogy')

@section('settings-title', 'API & Webhooks Settings')
@section('settings-description', 'Configure API access, webhook endpoints, and integration settings')

@section('settings-content')
<div>
    <form method="POST" action="{{ route('settings.api-webhooks.update') }}">
        @csrf
        @method('PUT')
