...
@section('title', 'Performance Optimization Settings - Nestogy')

@section('settings-title', 'Performance Optimization Settings')
@section('settings-description', 'Configure system performance, caching, and optimization features')

@section('settings-content')
<div>
    <form method="POST" action="{{ route('settings.performance-optimization.update') }}">
        @csrf
        @method('PUT')
