...
@section('title', 'Client Portal Settings - Nestogy')

@section('settings-title', 'Client Portal Settings')
@section('settings-description', 'Configure client portal access, features, and customization options')

@section('settings-content')
<div>
    <form method="POST" action="{{ route('settings.client-portal.update') }}">
        @csrf
        @method('PUT')
