...
@section('title', 'Automation & Workflow Settings - Nestogy')

@section('settings-title', 'Automation & Workflow Settings')
@section('settings-description', 'Configure automated business rules, workflows, and event-driven processes')

@section('settings-content')
<div>
    <form method="POST" action="{{ route('settings.automation-workflows.update') }}">
        @csrf
        @method('PUT')
