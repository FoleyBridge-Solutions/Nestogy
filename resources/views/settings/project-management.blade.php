...
@section('title', 'Project Management Settings - Nestogy')

@section('settings-title', 'Project Management Settings')
@section('settings-description', 'Configure project tracking, task management, and collaboration features')

@section('settings-content')
<div>
    <form method="POST" action="{{ route('settings.project-management.update') }}">
        @csrf
        @method('PUT')
