...
@section('title', 'Templates Settings - Nestogy')

@section('settings-title', 'Templates Settings')
@section('settings-description', 'Configure email templates, document templates, and communication templates')
