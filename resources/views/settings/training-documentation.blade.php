...
@section('title', 'Training & Documentation Settings - Nestogy')

@section('settings-title', 'Training & Documentation Settings')
@section('settings-description', 'Configure training programs, documentation management, and learning resources')

@section('settings-content')
<div>
    <form method="POST" action="{{ route('settings.training-documentation.update') }}">
        @csrf
        @method('PUT')
