    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="api_rate_limiting" name="api_rate_limiting" value="1" checked class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                ...
                <ul class="divide-y divide-gray-200">
                    <li class="px-4 py-4">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Active</span>
                                <button class="text-blue-600 dark:text-blue-400-600 hover:text-blue-600 dark:text-blue-400-900 text-sm font-medium">Test</button>
                                <button class="text-blue-600 dark:text-blue-400-600 hover:text-blue-600 dark:text-blue-400-900 text-sm font-medium">Edit</button>
                            </div>
                        </div>
                    </li>
