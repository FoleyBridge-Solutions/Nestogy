<div class="p-6">
    <div class="space-y-6">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <button class="text-primary-600 hover:text-primary-900 text-sm font-medium">Configure</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="border-t border-gray-200 pt-6">
            ...
            <div class="space-y-4">
                <div class="flex items-center">
                    <input type="checkbox" id="auto_capture" name="auto_capture" value="1" checked class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="save_payment_methods" name="save_payment_methods" value="1" checked class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="require_cvv" name="require_cvv" value="1" checked class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
        ...
        <div class="border-t border-gray-200 pt-6">
            ...
            <div class="space-y-4">
                <div class="flex items-center">
                    <input type="checkbox" id="pass_fees_to_client" name="pass_fees_to_client" value="1" class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
