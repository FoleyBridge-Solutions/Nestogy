    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="client_can_reply" name="client_can_reply" value="1" checked class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
