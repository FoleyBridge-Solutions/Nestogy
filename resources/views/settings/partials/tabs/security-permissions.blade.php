                        ...
                        <div class="px-4 py-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="editRole('manager')" class="text-blue-600 dark:text-blue-400-600 hover:text-blue-600 dark:text-blue-400-900 text-sm font-medium">
                                        Edit
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="px-4 py-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="editRole('technician')" class="text-blue-600 dark:text-blue-400-600 hover:text-blue-600 dark:text-blue-400-900 text-sm font-medium">
                                        Edit
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="px-4 py-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="editRole('client')" class="text-blue-600 dark:text-blue-400-600 hover:text-blue-600 dark:text-blue-400-900 text-sm font-medium">
                                        Edit
                                    </button>
                                </div>
                            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_system_admin" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_system_admin" class="ml-2 text-sm text-gray-700">System Administration</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_user_management" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_user_management" class="ml-2 text-sm text-gray-700">User Management</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_company_settings" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_client_create" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_client_create" class="ml-2 text-sm text-gray-700">Create Clients</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_client_edit" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_client_edit" class="ml-2 text-sm text-gray-700">Edit Clients</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_client_delete" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_client_delete" class="ml-2 text-sm text-gray-700">Delete Clients</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_client_view_all" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_client_view_all" class="ml-2 text-sm text-gray-700">View All Clients</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_client_assets" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_client_assets" class="ml-2 text-sm text-gray-700">Manage Assets</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_client_contacts" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_ticket_create" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_ticket_create" class="ml-2 text-sm text-gray-700">Create Tickets</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_ticket_edit" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_ticket_edit" class="ml-2 text-sm text-gray-700">Edit Tickets</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_ticket_delete" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_ticket_delete" class="ml-2 text-sm text-gray-700">Delete Tickets</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_ticket_assign" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_ticket_assign" class="ml-2 text-sm text-gray-700">Assign Tickets</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_ticket_view_all" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_ticket_view_all" class="ml-2 text-sm text-gray-700">View All Tickets</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_ticket_billing" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_invoice_create" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_invoice_create" class="ml-2 text-sm text-gray-700">Create Invoices</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_invoice_edit" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_invoice_edit" class="ml-2 text-sm text-gray-700">Edit Invoices</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_invoice_delete" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_invoice_delete" class="ml-2 text-sm text-gray-700">Delete Invoices</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_payment_process" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_payment_process" class="ml-2 text-sm text-gray-700">Process Payments</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_financial_reports" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_financial_reports" class="ml-2 text-sm text-gray-700">View Financial Reports</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_pricing_management" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_project_create" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_project_create" class="ml-2 text-sm text-gray-700">Create Projects</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_project_edit" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_project_edit" class="ml-2 text-sm text-gray-700">Edit Projects</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_project_delete" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_project_delete" class="ml-2 text-sm text-gray-700">Delete Projects</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_project_assign" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_project_assign" class="ml-2 text-sm text-gray-700">Assign Team Members</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_time_tracking" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_time_tracking" class="ml-2 text-sm text-gray-700">Time Tracking</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_project_reports" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_view_dashboard" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_view_dashboard" class="ml-2 text-sm text-gray-700">View Dashboard</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_basic_reports" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_basic_reports" class="ml-2 text-sm text-gray-700">Basic Reports</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_advanced_reports" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_advanced_reports" class="ml-2 text-sm text-gray-700">Advanced Reports</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_export_data" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_export_data" class="ml-2 text-sm text-gray-700">Export Data</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_audit_logs" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="perm_audit_logs" class="ml-2 text-sm text-gray-700">View Audit Logs</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_custom_reports" class="h-4 w-4 text-blue-600 dark:text-blue-400-600 focus:ring-primary-500 border-gray-300 rounded">
