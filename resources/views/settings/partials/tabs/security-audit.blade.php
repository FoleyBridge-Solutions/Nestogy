    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="log_data_changes" name="log_data_changes" value="1" checked class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                    <label for="log_data_changes" class="ml-3 block text-sm font-medium text-gray-700">Log all data modifications</label>
                </div>
                <div class="flex items-center">
                    <input type="checkbox" id="log_file_access" name="log_file_access" value="1" class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
