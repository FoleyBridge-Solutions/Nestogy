    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="auto_close_resolved" name="auto_close_resolved" value="1" class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
        ...
        <div class="border-t border-gray-200 pt-6">
            ...
            <div class="space-y-4">
                <div class="flex items-center">
                    <input type="checkbox" id="auto_generate_monthly" name="auto_generate_monthly" value="1" class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="auto_send_payment_reminders" name="auto_send_payment_reminders" value="1" class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="auto_apply_late_fees" name="auto_apply_late_fees" value="1" class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
