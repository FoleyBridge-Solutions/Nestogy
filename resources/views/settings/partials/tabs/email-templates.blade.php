                        ...
                        <div class="px-4 py-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="editTemplate('ticket_updated')" class="text-primary-600 hover:text-primary-900 text-sm font-medium">
                                        Edit
                                    </button>
                        ...
                        <div class="px-4 py-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="editTemplate('ticket_resolved')" class="text-primary-600 hover:text-primary-900 text-sm font-medium">
                                        Edit
                                    </button>
                        ...
                        <div class="px-4 py-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="editTemplate('invoice_created')" class="text-primary-600 hover:text-primary-900 text-sm font-medium">
                                        Edit
                                    </button>
                        ...
                        <div class="px-4 py-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="editTemplate('payment_reminder')" class="text-primary-600 hover:text-primary-900 text-sm font-medium">
                                        Edit
                                    </button>
                        ...
                        <div class="px-4 py-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="editTemplate('welcome_email')" class="text-primary-600 hover:text-primary-900 text-sm font-medium">
                                        Edit
                                    </button>
                        ...
                        <div class="px-4 py-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="editTemplate('password_reset')" class="text-primary-600 hover:text-primary-900 text-sm font-medium">
                                        Edit
                                    </button>
