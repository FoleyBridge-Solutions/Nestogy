...
@section('title', 'Reporting & Analytics Settings - Nestogy')

@section('settings-title', 'Reporting & Analytics Settings')
@section('settings-description', 'Configure reporting tools, analytics tracking, and data visualization options')

@section('settings-content')
<div>
    <form method="POST" action="{{ route('settings.reporting-analytics.update') }}">
        @csrf
        @method('PUT')
