...
@section('title', 'Asset Inventory Settings - Nestogy')

@section('settings-title', 'Asset Inventory Settings')
@section('settings-description', 'Configure asset management, tracking, and inventory settings')

@section('settings-content')
<div>
    <form method="POST" action="{{ route('settings.asset-inventory.update') }}">
        @csrf
        @method('PUT')
