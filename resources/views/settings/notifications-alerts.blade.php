...
@section('title', 'Notifications & Alerts Settings - Nestogy')

@section('settings-title', 'Notifications & Alerts Settings')
@section('settings-description', 'Configure system notifications, alerts, and communication preferences')

@section('settings-content')
<div>
    <form method="POST" action="{{ route('settings.notifications-alerts.update') }}">
        @csrf
        @method('PUT')
