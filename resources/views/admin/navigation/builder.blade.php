    ...
    <div class="flex flex-wrap -mx-4">
        ...
        <div class="flex-1 px-6-12">
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-0">Design custom navigation menus and breadcrumb systems</p>
                </div>
                <div class="nav-actions">
                    <button class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-secondary mr-2" id="preview-navigation">
                        <i class="fas fa-eye"></i> Preview
                    </button>
                    <button class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-success mr-2" id="save-navigation">
                        <i class="fas fa-save"></i> Save Configuration
                    </button>
                    <button class="btn px-6 py-2 font-medium rounded-md transition-colors-success" id="publish-navigation">
        ...
        <div class="flex-1 px-6-md-3">
            <div class="nav-config-sidebar">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                        <form id="navigation-config">
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-config-name">Configuration Name</label>
                                <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-config-name" placeholder="Enter configuration name" required>
                            </div>
                            
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-contract-type">Contract Type</label>
                                <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-contract-type" required>
                            ...
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-style">Navigation Style</label>
                                <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-style">
                            ...
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-position">Position</label>
                                <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-position">
                            ...
                            <div class="flex items-center mb-2">
                                <input type="checkbox" class="flex items-center-input" id="enable-breadcrumbs" checked>
                                <label class="flex items-center-label" for="enable-breadcrumbs">
                                    Enable breadcrumbs
                                </label>
                            </div>
                            
                            <div class="flex items-center mb-2">
                                <input type="checkbox" class="flex items-center-input" id="enable-search">
                                <label class="flex items-center-label" for="enable-search">
                                    Include search functionality
                                </label>
                            </div>
                            
                            <div class="flex items-center mb-2">
                                <input type="checkbox" class="flex items-center-input" id="responsive-menu" checked>
                                <label class="flex items-center-label" for="responsive-menu">
                                    Responsive mobile menu
                                </label>
                            </div>
                            
                            <div class="flex items-center">
                                <input type="checkbox" class="flex items-center-input" id="permission-based">
                                <label class="flex items-center-label" for="permission-based">
                            ...
                            <div class="component-category">
                                ...
                                <div class="component-list">
                                    ...
                                    <div class="nav-component-item" data-type="payments">
                                        <i class="fas fa-credit-bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden"></i> Payments
                                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                        <button class="btn border border-blue-600 text-blue-600 hover:bg-blue-50 px-6 py-2 font-medium rounded-md transition-colors-sm w-100 mb-2" id="add-submenu">
                            <i class="fas fa-plus"></i> Add Submenu
                        </button>
                        <button class="btn border border-gray-600 text-gray-600 hover:bg-gray-50 px-6 py-2 font-medium rounded-md transition-colors-sm w-100 mb-2" id="import-template">
                            <i class="fas fa-download"></i> Import Template
                        </button>
                        <flux:button variant="ghost" color="sky" class="px-6 py-2 font-medium rounded-md transition-colors-sm w-100" id="export-config">
        ...
        <div class="flex-1 px-6-md-9">
            <div class="nav-builder-canvas">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-header flex justify-between items-center">
                        ...
                        <div class="canvas-actions">
                            <button class="btn border border-gray-600 text-gray-600 hover:bg-gray-50 px-6 py-2 font-medium rounded-md transition-colors-sm mr-2" id="collapse-all">
                                <i class="fas fa-compress-alt"></i> Collapse All
                            </button>
                            <button class="btn border border-gray-600 text-gray-600 hover:bg-gray-50 px-6 py-2 font-medium rounded-md transition-colors-sm mr-2" id="expand-all">
                                <i class="fas fa-expand-alt"></i> Expand All
                            </button>
                            <button class="btn border border-red-600 text-red-600 hover:bg-red-50 px-6 py-2 font-medium rounded-md transition-colors-sm" id="clear-navigation">
                        ...
                        <div class="navigation-tree" id="navigation-tree">
                            <div class="empty-navigation-message">
                                <div class="text-center py-8">
                                    <i class="fas fa-sitemap fa-3x text-gray-600 dark:text-gray-400 mb-6"></i>
                                    <h5 class="text-gray-600 dark:text-gray-400">Build Your Navigation</h5>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mt-6" id="breadcrumb-config-card" style="display: none;">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-header">
                        <h6 class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-title mb-0">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                        <div class="breadcrumb-builder" id="breadcrumb-builder">
                            <div class="breadcrumb-item-template">
                                <div class="breadcrumb-preview mb-6">
                                ...
                                <div class="breadcrumb-settings">
                                    <div class="flex flex-wrap -mx-4">
                                        <div class="flex-1 px-6-md-4">
                                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="breadcrumb-separator">Separator</label>
                                            <select class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" id="breadcrumb-separator">
                                                <option value="/">/</option>
                                        ...
                                        <div class="flex-1 px-6-md-4">
                                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="breadcrumb-max-items">Max Items</label>
                                            <input type="number" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" 
                                                   id="breadcrumb-max-items" value="5" min="3" max="10">
                                        </div>
                                        <div class="flex-1 px-6-md-4">
                                            <div class="flex items-center mt-6">
                                                <input type="checkbox" class="flex items-center-input" id="breadcrumb-icons" checked>
                                                <label class="flex items-center-label" for="breadcrumb-icons">
                                                    Show icons
                                                </label>
                                            </div>
                                        </div>
...
<div class="fixed inset-0 z-50 overflow-y-auto fade" id="navItemConfigModal" tabindex="-1">
    <div class="flex items-center justify-center min-h-screen fixed inset-0 z-50 overflow-y-auto-lg">
        <div class="fixed inset-0 z-50 overflow-y-auto-content">
            <div class="fixed inset-0 z-50 overflow-y-auto-header">
                <h5 class="fixed inset-0 z-50 overflow-y-auto-title">Configure Navigation Item</h5>
                ...
                <form id="nav-item-config-form">
                    <div class="flex flex-wrap -mx-4">
                        ...
                        <div class="flex-1 px-6-md-6">
                            ...
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-item-label">Label</label>
                                <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-item-label" name="label" required>
                            </div>
                            
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-item-icon">Icon</label>
                                <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-item-icon" name="icon" placeholder="fas fa-home">
                            </div>
                            
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-item-url">URL/Route</label>
                                <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-item-url" name="url" placeholder="/contracts/{id}/overview">
                            </div>
                            
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-item-description">Description</label>
                                <textarea class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-item-description" name="description" rows="2"></textarea>
                            </div>
                        </div>
                        
                        {{-- Advanced Settings --}}
                        <div class="flex-1 px-6-md-6">
                            <h6 class="border-b pb-2 mb-6">Advanced Settings</h6>
                            
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-item-target">Target</label>
                                <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-item-target" name="target">
                            ...
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-item-badge">Badge</label>
                                <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-item-badge" name="badge" placeholder="New">
                            </div>
                            
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-item-badge-color">Badge Color</label>
                                <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-item-badge-color" name="badge_color">
                            ...
                            <div class="flex flex-wrap -mx-4">
                                <div class="flex-1 px-6-6">
                                    <div class="flex items-center">
                                        <input type="checkbox" class="flex items-center-input" id="nav-is-active" name="is_active">
                                        <label class="flex items-center-label" for="nav-is-active">Active</label>
                                    </div>
                                </div>
                                <div class="flex-1 px-6-6">
                                    <div class="flex items-center">
                                        <input type="checkbox" class="flex items-center-input" id="nav-is-visible" name="is_visible">
                                        <label class="flex items-center-label" for="nav-is-visible">Visible</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex-1 px-6-12 mt-6">
                            <h6 class="border-b pb-2 mb-6">Permissions & Conditions</h6>
                            
                            <div class="flex flex-wrap -mx-4">
                                <div class="flex-1 px-6-md-6">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-permission">Required Permission</label>
                                    <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-permission" name="permission">
                                ...
                                <div class="flex-1 px-6-md-6">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-condition">Display Condition</label>
                                    <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-condition" name="condition">
                            ...
                            <div class="mt-6" id="custom-condition-config" style="display: none;">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="nav-custom-condition">Custom Condition Code</label>
                                <textarea class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="nav-custom-condition" name="custom_condition" rows="3" 
            ...
            <div class="fixed inset-0 z-50 overflow-y-auto-footer">
                ...
                <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-primary" id="save-nav-item">Save Item</button>
            </div>
        </div>
    </div>
</div>
...
<div class="fixed inset-0 z-50 overflow-y-auto fade" id="navPreviewModal" tabindex="-1">
    <div class="flex items-center justify-center min-h-screen fixed inset-0 z-50 overflow-y-auto-xl">
        <div class="fixed inset-0 z-50 overflow-y-auto-content">
            <div class="fixed inset-0 z-50 overflow-y-auto-header">
                <h5 class="fixed inset-0 z-50 overflow-y-auto-title">Navigation Preview</h5>
                <button type="button" class="px-6 py-2 font-medium rounded-md transition-colors-close" ></button>
            </div>
            <div class="fixed inset-0 z-50 overflow-y-auto-body">
                <div class="preview-container mx-auto">
                    <div class="preview-styles mb-6">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="preview-style">Preview Style:</label>
                        <div class=" px-6 py-2 font-medium rounded-md transition-colors-group-sm" role="group">
                            <input type="radio" class="px-6 py-2 font-medium rounded-md transition-colors-check" name="preview-style" id="preview-desktop" value="desktop" checked>
                            <label class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-primary" for="preview-desktop">Desktop</label>
                            
                            <input type="radio" class="px-6 py-2 font-medium rounded-md transition-colors-check" name="preview-style" id="preview-tablet" value="tablet">
                            <label class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-primary" for="preview-tablet">Tablet</label>
                            
                            <input type="radio" class="px-6 py-2 font-medium rounded-md transition-colors-check" name="preview-style" id="preview-mobile" value="mobile">
                            <label class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-primary" for="preview-mobile">Mobile</label>
                        </div>
                    </div>
                    
                    <div id="navigation-preview-container" class="border rounded p-6">
...
<div class="fixed inset-0 z-50 overflow-y-auto fade" id="importTemplateModal" tabindex="-1">
    <div class="fixed inset-0 z-50 overflow-y-auto-dialog">
        <div class="fixed inset-0 z-50 overflow-y-auto-content">
            <div class="fixed inset-0 z-50 overflow-y-auto-header">
                <h5 class="fixed inset-0 z-50 overflow-y-auto-title">Import Navigation Template</h5>
                <button type="button" class="px-6 py-2 font-medium rounded-md transition-colors-close" ></button>
            </div>
            <div class="fixed inset-0 z-50 overflow-y-auto-body">
                <div class="template-options">
                    <div class="template-option" data-template="standard">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 small">Overview, Details, Timeline, Attachments, Edit</p>
                    </div>
                    <div class="template-option" data-template="financial">
                        <h6>Financial Contract Navigation</h6>
                        <p class="text-gray-600 dark:text-gray-400 small">Overview, Financial, Invoices, Payments, Reports</p>
                    </div>
                    <div class="template-option" data-template="service">
                        <h6>Service Contract Navigation</h6>
                        <p class="text-gray-600 dark:text-gray-400 small">Overview, Service Details, SLA, Assets, Performance</p>
                    </div>
                    <div class="template-option" data-template="minimal">
                        <h6>Minimal Navigation</h6>
                        <p class="text-gray-600 dark:text-gray-400 small">Overview, Edit, History</p>
                    </div>
                </div>
            </div>
            <div class="fixed inset-0 z-50 overflow-y-auto-footer">
                <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-secondary" >Cancel</button>
                <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-primary" id="import-selected-template">Import Template</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            itemElement.innerHTML = `
                <div class="nav-item-header">
                    <div class="nav-item-content">
                        ...
                        ${item.badge ? `<span class="badge bg-${item.badge_color} nav-item-inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium">${item.badge}</span>` : ''}
                        ${!item.is_visible ? '<i class="fas fa-eye-slash text-gray-600 dark:text-gray-400 ml-2" title="Hidden"></i>' : ''}
                        ${item.permission ? '<i class="fas fa-lock text-yellow-600 dark:text-yellow-400 ml-2" title="Permission Required"></i>' : ''}
                    </div>
                    <div class="nav-item-controls">
                        ${item.type !== 'separator' ? `
                            <button class="btn border border-green-600 text-green-600 hover:bg-green-50 px-4 py-1 text-sm nav-item-control-px-6 py-2 font-medium rounded-md transition-colors" onclick="addChildItem('${item.id}')" title="Add Child">
                                <i class="fas fa-plus"></i>
                            </button>
                        ` : ''}
                        <button class="btn border border-blue-600 text-blue-600 hover:bg-blue-50 px-4 py-1 text-sm nav-item-control-px-6 py-2 font-medium rounded-md transition-colors" onclick="editNavigationItem('${item.id}')" title="Edit">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn border border-gray-600 text-gray-600 hover:bg-gray-50 px-4 py-1 text-sm nav-item-control-px-6 py-2 font-medium rounded-md transition-colors" onclick="duplicateNavigationItem('${item.id}')" title="Duplicate">
                            <i class="fas fa-copy"></i>
                        </button>
                        <button class="btn border border-red-600 text-red-600 hover:bg-red-50 px-4 py-1 text-sm nav-item-control-px-6 py-2 font-medium rounded-md transition-colors" onclick="removeNavigationItem('${item.id}')" title="Delete">
        ...
        function clearNavigation(confirm = true) {
            ...
            navigationTree.innerHTML = '<div class="empty-navigation-message"><div class="text-center py-8"><i class="fas fa-sitemap fa-3x text-gray-600 dark:text-gray-400 mb-6"></i><h5 class="text-gray-600 dark:text-gray-400">Build Your Navigation</h5><p class="text-gray-600 dark:text-gray-400">Drag navigation components from the left panel to create your menu structure.<br>You can create nested submenus and organize items hierarchically.</p></div></div>';
