        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Customize how contract details are displayed and organized</p>
                </div>
                <div class="view-actions">
                    <button class="btn btn-outline-secondary me-2" id="preview-view">
                        <i class="fas fa-eye"></i> Preview
                    </button>
                    <button class="btn btn-outline-success me-2" id="save-configuration">
                        <i class="fas fa-save"></i> Save Configuration
                    </button>
                    <button class="btn btn-success" id="apply-configuration">
                    ...
                    <div class="card-body">
                        <form id="view-config">
                            ...
                            <div class="form-check mb-2">
                                <input type="checkbox" class="form-check-input" id="show-tabs" checked>
                                <label class="form-check-label" for="show-tabs">
                                    Enable tabbed interface
                                </label>
                            </div>
                            
                            <div class="form-check mb-2">
                                <input type="checkbox" class="form-check-input" id="show-timeline" checked>
                                <label class="form-check-label" for="show-timeline">
                                    Show timeline
                                </label>
                            </div>
                            
                            <div class="form-check mb-2">
                                <input type="checkbox" class="form-check-input" id="show-comments" checked>
                                <label class="form-check-label" for="show-comments">
                                    Show comments
                                </label>
                            </div>
                            
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="show-attachments" checked>
                                <label class="form-check-label" for="show-attachments">
                                    Show attachments
                                </label>
                            </div>
                        </form>
                        ...
                        <div class="tab-config-list" id="tab-config-list">
                            ...
                            <div class="tab-config-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <input type="checkbox" class="form-check-input tab-toggle" data-tab="timeline" checked>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-config-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <input type="checkbox" class="form-check-input tab-toggle" data-tab="attachments" checked>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-config-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <input type="checkbox" class="form-check-input tab-toggle" data-tab="comments" checked>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <button class="btn btn-outline-primary btn-sm w-100 mt-3" id="add-custom-tab">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="canvas-actions">
                            <button class="btn btn-outline-secondary btn-sm me-2" id="reset-view">
                        ...
                        <div class="view-canvas" id="view-canvas">
                            <div class="empty-canvas-message">
                                <div class="text-center py-5">
                                    <i class="fas fa-layout fa-3x text-muted mb-3"></i>
                                    <h5 class="text-muted">Design Your Contract View</h5>
                                    <p class="text-muted">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    {{-- Available Fields --}}
                    <div class="col-md-4">
                        <h6 class="border-bottom pb-2 mb-3">Available Fields</h6>
                    ...
                    {{-- Selected Fields --}}
                    <div class="col-md-4">
                        <h6 class="border-bottom pb-2 mb-3">Section Fields</h6>
                        <div class="selected-fields" id="selected-fields">
                            <div class="fields-container" id="section-fields-container">
                                <div class="empty-fields-message text-center text-muted py-4">
...
<div class="modal fade" id="fieldConfigModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Configure Field Display</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
...
{{-- Custom Tab Modal --}}
<div class="modal fade" id="customTabModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Custom Tab</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" id="save-custom-tab">Add Tab</button>
            </div>
        </div>
    </div>
</div>
...
{{-- View Preview Modal --}}
<div class="modal fade" id="viewPreviewModal" tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">View Configuration Preview</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
                ...
                fieldElement.innerHTML = `
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <br><small class="text-muted">${field.key} (${field.type})</small>
                        </div>
        ...
        function createSectionElement(section) {
            ...
            sectionElement.innerHTML = `
                <div class="section-controls">
                    <button class="btn btn-primary btn-sm section-control-btn" onclick="editSection('${section.id}')" title="Edit Section">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button class="btn btn-outline-secondary btn-sm section-control-btn" onclick="duplicateSection('${section.id}')" title="Duplicate">
                        <i class="fas fa-copy"></i>
                    </button>
                    <button class="btn btn-danger btn-sm section-control-btn" onclick="removeSection('${section.id}')" title="Delete">
                ...
                <div class="section-header">
                    ...
                    <div class="section-meta">
                        <span class="badge bg-secondary">${section.layout}</span>
                        <span class="badge bg-info">${section.fields.length} fields</span>
                    </div>
                </div>
                ...
                <div class="section-content">
                    <div class="section-fields">
                        ${section.fields.length > 0 ? 
                            ...
                            `).join('') : 
                            '<div class="text-muted text-center py-3">No fields configured</div>'
                        }
                    </div>
                </div>
            `;
            ...
            container.innerHTML = section.fields.map(field => `
                <div class="section-field-item" data-field-key="${field.key}">
                    ...
                    <div class="field-actions">
                        <button class="btn btn-outline-primary btn-sm me-1" onclick="editFieldInSection('${field.key}')" title="Edit">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-outline-danger btn-sm" onclick="removeFieldFromSection('${field.key}')" title="Remove">
        ...
        function populateFieldConfigModal(field) {
            ...
            form.querySelector('[name="col_size"]').value = field.col_size || 'col-md-6';
        ...
        function saveFieldConfig() {
            ...
            currentEditingField.col_size = formData.get('col_size') || 'col-md-6';
            ...
            const tabHtml = `
                <div class="tab-config-item">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <input type="checkbox" class="form-check-input custom-tab-toggle" 
        ...
        function resetView() {
            if (confirm('Are you sure you want to reset the entire view configuration? This action cannot be undone.')) {
                viewCanvas.innerHTML = '<div class="empty-canvas-message"><div class="text-center py-5"><i class="fas fa-layout fa-3x text-muted mb-3"></i><h5 class="text-muted">Design Your Contract View</h5><p class="text-muted">Drag section templates from the left panel to build your contract detail view.<br>Each section can be customized with specific fields and layouts.</p></div></div>';
