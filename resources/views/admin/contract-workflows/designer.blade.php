        ...
        <div class="flex-1 px-6-12">
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Design custom workflows for contract processing</p>
                </div>
                <div>
                    <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-secondary mr-2" id="loadWorkflowBtn">
                        <i class="fas fa-folder-open"></i> Load Workflow
                    </button>
                    <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-info mr-2" id="previewWorkflowBtn">
                        <i class="fas fa-eye"></i> Preview
                    </button>
                    <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-success mr-2" id="saveWorkflowBtn">
                        <i class="fas fa-save"></i> Save Workflow
                    </button>
                    <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-primary" id="publishWorkflowBtn">
            ...
            <div class="flex flex-wrap -mx-4">
                {{-- Workflow Sidebar --}}
                <div class="flex-1 px-6-lg-3">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-6">
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-header">
                            <h6 class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-title mb-0">Workflow Properties</h6>
                        </div>
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                            <div class="mb-6">
                                <label for="workflowName" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Workflow Name</label>
                                <input type="text" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" id="workflowName" 
                                       placeholder="Enter workflow name...">
                            </div>
                            <div class="mb-6">
                                <label for="workflowDescription" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Description</label>
                                <textarea class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" id="workflowDescription" rows="3"
                                          placeholder="Describe this workflow..."></textarea>
                            </div>
                            <div class="mb-6">
                                <label for="contractType" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Contract Type</label>
                                <select class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" id="contractType">
                            ...
                            <div class="flex items-center form-switch">
                                <input class="flex items-center-input" type="checkbox" id="isActive" checked>
                                <label class="flex items-center-label" for="isActive">Active</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-header">
                            <h6 class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-title mb-0">Workflow Elements</h6>
                        </div>
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body p-2">
                            <div class="flex flex-wrap -mx-4 g-2">
                                <div class="flex-1 px-6-12">
                                    <small class="text-gray-600 dark:text-gray-400 font-bold">STATES</small>
                                </div>
                            ...
                            <div class="flex flex-wrap -mx-4 g-2">
                                <div class="flex-1 px-6-12">
                                    <small class="text-gray-600 dark:text-gray-400 font-bold">ACTIONS</small>
                                </div>
                                <div class="flex-1 px-6-6">
                            ...
                            <div class="flex flex-wrap -mx-4 g-2">
                                <div class="flex-1 px-6-12">
                                    <small class="text-gray-600 dark:text-gray-400 font-bold">LOGIC</small>
                                </div>
                                <div class="flex-1 px-6-6">
                ...
                {{-- Workflow Canvas --}}
                <div class="flex-1 px-6-lg-6">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-header">
                            <div class="flex justify-between items-center">
                                <h6 class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-title mb-0">Workflow Canvas</h6>
                                <div>
                                    <div class=" px-6 py-2 font-medium rounded-md transition-colors-group-sm">
                                        <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-secondary" id="zoomOut">
                                            <i class="fas fa-search-minus"></i>
                                        </button>
                                        <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-secondary" id="zoomReset">
                                            100%
                                        </button>
                                        <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-secondary" id="zoomIn">
                                            <i class="fas fa-search-plus"></i>
                                        </button>
                                    </div>
                                    <button type="button" class="btn px-4 py-1 text-sm px-6 py-2 font-medium rounded-md transition-colors-outline-danger ml-2" id="clearCanvas">
                            ...
                            <div id="workflowCanvas" class="workflow-canvas">
                                ...
                                <div class="canvas-content">
                                    ...
                                    <div class="drop-zone-message">
                                        ...
                                        <h5 class="text-gray-600 dark:text-gray-400">Design Your Workflow</h5>
                                        <p class="text-gray-600 dark:text-gray-400">Drag elements from the palette to create your contract workflow</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex-1 px-6-lg-3">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-header">
                            <h6 class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-title mb-0">Element Properties</h6>
                        </div>
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                            <div id="nodeProperties">
                                <div class="text-center text-gray-600 dark:text-gray-400 py-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mt-6">
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-header">
                            <h6 class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-title mb-0">Workflow Statistics</h6>
                        </div>
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                            <div class="flex flex-wrap -mx-4 text-center">
                                <div class="flex-1 px-6-6">
                                    ...
                                    <small class="text-gray-600 dark:text-gray-400">Nodes</small>
                                    <div class="font-bold" id="nodeCount">0</div>
                                </div>
                                <div class="flex-1 px-6-6">
                                    <div class="text-green-600 dark:text-green-400">
                                        <i class="fas fa-arrow-right fa-lg"></i>
                                    </div>
                                    <small class="text-gray-600 dark:text-gray-400">Connections</small>
                                    <div class="font-bold" id="connectionCount">0</div>
                                </div>
                            </div>
                            <hr>
                            <div class="small">
                                <div class="flex justify-between">
                                    ...
                                    <span id="validationStatus" class="text-yellow-600 dark:text-yellow-400">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mt-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                            <div class="grid gap-2">
                                <button type="button" class="btn px-4 py-1 text-sm px-6 py-2 font-medium rounded-md transition-colors-outline-primary" id="addStartNode">
                                    <i class="fas fa-play"></i> Add Start Node
                                </button>
                                <button type="button" class="btn px-4 py-1 text-sm px-6 py-2 font-medium rounded-md transition-colors-outline-success" id="addEndNode">
                                    <i class="fas fa-stop"></i> Add End Node
                                </button>
                                <button type="button" class="btn px-4 py-1 text-sm px-6 py-2 font-medium rounded-md transition-colors-outline-info" id="autoLayout">
                                    <i class="fas fa-magic"></i> Auto Layout
                                </button>
                                <button type="button" class="btn px-4 py-1 text-sm px-6 py-2 font-medium rounded-md transition-colors-outline-secondary" id="exportWorkflow">
...
{{-- Load Workflow Modal --}}
<div class="fixed inset-0 z-50 overflow-y-auto fade" id="loadWorkflowModal" tabindex="-1">
    <div class="flex items-center justify-center min-h-screen fixed inset-0 z-50 overflow-y-auto-lg">
        <div class="fixed inset-0 z-50 overflow-y-auto-content">
            <div class="fixed inset-0 z-50 overflow-y-auto-header">
                <h5 class="fixed inset-0 z-50 overflow-y-auto-title">Load Workflow</h5>
            ...
            <div class="fixed inset-0 z-50 overflow-y-auto-body">
                <div class="flex flex-wrap -mx-4">
                    <div class="flex-1 px-6-12">
                        ...
                        <div id="savedWorkflows" class="divide-y divide-gray-200 dark:divide-gray-700 divide-y divide-gray-200 dark:divide-gray-700-flush">
                ...
                <div class="flex flex-wrap -mx-4">
                    <div class="flex-1 px-6-12">
                        ...
                        <input type="file" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="workflowFileInput" accept=".json">
            ...
            <div class="fixed inset-0 z-50 overflow-y-auto-footer">
                ...
                <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-primary" id="loadSelectedWorkflow">Load Workflow</button>
            </div>
        </div>
    </div>
</div>
...
{{-- Save Workflow Modal --}}
<div class="fixed inset-0 z-50 overflow-y-auto fade" id="saveWorkflowModal" tabindex="-1">
    <div class="fixed inset-0 z-50 overflow-y-auto-dialog">
        <div class="fixed inset-0 z-50 overflow-y-auto-content">
            <div class="fixed inset-0 z-50 overflow-y-auto-header">
                <h5 class="fixed inset-0 z-50 overflow-y-auto-title">Save Workflow</h5>
                <button type="button" class="px-6 py-2 font-medium rounded-md transition-colors-close" ></button>
            </div>
            <form id="saveWorkflowForm">
                <div class="fixed inset-0 z-50 overflow-y-auto-body">
                    <div class="mb-6">
                        <label for="saveWorkflowName" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Workflow Name</label>
                        <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="saveWorkflowName" required>
                    </div>
                    <div class="mb-6">
                        <label for="saveWorkflowVersion" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Version</label>
                        <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="saveWorkflowVersion" value="1.0">
                    </div>
                    <div class="mb-6">
                        <label for="saveWorkflowNotes" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Notes</label>
                        <textarea class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="saveWorkflowNotes" rows="3" 
                                  placeholder="Optional notes about this version..."></textarea>
                    </div>
                    <div class="flex items-center">
                        <input class="flex items-center-input" type="checkbox" id="saveAsTemplate">
                        <label class="flex items-center-label" for="saveAsTemplate">
                ...
                <div class="fixed inset-0 z-50 overflow-y-auto-footer">
                    <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-secondary" >Cancel</button>
                    <button type="submit" class="btn px-6 py-2 font-medium rounded-md transition-colors-primary">Save Workflow</button>
                </div>
            </form>
        </div>
    </div>
...
{{-- Preview Modal --}}
<div class="fixed inset-0 z-50 overflow-y-auto fade" id="previewWorkflowModal" tabindex="-1">
    <div class="flex items-center justify-center min-h-screen fixed inset-0 z-50 overflow-y-auto-xl">
        <div class="fixed inset-0 z-50 overflow-y-auto-content">
            <div class="fixed inset-0 z-50 overflow-y-auto-header">
                <h5 class="fixed inset-0 z-50 overflow-y-auto-title">Workflow Preview</h5>
                <button type="button" class="px-6 py-2 font-medium rounded-md transition-colors-close" ></button>
            </div>
            <div class="fixed inset-0 z-50 overflow-y-auto-body">
                <div class="flex flex-wrap -mx-4">
                    <div class="flex-1 px-6-md-6">
                        ...
                        <div id="previewDiagram" class="border rounded p-6 bg-light" style="min-height: 300px;">
            ...
            <div class="fixed inset-0 z-50 overflow-y-auto-footer">
                ...
                <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-primary" id="previewTestRun">Test Run</button>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function generatePropertiesForm(nodeData) {
        const baseForm = `
            <div class="mb-6">
                ...
                <input type="text" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" name="name" 
                       value="${nodeData.properties.name || ''}" required>
            </div>
            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Description</label>
                <textarea class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" name="description" rows="2"
        ...
        switch (nodeData.type) {
            case 'status':
                specificForm = `
                    <div class="mb-6">
                        ...
                        <select class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" name="status">
            ...
            case 'approval':
                specificForm = `
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Approver</label>
                        <select class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" name="approver">
            ...
            case 'notification':
                specificForm = `
                    <div class="mb-6">
                        ...
                        <select class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" name="recipients" multiple>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" name="message" rows="3"
                ...
                specificForm = `
                    <div class="flex flex-wrap -mx-4">
                        <div class="flex-1 px-6-8">
                            ...
                            <input type="number" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" name="duration" 
                        ...
                        <div class="flex-1 px-6-4">
                            ...
                            <select class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm-sm" name="unit">
    ...
    function updateStats() {
        ...
        if (hasStart && hasEnd && workflowData.nodes.length > 0) {
            ...
            validationElement.className = 'text-green-600 dark:text-green-400';
        } else {
            validationElement.innerHTML = '<i class="fas fa-exclamation-triangle"></i> Incomplete';
            validationElement.className = 'text-yellow-600 dark:text-yellow-400';
        }
    ...
    function loadSavedWorkflows() {
        ...
        container.innerHTML = savedWorkflows.map(workflow => `
            <div class="divide-y divide-gray-200 dark:divide-gray-700-item divide-y divide-gray-200 dark:divide-gray-700-item-action" data-workflow-id="${workflow.id}">
    ...
    function generateWorkflowPreview() {
        ...
        previewDiagram.innerHTML = '<p class="text-gray-600 dark:text-gray-400">Workflow diagram preview would be shown here</p>';
        
        // Generate steps list
        const steps = workflowData.nodes.map((node, index) => `
            <div class="flex items-center mb-2">
                <div class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-primary rounded-full mr-2" style="width: 24px; height: 24px; line-height: 24px;">${index + 1}</div>
                <div>
                    <strong>${node.properties.name || node.type}</strong>
                    ${node.properties.description ? `<br><small class="text-gray-600 dark:text-gray-400">${node.properties.description}</small>` : ''}
                </div>
            </div>
        `).join('');
        
        previewSteps.innerHTML = steps || '<p class="text-gray-600 dark:text-gray-400">No workflow steps defined</p>';
    }
