        ...
        <div class="flex-1 px-6-12">
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-0">Design and configure dynamic contract forms</p>
                </div>
                <div class="form-actions">
                    <button class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-secondary mr-2" id="preview-form">
                        <i class="fas fa-eye"></i> Preview
                    </button>
                    <button class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-success mr-2" id="save-draft">
                        <i class="fas fa-save"></i> Save Draft
                    </button>
                    <button class="btn px-6 py-2 font-medium rounded-md transition-colors-success" id="publish-form">
            ...
            <div class="design-sidebar">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                        <form id="form-config">
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="form-name">Form Name</label>
                                <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="form-name" placeholder="Enter form name" required>
                            </div>
                            ...
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="form-description">Description</label>
                                <textarea class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="form-description" rows="3" 
                                          placeholder="Brief description of this form"></textarea>
                            </div>
                            
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="form-status">Status</label>
                                <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="form-status">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" class="flex items-center-input" id="allow-client-access">
                                <label class="flex items-center-label" for="allow-client-access">
                                    Allow client access
                                </label>
                            </div>
                        </form>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-body">
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="form-layout">Form Layout</label>
                            <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="form-layout">
                        ...
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="form-style">Form Style</label>
                            <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="form-style">
                        ...
                        <div class="flex items-center mb-2">
                            <input type="checkbox" class="flex items-center-input" id="show-progress" checked>
                            <label class="flex items-center-label" for="show-progress">
                                Show progress indicator
                            </label>
                        </div>
                        
                        <div class="flex items-center mb-2">
                            <input type="checkbox" class="flex items-center-input" id="enable-validation">
                            <label class="flex items-center-label" for="enable-validation">
                                Enable client-side validation
                            </label>
                        </div>
                        
                        <div class="flex items-center">
                            <input type="checkbox" class="flex items-center-input" id="auto-save">
                            <label class="flex items-center-label" for="auto-save">
                                Auto-save draft
                            </label>
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden-header flex justify-between items-center">
                        ...
                        <div class="canvas-actions">
                            <button class="btn border border-gray-600 text-gray-600 hover:bg-gray-50 px-6 py-2 font-medium rounded-md transition-colors-sm mr-2" id="clear-form">
                        ...
                        <div class="form-drop-zone" id="form-canvas">
                            <div class="empty-canvas-message">
                                <div class="text-center py-8">
                                    <i class="fas fa-mouse-pointer fa-3x text-gray-600 dark:text-gray-400 mb-6"></i>
                                    <h5 class="text-gray-600 dark:text-gray-400">Start Building Your Form</h5>
    ...
    <div class="flex items-center justify-center min-h-screen fixed inset-0 z-50 overflow-y-auto-lg">
        <div class="fixed inset-0 z-50 overflow-y-auto-content">
            <div class="fixed inset-0 z-50 overflow-y-auto-header">
                <h5 class="fixed inset-0 z-50 overflow-y-auto-title">Configure Field</h5>
                ...
                <form id="field-config-form">
                    <div class="flex flex-wrap -mx-4">
                        ...
                        <div class="flex-1 px-6-md-6">
                            ...
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="field-label">Field Label</label>
                                <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="field-label" name="label" required>
                            </div>
                            
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="field-slug">Field Key</label>
                                <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="field-slug" name="field_slug" required>
                                <small class="form-text text-gray-600 dark:text-gray-400">Used for database storage (auto-generated from label)</small>
                            </div>
                            
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="field-placeholder">Placeholder</label>
                                <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="field-placeholder" name="placeholder">
                            </div>
                            
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="field-help-text">Help Text</label>
                                <textarea class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="field-help-text" name="help_text" rows="2"></textarea>
                            </div>
                            
                            <div class="flex flex-wrap -mx-4">
                                <div class="flex-1 px-6-6">
                                    <div class="flex items-center">
                                        <input type="checkbox" class="flex items-center-input" id="is-required" name="is_required">
                                        <label class="flex items-center-label" for="is-required">Required</label>
                                    </div>
                                </div>
                                <div class="flex-1 px-6-6">
                                    <div class="flex items-center">
                                        <input type="checkbox" class="flex items-center-input" id="is-readonly" name="is_readonly">
                                        <label class="flex items-center-label" for="is-readonly">Read Only</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex-1 px-6-md-6">
                            <h6 class="border-b pb-2 mb-6">Field Options</h6>
                        ...
                        <div class="flex-1 px-6-12 mt-6">
                            <h6 class="border-b pb-2 mb-6">Layout & Display</h6>
                            <div class="flex flex-wrap -mx-4">
                                <div class="flex-1 px-6-md-4">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="column-width">Column Width</label>
                                    <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="column-width" name="column_width">
                                ...
                                <div class="flex-1 px-6-md-4">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="sort-order">Display Order</label>
                                    <input type="number" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="sort-order" name="sort_order" min="0">
                                </div>
                                <div class="flex-1 px-6-md-4">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="section-id">Section</label>
                                    <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="section-id" name="section_id">
                        ...
                        {{-- Conditional Logic --}}
                        <div class="flex-1 px-6-12 mt-6">
                            <h6 class="border-b pb-2 mb-6">Conditional Logic</h6>
                            <div class="conditional-rules" id="conditional-rules">
                                <button type="button" class="btn border border-blue-600 text-blue-600 hover:bg-blue-50 px-6 py-2 font-medium rounded-md transition-colors-sm" id="add-condition">
            ...
            <div class="fixed inset-0 z-50 overflow-y-auto-body">
                <form id="section-config-form">
                    ...
                    <div class="flex flex-wrap -mx-4">
                        <div class="flex-1 px-6-6">
                            <div class="flex items-center">
                                <input type="checkbox" class="flex items-center-input" id="is-collapsible" name="is_collapsible">
                                <label class="flex items-center-label" for="is-collapsible">Collapsible</label>
                            </div>
                        </div>
                        <div class="flex-1 px-6-6">
                            <div class="flex items-center">
                                <input type="checkbox" class="flex items-center-input" id="is-expanded" name="is_expanded">
                                <label class="flex items-center-label" for="is-expanded">Expanded by Default</label>
                            </div>
                        </div>
                    </div>
                </form>
...
{{-- Form Preview Modal --}}
<div class="fixed inset-0 z-50 overflow-y-auto fade" id="formPreviewModal" tabindex="-1">
    <div class="flex items-center justify-center min-h-screen fixed inset-0 z-50 overflow-y-auto-xl">
        <div class="fixed inset-0 z-50 overflow-y-auto-content">
            <div class="fixed inset-0 z-50 overflow-y-auto-header">
                <h5 class="fixed inset-0 z-50 overflow-y-auto-title">Form Preview</h5>
                <button type="button" class="px-6 py-2 font-medium rounded-md transition-colors-close" ></button>
            </div>
            <div class="fixed inset-0 z-50 overflow-y-auto-body">
            ...
            <div class="fixed inset-0 z-50 overflow-y-auto-footer">
                ...
                <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-primary" id="test-form">Test Form</button>
            </div>
        </div>
    </div>
</div>
...
<style>
    ...
    .conditional-rule .flex flex-wrap {
        align-items: end;
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function createFieldElement(field) {
            ...
            fieldElement.innerHTML = `
                <div class="field-controls">
                    <button class="btn bg-blue-600 text-white hover:bg-blue-700 px-4 py-1 text-sm field-control-px-6 py-2 font-medium rounded-md transition-colors" onclick="editField('${field.id}')" title="Edit">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button class="btn border border-gray-600 text-gray-600 hover:bg-gray-50 px-4 py-1 text-sm field-control-px-6 py-2 font-medium rounded-md transition-colors" onclick="duplicateField('${field.id}')" title="Duplicate">
                        <i class="fas fa-copy"></i>
                    </button>
                    <button class="btn bg-red-600 text-white hover:bg-red-700 px-4 py-1 text-sm field-control-px-6 py-2 font-medium rounded-md transition-colors" onclick="removeField('${field.id}')" title="Delete">
                ...
                <div class="field-preview">
                    <div class="flex items-center mb-2">
                        <i class="${fieldTypes[field.type] || 'fas fa-question'} field-icon mr-2"></i>
                        <strong>${field.label || 'Untitled Field'}</strong>
                        ${field.is_required ? '<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-danger ml-2">Required</span>' : ''}
                    </div>
                    ...
                    ${field.help_text ? `<small class="text-gray-600 dark:text-gray-400">${field.help_text}</small>` : ''}
                </div>
            `;
        ...
        function generateFieldPreview(field) {
            switch (field.type) {
                ...
                case 'currency':
                case 'percentage':
                    return `<input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="${field.placeholder || 'Enter value...'}" disabled>`;
                    
                case 'textarea':
                    return `<textarea class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" rows="3" placeholder="${field.placeholder || 'Enter text...'}" disabled></textarea>`;
                    
                case 'select':
                    return `<select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" disabled>
                                <option>${field.placeholder || 'Select option...'}</option>
                                ${field.options.map(opt => `<option>${opt.label || opt}</option>`).join('')}
                            </select>`;
                            
                case 'multiselect':
                    return `<select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" multiple disabled>
                                ${field.options.map(opt => `<option>${opt.label || opt}</option>`).join('')}
                            </select>`;
                ...
                case 'radio':
                    return field.options.map((opt, i) => `
                        <div class="flex items-center">
                            <input class="flex items-center-input" type="radio" disabled>
                            <label class="flex items-center-label">${opt.label || opt}</label>
                        </div>
                    `).join('');
                ...
                case 'checkbox':
                    return field.options.map((opt, i) => `
                        <div class="flex items-center">
                            <input class="flex items-center-input" type="checkbox" disabled>
                            <label class="flex items-center-label">${opt.label || opt}</label>
                        </div>
                    `).join('');
                    
                case 'date':
                    return `<input type="date" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" disabled>`;
                    
                case 'datetime':
                    return `<input type="datetime-local" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" disabled>`;
                    
                case 'file':
                    return `<input type="file" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" disabled>`;
                ...
                case 'json':
                    return `<textarea class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" rows="4" placeholder="JSON data..." disabled></textarea>`;
                    
                default:
                    return `<input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="${field.placeholder || 'Field preview'}" disabled>`;
            }
        }
        ...
        function populateFieldConfigModal(field) {
            ...
            // Layout settings
            form.querySelector('[name="column_width"]').value = field.column_width || 'md:w-1/2';
        ...
        function generateFieldSpecificConfig(field) {
            ...
            switch (field.type) {
                ...
                case 'checkbox':
                    container.innerHTML = `
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="options-container">Options</label>
                            <div id="options-container">
                                ${(field.options || []).map((opt, i) => `
                                    <div class="flex mb-2">
                                        <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm option-input" 
                                               value="${typeof opt === 'object' ? opt.label : opt}" 
                                               placeholder="Option ${i + 1}">
                                        <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-danger remove-option">
                                            <i class="fas fa-times"></i>
                                        </button>
                                    </div>
                                `).join('')}
                            </div>
                            <button type="button" class="btn border border-blue-600 text-blue-600 hover:bg-blue-50 px-6 py-2 font-medium rounded-md transition-colors-sm" id="add-option">
                                <i class="fas fa-plus"></i> Add Option
                            </button>
                        </div>
                        ${field.type === 'multiselect' ? `
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="max-selections">Maximum Selections</label>
                                <input type="number" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="max-selections" name="max_selections" 
                ...
                case 'percentage':
                    container.innerHTML = `
                        <div class="flex flex-wrap -mx-4">
                            <div class="flex-1 px-6-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="min-value">Minimum Value</label>
                                <input type="number" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="min-value" name="min_value" 
                                       value="${field.ui_config?.min || ''}" step="any">
                            </div>
                            <div class="flex-1 px-6-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="max-value">Maximum Value</label>
                                <input type="number" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="max-value" name="max_value" 
                                       value="${field.ui_config?.max || ''}" step="any">
                            </div>
                        </div>
                        <div class="mt-6">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="step-value">Step</label>
                            <input type="number" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="step-value" name="step_value" 
                                   value="${field.ui_config?.step || (field.type === 'percentage' ? '1' : '1')}" step="any">
                        </div>
                        ${field.type === 'currency' ? `
                            <div class="mt-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="currency-symbol">Currency Symbol</label>
                                <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="currency-symbol" name="currency_symbol" 
                ...
                case 'textarea':
                    container.innerHTML = `
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="textarea-rows">Rows</label>
                            <input type="number" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="textarea-rows" name="textarea_rows" 
                                   value="${field.ui_config?.rows || '4'}" min="2" max="20">
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" class="flex items-center-input" id="enable-wysiwyg" name="enable_wysiwyg" 
                                   ${field.ui_config?.wysiwyg ? 'checked' : ''}>
                            <label class="flex items-center-label" for="enable-wysiwyg">Enable WYSIWYG Editor</label>
                        </div>
                    `;
                    break;
                ...
                case 'file':
                    container.innerHTML = `
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="allowed-types">Allowed File Types</label>
                            <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="allowed-types" name="allowed_types" 
                                   value="${(field.ui_config?.accept_types || []).join(', ')}"
                                   placeholder="image/*, .pdf, .doc">
                            <small class="form-text text-gray-600 dark:text-gray-400">Comma-separated list of MIME types or extensions</small>
                        </div>
                        <div class="flex flex-wrap -mx-4">
                            <div class="flex-1 px-6-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="max-file-size">Max File Size (MB)</label>
                                <input type="number" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="max-file-size" name="max_file_size" 
                                       value="${field.ui_config?.max_file_size || '10'}" min="1">
                            </div>
                            <div class="flex-1 px-6-6">
                                <div class="flex items-center mt-6">
                                    <input type="checkbox" class="flex items-center-input" id="allow-multiple" name="allow_multiple" 
                                           ${field.ui_config?.multiple ? 'checked' : ''}>
                                    <label class="flex items-center-label" for="allow-multiple">Allow Multiple Files</label>
                                </div>
                            </div>
                        </div>
                    `;
                ...
                case 'datetime':
                    container.innerHTML = `
                        <div class="flex flex-wrap -mx-4">
                            <div class="flex-1 px-6-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="min-date">Min Date</label>
                                <input type="date" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="min-date" name="min_date" 
                                       value="${field.ui_config?.min_date || ''}">
                            </div>
                            <div class="flex-1 px-6-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="max-date">Max Date</label>
                                <input type="date" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="max-date" name="max_date" 
        ...
        function setupOptionsEditor(field) {
            ...
            if (addOptionBtn) {
                addOptionBtn.addEventListener('click', function() {
                    const optionHtml = `
                        <div class="flex mb-2">
                            <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm option-input" placeholder="New option">
                            <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-danger remove-option">
                                <i class="fas fa-times"></i>
                            </button>
                        </div>
        ...
        function addConditionalRuleUI(rule = null, index = null) {
            ...
            const ruleHtml = `
                <div class="conditional-rule">
                    <div class="flex flex-wrap -mx-4">
                        <div class="flex-1 px-6-md-3">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="condition-field">Field</label>
                            <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm condition-field" id="condition-field">
                        ...
                        <div class="flex-1 px-6-md-2">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="condition-operator">Operator</label>
                            <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm condition-operator" id="condition-operator">
                        ...
                        <div class="flex-1 px-6-md-3">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="condition-value">Value</label>
                            <input type="text" class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm condition-value" id="condition-value" 
                                   value="${rule ? rule.value : ''}" placeholder="Comparison value">
                        </div>
                        <div class="flex-1 px-6-md-2">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="condition-action">Action</label>
                            <select class="block w-full px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm condition-action" id="condition-action">
                        ...
                        <div class="flex-1 px-6-md-2">
                            ...
                            <button type="button" class="btn px-6 py-2 font-medium rounded-md transition-colors-outline-danger w-100 remove-condition">
                                <i class="fas fa-times"></i>
                            </button>
                        </div>
                    </div>
        ...
        function saveFieldConfig() {
            ...
            currentEditingField.column_width = formData.get('column_width') || 'md:w-1/2';
        ...
        function updateFormLayout() {
            ...
            formData.fields.forEach(field => {
                if (layout === 'single-column') {
                    field.column_width = 'w-12/12';
                } else if (layout === 'three-column') {
                    field.column_width = 'md:w-1/3';
                } else {
                    field.column_width = 'md:w-1/2';
                }
            });
        ...
        function clearForm() {
            if (confirm('Are you sure you want to clear the entire form? This action cannot be undone.')) {
                formCanvas.innerHTML = '<div class="empty-canvas-message"><div class="text-center py-8"><i class="fas fa-mouse-pointer fa-3x text-gray-600 dark:text-gray-400 mb-6"></i><h5 class="text-gray-600 dark:text-gray-400">Start Building Your Form</h5><p class="text-gray-600 dark:text-gray-400">Drag and drop components from the left panel to build your form.<br>You can also click "Add Section" to organize your fields.</p></div></div>';
