            ...
            <div class="bg-white shadow rounded-lg mb-6">
                <div class="px-6 py-6 border-b border-gray-200">
                    <div class="flex justify-between items-center">
                        ...
                        <button type="button" id="add-item" 
                                class="inline-flex items-center px-6 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                            <svg class="-ml-1 mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="p-6">
                    <div id="invoice-items" class="space-y-4">
                        ...
                        <div class="invoice-item border border-gray-200 rounded-lg p-6 bg-gray-50" data-index="{{ $index }}">
                            <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                                <div class="md:flex-1 px-6-span-5">
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Description</label>
                                    <textarea name="items[{{ $index }}][description]" rows="2" required 
                                              class="w-full px-6 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">{{ old('items.'.$index.'.description', $item->description) }}</textarea>
                                ...
                                <div class="md:flex-1 px-6-span-2">
                                    ...
                                    <input type="number" name="items[{{ $index }}][quantity]" value="{{ old('items.'.$index.'.quantity', $item->quantity) }}" 
                                           ...
                                           class="item-quantity w-full px-6 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                <div class="md:flex-1 px-6-span-2">
                                    ...
                                    <input type="number" name="items[{{ $index }}][rate]" value="{{ old('items.'.$index.'.rate', number_format($item->rate, 2, '.', '')) }}" 
                                           ...
                                           class="item-rate w-full px-6 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                <div class="md:flex-1 px-6-span-2">
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Total</label>
                                    <div class="item-total w-full px-6 py-2 bg-gray-100 border border-gray-300 rounded-md text-right font-semibold">
...
<div id="details-modal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-8 border w-11/12 max-w-2xl shadow-lg rounded-md bg-white">
        <div class="mt-6">
            <h3 class="text-lg font-medium text-gray-900 mb-6">Edit Invoice Details</h3>
            ...
            <form id="details-form" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="modal-client_id" class="w-full px-6 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div>
                        ...
                        <select id="modal-category_id" class="w-full px-6 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div>
                        ...
                        <select id="modal-currency_code" class="w-full px-6 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div>
                        ...
                        <select id="modal-status" class="w-full px-6 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="date" id="modal-date" value="{{ $invoice->date->format('Y-m-d') }}" 
                               class="w-full px-6 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                ...
                <div>
                    ...
                    <textarea id="modal-note" rows="3" 
                              ...
                              class="w-full px-6 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">{{ $invoice->note }}</textarea>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('add-item').addEventListener('click', function() {
        ...
        const itemHtml = `
            <div class="invoice-item border border-gray-200 rounded-lg p-6 bg-gray-50" data-index="${itemIndex}">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    <div class="md:flex-1 px-6-span-5">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Description</label>
                        <textarea name="items[${itemIndex}][description]" rows="2" required 
                                  class="w-full px-6 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"></textarea>
                    </div>
                    <div class="md:flex-1 px-6-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Quantity</label>
