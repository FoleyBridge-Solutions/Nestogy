...
<div class="max-w-7xl mx-auto space-y-6" x-data="assetAssignmentManager(@json($contract), @json($availableAssets), @json($assignedAssets))">
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div class="space-y-4">
            ...
            <!-- Advanced Filters -->
            <div x-show="showAssetFilters" x-transition class="grid grid-cols-1 md:grid-cols-4 gap-4 p-6 bg-gray-50 rounded-lg">
                <div>
                ...
                <template x-for="asset in filteredAssets" :key="asset.id">
                    <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow cursor-pointer"
                        ...
                        <div x-show="isAssetAssigned(asset) && getAssetBillingRate(asset)" 
                             class="mt-6 pt-3 border-t border-gray-200">
