...
@php
$breadcrumbs = [
    ['label' => 'Financial', 'url' => route('financial.contracts.index')],
    ['label' => 'Contracts', 'url' => route('financial.contracts.index')],
...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900" x-data="{ activeTab: 'overview', mobileMenuOpen: false, contract: @js($contract->only(['id', 'title', 'status', 'contract_number', 'contract_value'])) }">
    ...
    <!-- Tab Content -->
        <!-- Overview Tab -->
        <div x-show="activeTab === 'overview'" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    @if($contract->isActive())
                        <x-content-card>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Contract Progress</h3>
                ...
                <div class="space-y-6">
                    ...
                    <x-content-card>
                        ...
                        <div class="space-y-2">
                            <a href="{{ route('financial.contracts.pdf', $contract) }}" 
                               target="_blank"
                               class="w-full inline-flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    ...
                    @if($contract->isActive())
                        <x-content-card>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Contract Metrics</h3>
                            <div class="space-y-4">
        ...
        <!-- Schedules Tab -->
        <div x-show="activeTab === 'schedules'" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="space-y-8">
        ...
        <!-- Billing Tab -->
        <div x-show="activeTab === 'billing'" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="space-y-8">
                <!-- Billing Overview -->
                <x-content-card>
                ...
                <x-content-card>
                    ...
                    @if($contract->getSupportedAssetTypes())
                        <div class="mt-6">
                            <h4 class="text-sm font-medium text-gray-900 dark:text-gray-100 mb-3">Supported Asset Types</h4>
        ...
        <!-- History Tab -->
        <div x-show="activeTab === 'history'" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <x-content-card>
