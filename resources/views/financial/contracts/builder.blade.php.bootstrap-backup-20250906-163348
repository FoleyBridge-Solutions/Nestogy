...
@section('header')
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
            <button type="button" id="save-draft" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">
                Save Draft
            </button>
            <button type="button" id="preview-contract" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">
                Preview
            </button>
            <button type="button" id="save-contract" class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600">
                Create Contract
            </button>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sticky top-4">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Component Library</h3>
                ...
                <div class="space-y-2 max-h-96 overflow-y-auto">
                    <template x-for="component in filteredComponents" :key="component.id">
                        <div class="border border-gray-200 rounded-md p-3 cursor-pointer hover:bg-gray-50 transition-colors"
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <!-- Drop Zone -->
                <div class="min-h-96 border-2 border-dashed border-gray-300 rounded-lg p-4"
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sticky top-4">
                ...
                <div class="mt-6 space-y-2">
                    <button type="button" @click="clearAll()" 
                            class="w-full bg-red-50 text-red-700 border border-red-200 rounded-md px-3 py-2 text-sm hover:bg-red-100">
                        Clear All Components
                    </button>
                    
                    <button type="button" @click="loadTemplate()" 
                            class="w-full bg-blue-50 text-blue-700 border border-blue-200 rounded-md px-3 py-2 text-sm hover:bg-blue-100">
                        Load from Template
                    </button>
                </div>
            </div>
...
<div x-show="showTemplateModal" x-cloak
    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <h3 class="text-lg font-medium text-gray-900 mb-4">Load Contract Template</h3>
