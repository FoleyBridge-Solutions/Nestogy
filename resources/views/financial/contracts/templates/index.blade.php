    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                            ...
                            <a href="{{ route('financial.contracts.templates.edit', $template) }}" 
                               class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Edit Template</a>
        ...
        <div class="col-span-full">
            <div class="text-center py-12">
                ...
                <h3 class="mt-4 text-lg font-medium text-gray-900">No contract templates found</h3>
