    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <form action="{{ route('financial.contracts.templates.store') }}" method="POST" @submit="prepareSubmission">
            ...
            <div x-show="currentStep === 2" x-transition class="space-y-6">
                <div>
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Choose Billing Model</h3>
                ...
                <div x-show="form.billing_model && form.billing_model !== 'fixed'" class="mt-8">
                    <div class="bg-gray-50 rounded-lg p-6">
                        <h4 class="font-medium text-gray-900 mb-4">Billing Configuration</h4>
                        
                        <!-- Asset Billing Rules -->
                        <div x-show="['per_asset', 'hybrid'].includes(form.billing_model)" class="mb-6">
                            <h5 class="text-sm font-medium text-gray-700 mb-3">Asset Billing Rules</h5>
                            <div class="space-y-3">
                        ...
                        <div x-show="['per_contact', 'hybrid'].includes(form.billing_model)">
                            <h5 class="text-sm font-medium text-gray-700 mb-3">Contact Access Tiers</h5>
                            <div class="space-y-3">
            ...
            <div x-show="currentStep === 3" x-transition class="space-y-6">
                <div>
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Template Content</h3>
                    <p class="text-sm text-gray-600 mb-6">Define the contract content using variables for dynamic values.</p>
                </div>

                <!-- Variable Fields -->
                <div class="bg-gray-50 rounded-lg p-6 mb-6">
                    <h4 class="font-medium text-gray-900 mb-4">Variable Fields</h4>
                    <p class="text-sm text-gray-600 mb-4">Define variables that can be customized for each contract. Use {{variable_name}} in the content.</p>
            ...
            <div x-show="currentStep === 4" x-transition class="space-y-6">
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    <h4 class="font-medium text-gray-900 mb-4">Auto Assignment Rules</h4>
                    <p class="text-sm text-gray-600 mb-4">Define rules for automatically assigning assets and contacts to contracts.</p>
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    <h4 class="font-medium text-gray-900 mb-4">Custom Calculation Formulas</h4>
                    <p class="text-sm text-gray-600 mb-4">Define custom formulas for complex billing calculations (optional).</p>
