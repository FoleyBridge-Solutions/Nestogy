...
$breadcrumbs = [
    ...
    ['name' => 'Contact Assignments', 'active' => true]
];
@endphp
...
<div class="max-w-7xl mx-auto space-y-6" x-data="contactAssignmentManager(@json($contract), @json($availableContacts), @json($assignedContacts), @json($accessTiers))">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <template x-for="tier in accessTiers" :key="tier.id">
                <div class="border border-gray-200 rounded-lg p-4">
                    ...
                    <p class="text-sm text-gray-600 mb-3" x-text="tier.description || 'Portal access tier'"></p>
            ...
            <!-- No Tiers State -->
            <div x-show="accessTiers.length === 0" class="col-span-3 text-center py-8">
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div class="space-y-4">
            ...
            <!-- Advanced Filters -->
            <div x-show="showContactFilters" x-transition class="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <template x-for="contact in filteredContacts" :key="contact.id">
                    <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow"
                        ...
                        <div x-show="isContactAssigned(contact)" class="mt-3 pt-3 border-t border-gray-200">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Access Tier</label>
    ...
    <div x-show="showTierManagementModal" 
        ...
        <div @click.away="showTierManagementModal = false"
            ...
            <div class="p-6">
                <p class="text-sm text-gray-600 mb-4">Configure access tiers and pricing for contact portal access.</p>
        ...
        <div @click.away="showBulkAssignModal = false"
            ...
            <div class="p-6 space-y-4">
                ...
                <div x-show="bulkAction === 'assign'">
                    ...
                    <select x-model="bulkAssignTier" class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                        <option value="">Select tier...</option>
                        <template x-for="tier in accessTiers" :key="tier.id">
                            <option :value="tier.id" x-text="tier.name"></option>
                        </template>
