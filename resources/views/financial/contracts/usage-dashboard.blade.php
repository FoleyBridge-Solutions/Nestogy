...
$breadcrumbs = [
    ...
    ['name' => 'Usage Dashboard', 'active' => true]
];
@endphp
...
<div class="max-w-7xl mx-auto space-y-6" x-data="usageDashboard(@json($contract), @json($billingData))">
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            <h3 class="font-medium text-gray-900 mb-3">Billing Trend</h3>
            ...
            <table class="min-w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Monthly Rate</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Period Total</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    <template x-for="asset in assetDetails" :key="asset.id">
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900" x-text="formatDate(asset.assigned_date)"></td>
                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900" x-text="'$' + asset.monthly_rate.toFixed(2)"></td>
                            <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900" x-text="'$' + asset.period_total.toFixed(2)"></td>
                        </tr>
                    </template>
                </tbody>
            </table>
            ...
            <table class="min-w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Access Tier</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Portal Usage</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Assigned Date</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Monthly Rate</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Period Total</th>
                    </tr>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <template x-for="contact in contactDetails" :key="contact.id">
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900" x-text="formatDate(contact.assigned_date)"></td>
                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900" x-text="'$' + contact.monthly_rate.toFixed(2)"></td>
                            <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900" x-text="'$' + contact.period_total.toFixed(2)"></td>
                        </tr>
                    </template>
                </tbody>
            </table>
            ...
            <table class="min-w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Calculation Date</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Asset Billing</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Contact Billing</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <template x-for="calculation in filteredCalculations" :key="calculation.id">
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900" x-text="calculation.billing_period"></td>
                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900" x-text="formatDate(calculation.calculated_at)"></td>
                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900" x-text="'$' + calculation.asset_billing_amount.toFixed(2)"></td>
                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900" x-text="'$' + calculation.contact_billing_amount.toFixed(2)"></td>
                            <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900" x-text="'$' + calculation.total_amount.toFixed(2)"></td>
                            <td class="px-4 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"
