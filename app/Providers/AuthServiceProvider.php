...
class AuthServiceProvider extends ServiceProvider
{
    ...
    protected $policies = [
        ...
        \App\Domains\Client\Models\ClientContact::class => \App\Policies\ContactPolicy::class,
        \App\Domains\Client\Models\Location::class => \App\Policies\LocationPolicy::class,
        \App\Domains\Ticket\Models\Ticket::class => \App\Policies\TicketPolicy::class,
        \App\Domains\Asset\Models\Asset::class => \App\Policies\AssetPolicy::class,
        \App\Domains\Core\Models\User::class => \App\Policies\UserPolicy::class,
        \App\Domains\Core\Models\Role::class => \App\Policies\RolePolicy::class,
        \App\Domains\Project\Models\Project::class => \App\Policies\ProjectPolicy::class,
        \App\Domains\Financial\Models\Invoice::class => \App\Policies\InvoicePolicy::class,
        \App\Domains\Financial\Models\Quote::class => \App\Policies\QuotePolicy::class,
        \App\Domains\Financial\Models\Recurring::class => \App\Policies\RecurringPolicy::class,
        \App\Domains\Client\Models\ClientITDocumentation::class => \App\Policies\ClientITDocumentationPolicy::class,
        \App\Domains\Product\Models\Product::class => \App\Policies\ProductPolicy::class,
        \App\Domains\Product\Models\ProductBundle::class => \App\Policies\ProductBundlePolicy::class,
