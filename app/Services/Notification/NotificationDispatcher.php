...
use App\Services\Notification\Contracts\NotificationDispatcherInterface;
...
class NotificationDispatcher implements NotificationDispatcherInterface
{
    ...
    {
        $this->registerChannel(new \App\Services\Notification\Channels\EmailChannel());
        $this->registerChannel(new \App\Services\Notification\Channels\SmsChannel());
        $this->registerChannel(new \App\Services\Notification\Channels\SlackChannel());
    }
    ...
    {
        $this->registerStrategy(new \App\Services\Notification\Strategies\TicketCreatedStrategy());
        $this->registerStrategy(new \App\Services\Notification\Strategies\TicketStatusChangedStrategy());
        $this->registerStrategy(new \App\Services\Notification\Strategies\SlaBreachStrategy());
    }
