...
class TicketsController extends Controller
{
    ...
    {
        $query = Ticket::with(['client', 'assignedTo', 'category', 'replies.user'])
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'data' => $ticket->load(['client', 'assignedTo', 'category', 'attachments']),
    ...
    public function update(Request $request, Ticket $ticket): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'data' => $ticket->fresh(['client', 'assignedTo', 'category']),
