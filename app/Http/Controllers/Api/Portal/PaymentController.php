...
use App\Services\PortalPaymentService;
...
class PaymentController extends PortalApiController
{
    ...
    public function __construct(PortalPaymentService $paymentService, \App\Services\ClientPortalService $portalService, \App\Services\PortalAuthService $authService)
    {
