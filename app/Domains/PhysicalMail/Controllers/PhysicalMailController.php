...
{
    private const VALIDATION_RULE_OPTIONAL_DATE = 'sometimes|date';
    ...
    public function index(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'date_from' => self::VALIDATION_RULE_OPTIONAL_DATE,
            'date_to' => self::VALIDATION_RULE_OPTIONAL_DATE,
    ...
    public function send(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'send_date' => self::VALIDATION_RULE_OPTIONAL_DATE,
        ]);
