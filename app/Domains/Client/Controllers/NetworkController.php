...
class NetworkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = $client->networks()->with('client');
        ...
        return view('clients.networks.index', compact('networks', 'client', 'providers', 'networkTypes'));
    }
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'ip_range' => self::VALIDATION_NULLABLE_STRING.'|max:100',
            'subnet_mask' => self::VALIDATION_NULLABLE_STRING.'|max:50',
            'gateway' => 'nullable|ip',
            'dns_servers' => self::VALIDATION_NULLABLE_STRING,
            'dhcp_range_start' => 'nullable|ip',
            'dhcp_range_end' => 'nullable|ip',
            'vlan_id' => 'nullable|integer|min:1|max:4094',
            'ssid' => self::VALIDATION_NULLABLE_STRING.'|max:255',
            'wifi_password' => self::VALIDATION_NULLABLE_STRING.'|max:255',
            'security_type' => 'nullable|in:'.implode(',', array_keys(ClientNetwork::getSecurityTypes())),
            'bandwidth' => self::VALIDATION_NULLABLE_STRING.'|max:100',
            'provider' => self::VALIDATION_NULLABLE_STRING.'|max:255',
            'circuit_id' => self::VALIDATION_NULLABLE_STRING.'|max:255',
            'static_routes' => self::VALIDATION_NULLABLE_STRING,
            'firewall_rules' => self::VALIDATION_NULLABLE_STRING,
            'vpn_config' => self::VALIDATION_NULLABLE_STRING,
            'monitoring_enabled' => 'boolean',
            'backup_config' => self::VALIDATION_NULLABLE_STRING,
            'is_active' => 'boolean',
            'location' => self::VALIDATION_NULLABLE_STRING.'|max:255',
            'equipment' => self::VALIDATION_NULLABLE_STRING,
