...
class CredentialController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'service_name' => self::NULLABLE_STRING.'|max:255',
            'username' => self::NULLABLE_STRING.'|max:255',
            'password' => self::NULLABLE_STRING.'|max:1000',
            'email' => 'nullable|email|max:255',
            'url' => 'nullable|url|max:500',
            'port' => 'nullable|integer|min:1|max:65535',
            'database_name' => self::NULLABLE_STRING.'|max:255',
            'connection_string' => self::NULLABLE_STRING.'|max:1000',
            'api_key' => self::NULLABLE_STRING.'|max:1000',
            'secret_key' => self::NULLABLE_STRING.'|max:1000',
            'certificate' => self::NULLABLE_STRING,
            'private_key' => self::NULLABLE_STRING,
            'public_key' => self::NULLABLE_STRING,
            'token' => self::NULLABLE_STRING.'|max:1000',
