...
{
    /**
     * Display a listing of all certificates (standalone view)
     */
    public function index(Request $request)
    {
        ...
        return view('clients.certificates.index', compact('certificates', 'clients', 'types', 'statuses', 'vendors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $certificate->tenant_id = auth()->user()->tenant_id;
        $certificate->save();
