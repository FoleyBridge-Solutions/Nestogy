...
class VendorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'contact_person' => self::NULLABLE_STRING.'|max:255',
            'email' => 'nullable|email|max:255',
            'phone' => self::NULLABLE_STRING.'|max:50',
            'website' => 'nullable|url|max:255',
            'address_line_1' => self::NULLABLE_STRING.'|max:255',
            'address_line_2' => self::NULLABLE_STRING.'|max:255',
            'city' => self::NULLABLE_STRING.'|max:100',
            'state' => self::NULLABLE_STRING.'|max:100',
            'zip_code' => self::NULLABLE_STRING.'|max:20',
            'country' => self::NULLABLE_STRING.'|max:100',
            'tax_id' => self::NULLABLE_STRING.'|max:50',
            'account_number' => self::NULLABLE_STRING.'|max:100',
            ...
            'currency' => self::NULLABLE_STRING.'|size:3',
            ...
            'average_response_time' => self::NULLABLE_STRING.'|max:100',
            ...
            'certifications' => self::NULLABLE_STRING,
            'insurance_info' => self::NULLABLE_STRING,
            'backup_contacts' => self::NULLABLE_STRING,
            'service_areas' => self::NULLABLE_STRING,
            'specializations' => self::NULLABLE_STRING,
