...
{
    /**
     * Display a listing of all vendors (standalone view)
     */
    public function index(Request $request)
    {
        ...
        return view('clients.vendors.index', compact('vendors', 'clients', 'vendorTypes', 'vendorCategories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('clients.vendors.standalone.index')
