...
{
    /**
     * Display a listing of all documents (standalone view)
     */
    public function index(Request $request)
    {
        ...
        return view('clients.documents.index', compact('documents', 'clients', 'categories'));
    }
    ...
    public function uploadVersion(Request $request, ClientDocument $document)
    {
        ...
        $newVersion->tenant_id = auth()->user()->tenant_id;
        $newVersion->save();
