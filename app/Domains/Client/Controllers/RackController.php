...
{
    /**
     * Display a listing of all racks (standalone view)
     */
    public function index(Request $request)
    {
        ...
        $locations = ClientRack::where('tenant_id', auth()->user()->tenant_id)
        ...
        return view('clients.racks.index', compact('racks', 'clients', 'statuses', 'locations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $rack->tenant_id = auth()->user()->tenant_id;
        $rack->save();
