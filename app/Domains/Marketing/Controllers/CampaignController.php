...
class CampaignController extends BaseResourceController
{
     ...
     */
    public function show(MarketingCampaign $campaign): View|JsonResponse
    {
     ...
     */
    public function update(Request $request, MarketingCampaign $campaign): JsonResponse|\Illuminate\Http\RedirectResponse
    {
        $this->authorize('update', $campaign);
     ...
     */
    public function destroy(MarketingCampaign $campaign): JsonResponse|\Illuminate\Http\RedirectResponse
    {
     ...
     * Pause the campaign.
     */
    public function pause(MarketingCampaign $campaign): JsonResponse|\Illuminate\Http\RedirectResponse
    {
        $this->authorize('update', $campaign);
     ...
     */
    public function complete(MarketingCampaign $campaign): JsonResponse|\Illuminate\Http\RedirectResponse
    {
        $this->authorize('update', $campaign);
     ...
     * Clone the campaign.
     */
    public function clone(MarketingCampaign $campaign): JsonResponse|\Illuminate\Http\RedirectResponse
    {
        $this->authorize('view', $campaign);
     ...
     */
    public function addSequence(Request $request, MarketingCampaign $campaign): JsonResponse
    {
        $this->authorize('update', $campaign);
     ...
     */
    public function enrollLeads(Request $request, MarketingCampaign $campaign): JsonResponse
    {
        $this->authorize('update', $campaign);
     ...
     */
    public function enrollContacts(Request $request, MarketingCampaign $campaign): JsonResponse
    {
        $this->authorize('update', $campaign);
     ...
     */
    public function sendTestEmail(Request $request, MarketingCampaign $campaign, CampaignSequence $sequence): JsonResponse
    {
        $this->authorize('update', $campaign);
