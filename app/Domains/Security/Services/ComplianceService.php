...
class ComplianceService
{
    ...
    protected function checkStateCompliance(Client $client): array
    {
        ...
        if (isset($stateRules['max_interest_rate'])) {
            $interestCheck = $this->checkInterestRateCompliance($client);
        ...
        if (isset($stateRules['wage_garnishment_limit'])) {
            $garnishmentCheck = $this->checkGarnishmentCompliance($client);
...
NESTOGY COLLECTIONS DEPARTMENT
    ...
    protected function checkInterestRateCompliance(Client $client): array
    {
        return ['violation' => false];
    }

    protected function checkGarnishmentCompliance(Client $client): array
    {
        return ['violation' => false];
    }
