...
class ContractController extends Controller
{
    ...
    public function edit(Contract $contract)
    {
        ...
        $draftStatus = array_search('Draft', array_column($contractStatuses, 'name'));
        $pendingReviewStatus = array_search('Pending Review', array_column($contractStatuses, 'name'));
        
        if (!in_array($contract->status, [$draftStatus, $pendingReviewStatus])) {
        ...
        return view('financial.contracts.edit', compact('contract', 'clients', 'templates', 'billingModels'));
    }
