...
class ContractAnalyticsService
{
    ...
    public function getTrendAnalysis(int $companyId, Carbon $startDate, Carbon $endDate): array
    {
        return [
            ...
            'client_acquisition_trend' => $this->getClientAcquisitionTrend($startDate, $endDate),
        ];
    }
    ...
    protected function getClientAcquisitionTrend(Carbon $startDate, Carbon $endDate): array
    {
        return [];
    }
}
