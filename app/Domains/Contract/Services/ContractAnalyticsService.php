...
class ContractAnalyticsService
{
    ...
    public function getPerformanceMetrics(int $companyId, Carbon $startDate, Carbon $endDate): array
    {
        ...
        return [
            ...
            'client_satisfaction' => $this->getClientSatisfactionMetrics($companyId, $endDate),
        ];
    }
    ...
    protected function getClientSatisfactionMetrics(int $companyId, Carbon $endDate): array
    {
        return [];
    }
