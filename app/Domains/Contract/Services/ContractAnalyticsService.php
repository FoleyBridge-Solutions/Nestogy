...
class ContractAnalyticsService
{
    ...
    public function getClientAnalytics(int $companyId, Carbon $startDate, Carbon $endDate): array
    {
        ...
        return [
            ...
            'client_acquisition_cost' => $this->getClientAcquisitionCost($startDate, $endDate),
        ];
    }
    ...
    protected function getClientAcquisitionCost(Carbon $startDate, Carbon $endDate): float
    {
        return 0;
    }
