...
class ContractAnalyticsService
{
    ...
    public function getPerformanceMetrics(int $companyId, Carbon $startDate, Carbon $endDate): array
    {
        ...
        return [
            ...
            'client_satisfaction' => $this->getClientSatisfactionMetrics($startDate, $endDate),
        ];
    }
    ...
    protected function getClientSatisfactionMetrics(Carbon $startDate, Carbon $endDate): array
    {
        return [];
    }
