...
class ContractGenerationService
{
    ...
    protected function generateDefaultTemplate(Contract $contract): string
    {
        ...
        $content .= "<p><strong>Date:</strong> " . now()->format(self::DEFAULT_DATE_FORMAT) . "</p>\n\n";
        ...
        $content .= "<p><strong>Start Date:</strong> " . $contract->start_date->format(self::DEFAULT_DATE_FORMAT) . "</p>\n";
        if ($contract->end_date) {
            $content .= "<p><strong>End Date:</strong> " . $contract->end_date->format(self::DEFAULT_DATE_FORMAT) . "</p>\n";
        }
