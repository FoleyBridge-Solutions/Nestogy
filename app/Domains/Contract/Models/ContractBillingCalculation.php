...
class ContractBillingCalculation extends Model
{
    ...
    protected $casts = [
        ...
        'base_contract_amount' => self::CAST_DECIMAL_2,
        'fixed_monthly_charges' => self::CAST_DECIMAL_2,
        ...
        'asset_billing_total' => self::CAST_DECIMAL_2,
        ...
        'contact_billing_total' => self::CAST_DECIMAL_2,
        'contact_billing_breakdown' => 'array',
        'total_tickets_created' => 'integer',
        'total_support_hours' => self::CAST_DECIMAL_2,
        'total_incidents_resolved' => 'integer',
        'usage_charges' => self::CAST_DECIMAL_2,
        'usage_breakdown' => 'array',
        'service_charges' => 'array',
        'monitoring_charges' => self::CAST_DECIMAL_2,
        'backup_charges' => self::CAST_DECIMAL_2,
        'security_charges' => self::CAST_DECIMAL_2,
        'maintenance_charges' => self::CAST_DECIMAL_2,
        'additional_service_charges' => 'array',
        'discounts_applied' => self::CAST_DECIMAL_2,
        'surcharges_applied' => self::CAST_DECIMAL_2,
        'pricing_adjustments' => 'array',
        'tax_amount' => self::CAST_DECIMAL_2,
        'tax_rate' => 'decimal:4',
        'subtotal_before_tax' => self::CAST_DECIMAL_2,
        'total_amount' => self::CAST_DECIMAL_2,
        ...
        'previous_period_amount' => self::CAST_DECIMAL_2,
        'amount_variance' => self::CAST_DECIMAL_2,
        'variance_percentage' => self::CAST_DECIMAL_2,
        'variance_analysis' => 'array',
        'projected_next_period' => self::CAST_DECIMAL_2,
        'forecasting_data' => 'array',
        'trend_analysis' => 'array',
        'has_disputes' => 'boolean',
        'dispute_details' => 'array',
        'disputed_amount' => self::CAST_DECIMAL_2,
