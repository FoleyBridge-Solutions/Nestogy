...
class CompanySettingsService extends BaseSettingsService
{
    ...
    private const HEX_COLOR_VALIDATION = 'nullable|string|regex:/^#[0-9A-Fa-f]{6}$/';
        ...
        switch ($category) {
            ...
            case 'branding':
                return [
                    ...
                    'accent_color' => self::HEX_COLOR_VALIDATION,
                    'accent_content_color' => self::HEX_COLOR_VALIDATION,
                    'accent_foreground_color' => self::HEX_COLOR_VALIDATION,
