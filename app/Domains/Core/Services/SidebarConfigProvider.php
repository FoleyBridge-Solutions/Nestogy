...
{
    private const LABEL_PHYSICAL_MAIL = 'Physical Mail';
    ...
    protected function getPhysicalMailConfig(): array
    {
        ...
        return [
            'title' => self::LABEL_PHYSICAL_MAIL,
            'icon' => 'paper-airplane',
            'sections' => [
                [
                    'type' => 'primary',
            ...
            'sections' => [
                ...
                [
                    ...
                    'items' => [
                        ...
                        ['name' => self::LABEL_PHYSICAL_MAIL, 'route' => 'settings.category.show', 'params' => ['domain' => 'communication', 'category' => 'physical-mail'], 'icon' => 'paper-airplane', 'key' => 'physical-mail'],
