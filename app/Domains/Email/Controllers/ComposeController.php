...
{
    private const ATTACHMENT_VALIDATION_RULE = 'attachments.*';
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            self::ATTACHMENT_VALIDATION_RULE => 'file|max:25600', // 25MB max
        ]);
    ...
    public function sendReply(Request $request, EmailMessage $message)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'signature_id' => 'nullable|exists:email_signatures,id',
            'attachments' => 'nullable|array',
            self::ATTACHMENT_VALIDATION_RULE => 'file|max:25600',
        ]);
    ...
    {
        $attachments = $this->processUploadedAttachments($request);
    ...
    private function processUploadedAttachments(Request $request): array
    {
        $attachments = [];
