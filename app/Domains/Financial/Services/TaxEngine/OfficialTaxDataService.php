...
{
    protected const TEXAS_STATE_NAME = 'TEXAS STATE';
    ...
    protected function downloadCountyAddressFile(string $countyFips, string $quarter): array
    {
        try {
            ...
            $targetFile = $this->findTargetCountyFile($fileList, $countyFips, $quarter);
    ...
    protected function findTargetCountyFile(array $fileList, string $countyFips, string $quarter): array
    {
