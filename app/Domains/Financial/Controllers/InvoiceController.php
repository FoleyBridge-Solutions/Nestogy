...
class InvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('financial.invoices.index', compact('invoices', 'totals'));
    }
    ...
    public function create(Request $request)
    {
        ...
        // Handle pre-selected client or ticket
        $clientId = $request->get('client_id');
        $selectedClient = $clientId ? Client::findOrFail($clientId) : null;
        $ticketId = $request->get('ticket_id');
        $ticket = $ticketId ? Ticket::findOrFail($ticketId) : null;
        
        return view('financial.invoices.create', compact('clients', 'categories', 'selectedClient', 'ticket'));
    }
