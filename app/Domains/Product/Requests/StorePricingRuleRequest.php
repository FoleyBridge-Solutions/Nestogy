...
class StorePricingRuleRequest extends FormRequest
{
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            $this->validateRuleTypeRequirements($validator);
        });
    }

    protected function validateRuleTypeRequirements($validator): void
    {
        $ruleType = $this->input('rule_type');

        match ($ruleType) {
            'percentage_discount' => $this->validatePercentageDiscount($validator),
            'fixed_discount' => $this->validateFixedDiscount($validator),
            'fixed_price' => $this->validateFixedPrice($validator),
            'bulk_pricing' => $this->validateBulkPricing($validator),
            'buy_x_get_y' => $this->validateBuyXGetY($validator),
            default => null,
        };
    }

    protected function validatePercentageDiscount($validator): void
    {
    ...
    protected function validateFixedDiscount($validator): void
    {
    ...
    protected function validateFixedPrice($validator): void
    {
    ...
    protected function validateBulkPricing($validator): void
    {
    ...
    protected function validateBuyXGetY($validator): void
    {
