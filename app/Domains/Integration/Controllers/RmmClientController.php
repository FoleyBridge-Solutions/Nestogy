...
class RmmClientController extends Controller
{
    ...
    public function getNestogyClients(Request $request): JsonResponse
    {
        return response()->json([
            'success' => true,
    ...
    public function getRmmClients(Request $request): JsonResponse
    {
        $integration = RmmIntegration::where('company_id', auth()->user()->company_id)->first();
        if (! $integration) {
            return response()->json(['success' => false, 'message' => 'No RMM integration found'], 404);
    ...
    public function storeClientMapping(Request $request): JsonResponse
    {
        $integration = RmmIntegration::where('company_id', auth()->user()->company_id)->first();
        if (! $integration) {
            return response()->json(['success' => false, 'message' => 'No RMM integration found'], 404);
    ...
    public function destroyClientMapping(Request $request, $mappingId): JsonResponse
    {
