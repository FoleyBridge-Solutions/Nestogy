...
const INTEGRATION_ROUTE = 'integrations/{integration}';
...
Route::middleware(['auth', 'verified', 'company'])->prefix('api/rmm')->name('api.rmm.')->group(function () {
    ...
    Route::get(INTEGRATION_ROUTE, [App\Domains\Integration\Controllers\RmmIntegrationsController::class, 'show'])->name('integrations.show');
    Route::put(INTEGRATION_ROUTE, [App\Domains\Integration\Controllers\RmmIntegrationsController::class, 'update'])->name('integrations.update');
    Route::delete(INTEGRATION_ROUTE, [App\Domains\Integration\Controllers\RmmIntegrationsController::class, 'destroy'])->name('integrations.destroy');
