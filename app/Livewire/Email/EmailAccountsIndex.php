...
class EmailAccountsIndex extends Component
{
    ...
    public function syncAccount($accountId)
    {
        try {
            ...
            if ($account->user_id !== Auth::id()) {
                throw new EmailPermissionException('sync email account', ['account_id' => $accountId]);
            }
    ...
    public function testConnection($accountId)
    {
        try {
            ...
            if ($account->user_id !== Auth::id()) {
                throw new EmailPermissionException('test email account connection', ['account_id' => $accountId]);
            }
    ...
    public function setDefault($accountId)
    {
        try {
            ...
            if ($account->user_id !== Auth::id()) {
                throw new EmailPermissionException('set default email account', ['account_id' => $accountId]);
            }
    ...
    public function deleteAccount()
    {
        try {
            ...
            if ($this->accountToDelete->user_id !== Auth::id()) {
                throw new EmailPermissionException('delete email account', ['account_id' => $this->accountToDelete->id]);
            }
