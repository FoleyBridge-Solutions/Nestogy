    ...
    protected function validateCompanyInfo(): bool
    {
        try {
            $this->validate([
                ...
                'company_address' => self::NULLABLE_STRING_MAX_255,
    ...
    protected function validateEmailConfig(): bool
    {
        ...
        try {
            $this->validate([
                ...
                'smtp_username' => self::NULLABLE_STRING_MAX_255,
                'smtp_password' => self::NULLABLE_STRING_MAX_255,
                'mail_from_email' => 'nullable|email|max:255',
                'mail_from_name' => self::NULLABLE_STRING_MAX_255,
            ], [
