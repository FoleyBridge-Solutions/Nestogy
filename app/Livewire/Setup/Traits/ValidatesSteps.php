...
{
    private const VALIDATION_NULLABLE_STRING_MAX_20 = 'nullable|string|max:20';
    ...
    protected function validateCompanyInfo(): bool
    {
        try {
            $this->validate([
                ...
                'company_phone' => self::VALIDATION_NULLABLE_STRING_MAX_20,
                'company_address' => 'nullable|string|max:255',
                'company_city' => 'nullable|string|max:100',
                'company_state' => 'nullable|string|max:100',
                'company_zip' => self::VALIDATION_NULLABLE_STRING_MAX_20,
    ...
    protected function validateSystemPrefs(): bool
    {
        try {
            $this->validate([
                ...
                'date_format' => self::VALIDATION_NULLABLE_STRING_MAX_20,
