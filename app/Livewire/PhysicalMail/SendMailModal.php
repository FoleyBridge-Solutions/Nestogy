...
class SendMailModal extends Component
{
    ...
    protected $rules = [
        'recipientName' => self::VALIDATION_REQUIRED_STRING_255,
        'recipientCompany' => 'nullable|string|max:255',
        'recipientAddressLine1' => self::VALIDATION_REQUIRED_STRING_255,
        'recipientAddressLine2' => 'nullable|string|max:255',
        'recipientCity' => self::VALIDATION_REQUIRED_STRING_255,
