...
{
    private const MAX_PHONE_LENGTH = 'max:50';
    ...
    protected function rules()
    {
        $rules = [
            ...
            'phone' => ['nullable', 'string', self::MAX_PHONE_LENGTH],
            'extension' => ['nullable', 'string', 'max:20'],
            'mobile' => ['nullable', 'string', self::MAX_PHONE_LENGTH],
        ...
        if ($this->activeTab === 'professional' || $this->activeTab === 'all') {
            $rules += [
                ...
                'language' => ['nullable', 'string', self::MAX_PHONE_LENGTH],
                'do_not_disturb' => ['boolean'],
                'marketing_opt_in' => ['boolean'],
                'linkedin_url' => ['nullable', 'url', 'max:255'],
                'assistant_name' => ['nullable', 'string', 'max:255'],
                'assistant_email' => ['nullable', 'email', 'max:255'],
                'assistant_phone' => ['nullable', 'string', self::MAX_PHONE_LENGTH],
