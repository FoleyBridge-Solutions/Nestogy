...
class EditContact extends Component
{
    ...
    protected function rules()
    {
        $rules = [
            ...
            'title' => ['nullable', 'string', self::MAX_STRING_LENGTH],
            'email' => ['nullable', 'string', 'email', self::MAX_STRING_LENGTH],
            'phone' => ['nullable', 'string', 'max:50'],
            'extension' => ['nullable', 'string', 'max:20'],
            'mobile' => ['nullable', 'string', 'max:50'],
            'department' => ['nullable', 'string', self::MAX_STRING_LENGTH],
            'role' => ['nullable', 'string', self::MAX_STRING_LENGTH],
            // Contact Type
            'primary' => ['boolean'],
            'billing' => ['boolean'],
            'technical' => ['boolean'],
        ...
        if ($this->activeTab === 'professional' || $this->activeTab === 'all') {
            $rules += [
                ...
                'linkedin_url' => ['nullable', 'url', self::MAX_STRING_LENGTH],
                'assistant_name' => ['nullable', 'string', self::MAX_STRING_LENGTH],
                'assistant_email' => ['nullable', 'email', self::MAX_STRING_LENGTH],
        ...
        if ($this->activeTab === 'extended' || $this->activeTab === 'all') {
            $rules += [
                ...
                'website' => ['nullable', 'url', self::MAX_STRING_LENGTH],
                'twitter_handle' => ['nullable', 'string', 'max:100'],
                'facebook_url' => ['nullable', 'url', self::MAX_STRING_LENGTH],
                'instagram_handle' => ['nullable', 'string', 'max:100'],
                'company_blog' => ['nullable', 'url', self::MAX_STRING_LENGTH],
            ];
        }
