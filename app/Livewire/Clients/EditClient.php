...
class EditClient extends Component
{
    ...
    public function rules()
    {
        return [
            ...
            'hourly_rate' => self::VALIDATION_NULLABLE_NUMERIC_MIN_ZERO,
            'rate' => self::VALIDATION_NULLABLE_NUMERIC_MIN_ZERO,
            ...
            'custom_standard_rate' => self::VALIDATION_NULLABLE_NUMERIC_MIN_ZERO,
            'custom_after_hours_rate' => self::VALIDATION_NULLABLE_NUMERIC_MIN_ZERO,
            'custom_emergency_rate' => self::VALIDATION_NULLABLE_NUMERIC_MIN_ZERO,
            'custom_weekend_rate' => self::VALIDATION_NULLABLE_NUMERIC_MIN_ZERO,
            'custom_holiday_rate' => self::VALIDATION_NULLABLE_NUMERIC_MIN_ZERO,
