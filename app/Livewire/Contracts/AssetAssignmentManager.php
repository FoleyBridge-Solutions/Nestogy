...
class AssetAssignmentManager extends Component
{
    ...
    private const VALIDATION_REQUIRED_ARRAY_MIN_ONE = 'required|array|min:1';
    ...
    {
        $this->validate([
            'selectedAssetIds' => self::VALIDATION_REQUIRED_ARRAY_MIN_ONE,
            'assigned_services' => self::VALIDATION_REQUIRED_ARRAY_MIN_ONE,
