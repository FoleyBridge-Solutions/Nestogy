...
$protectedMiddleware = ['auth:sanctum', 'company', 'throttle:120,1'];

// Dashboard API
Route::middleware($protectedMiddleware)->prefix('dashboard')->name('api.dashboard.')->group(function () {
...
Route::middleware($protectedMiddleware)->prefix('clients')->name('api.clients.')->group(function () {
...
// Ticket System API
Route::middleware($protectedMiddleware)->prefix('tickets')->name('api.tickets.')->group(function () {
...
Route::middleware($protectedMiddleware)->prefix('assets')->name('api.assets.')->group(function () {
...
Route::middleware($protectedMiddleware)->prefix('financial')->name('api.financial.')->group(function () {
...
Route::middleware($protectedMiddleware)->prefix('products')->name('api.products.')->group(function () {
...
Route::middleware($protectedMiddleware)->prefix('services')->name('api.services.')->group(function () {
...
Route::middleware($protectedMiddleware)->prefix('bundles')->name('api.bundles.')->group(function () {
...
Route::middleware($protectedMiddleware)->prefix('promo-codes')->name('api.promo-codes.')->group(function () {
    Route::post('validate', [App\Domains\Product\Controllers\Api\ProductController::class, 'applyPromo'])->name('validate');
});

// Project Management API
Route::middleware($protectedMiddleware)->prefix('projects')->name('api.projects.')->group(function () {
...
// Reports API
Route::middleware($protectedMiddleware)->prefix('reports')->name('api.reports.')->group(function () {
...
Route::middleware($protectedMiddleware)->prefix('documentation-templates')->name('api.documentation-templates.')->group(function () {
...
// User Management API
Route::middleware($protectedMiddleware)->prefix('users')->name('api.users.')->group(function () {
...
// File Management API
Route::middleware($protectedMiddleware)->prefix('files')->name('api.files.')->group(function () {
...
// Navigation API
Route::middleware($protectedMiddleware)->prefix('navigation')->name('api.navigation.')->group(function () {
...
Route::middleware($protectedMiddleware)->prefix('shortcuts')->name('api.shortcuts.')->group(function () {
...
// Categories API
Route::middleware($protectedMiddleware)->prefix('categories')->name('api.categories.')->group(function () {
    Route::get('/', [App\Domains\Product\Controllers\Api\CategoriesController::class, 'index'])->name('index');
});

// Search API
Route::middleware($protectedMiddleware)->prefix('search')->name('api.search.')->group(function () {
...
Route::middleware(array_merge($protectedMiddleware, ['role:admin']))->prefix('settings')->name('api.settings.')->group(function () {
...
Route::middleware(array_merge($protectedMiddleware, ['role:admin']))->prefix('integrations')->name('api.integrations.')->group(function () {
...
Route::middleware($protectedMiddleware)->prefix('rmm')->name('api.rmm.')->group(function () {
