...
if (isset($_POST['add_contact'])) {
    ...
    require_once '/var/www/nestogy/includes/post/models/contact_model.php';
...
if (isset($_POST['edit_contact'])) {
    ...
    if (!file_exists("/var/www/nestogy/uploads/clients/$client_id")) {
        mkdir("/var/www/nestogy/uploads/clients/$client_id");
    }
