...
CREATE TABLE `accounts` (
  ...
  CONSTRAINT `fk_account_type` FOREIGN KEY (`account_type`) REFERENCES `account_types` (`account_type_id`)
...
CREATE TABLE `assets` (
  ...
  KEY `ft_client_id` (`asset_client_id`),
  KEY `fk_vendor_id` (`asset_vendor_id`),
  KEY `fk_location_id` (`asset_location_id`),
  KEY `fk_contact_id` (`asset_contact_id`),
  KEY `fk_network_id` (`asset_network_id`),
  CONSTRAINT `fk_contact_id` FOREIGN KEY (`asset_contact_id`) REFERENCES `contacts` (`contact_id`),
  CONSTRAINT `fk_location_id` FOREIGN KEY (`asset_location_id`) REFERENCES `locations` (`location_id`),
  CONSTRAINT `fk_network_id` FOREIGN KEY (`asset_network_id`) REFERENCES `networks` (`network_id`),
  CONSTRAINT `fk_vendor_id` FOREIGN KEY (`asset_vendor_id`) REFERENCES `vendors` (`vendor_id`),
  CONSTRAINT `ft_client_id` FOREIGN KEY (`asset_client_id`) REFERENCES `clients` (`client_id`)
...
CREATE TABLE `certificates` (
  ...
  `certificate_client_id` int(11) DEFAULT NULL,
...
CREATE TABLE `contacts` (
  ...
  KEY `fk_client` (`contact_client_id`),
  CONSTRAINT `fk_client` FOREIGN KEY (`contact_client_id`) REFERENCES `clients` (`client_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=7908 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12531 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `locations` (
  ...
  KEY `fk_location_contact` (`location_contact_id`),
  KEY `fk_location_client` (`location_client_id`),
  CONSTRAINT `fk_location_client` FOREIGN KEY (`location_client_id`) REFERENCES `clients` (`client_id`),
  CONSTRAINT `fk_location_contact` FOREIGN KEY (`location_contact_id`) REFERENCES `contacts` (`contact_id`)
...
CREATE TABLE `logs` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=195723 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1889 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `products` (
  ...
  `product_is_service` int(1) DEFAULT 0,
  `product_subscription` int(11) DEFAULT NULL,
...
CREATE TABLE `subscriptions` (
  ...
  `subscription_product_id` varchar(255) NOT NULL COMMENT 'Subscription Product ID',
  `subscription_client_id` int(11) NOT NULL COMMENT 'Subscription Client ID',
  `subscription_product_quantity` int(11) NOT NULL COMMENT 'Subscription Product Quantity',
  `subscription_created` datetime DEFAULT current_timestamp(),
  `subscription_updated` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
) ENGINE=InnoDB AUTO_INCREMENT=3457 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7298 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_employees` (
  ...
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='User Employees Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-08-16 13:16:43
