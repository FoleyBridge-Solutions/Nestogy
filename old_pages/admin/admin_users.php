                ...
                while ($row = mysqli_fetch_array($sql)) {
                    ...
                    <tr>
                        <td class="text-center">
                            <a class="text-dark" href="#" <?php if ($user_id !== $user_id) {   // Prevent modifying self ?> data-bs-toggle="modal" data-bs-target="#editUserModal<?= $user_id; ?>" <?php } ?>>
                        ...
                        <td><?= $last_login; ?></td>
                        <td>
                            <?php if ($user_id !== $user_id) {   // Prevent modifying self ?>
