                            ...
                            <div class="form-group">
                                <h4>
                                    ...
                                    <b id="inputted_amount" class="text-success">
                                        <?= numfmt_format_currency($currency_format, $payment_received, $company_currency) ?>
                                    </b>
                                </h4>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <input type="number" name="payment_amount" id="payment_amount" class="form-control" step="0.01" min="0.01" placeholder="<?= numfmt_format_currency($currency_format, $payment_received, $company_currency) ?>">
                            </div>
                        </div>
                    </div>
                </form>
