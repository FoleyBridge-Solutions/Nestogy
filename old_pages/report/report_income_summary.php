        ...
        <div class="card-datatable table-responsive container-fluid  pt-0">            <table id=responsive class="responsive table table-striped">
                ...
                while ($row = mysqli_fetch_array($sql_categories)) {
                    ...
                    <tr>
                        ...
                        for($month = 1; $month<=12; $month++) {
                            ...
                            ?>
                            <td class="text-right"><?= numfmt_format_currency($currency_format, $payment_amount_for_month, $company_currency); ?></td>
                        ...
                        <td class="text-right text-bold"><?= numfmt_format_currency($currency_format, $total_payment_for_all_months, $company_currency); ?></td>
                    </tr>
                ...
                <tr>
                    ...
                    for($month = 1; $month<=12; $month++) {
                        ...
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $payment_total_amount_for_month, $company_currency); ?></th>
                        <?php
                    ...
                    <th class="text-right"><?= numfmt_format_currency($currency_format, $total_payment_for_all_months, $company_currency); ?></th>
                </tr>
                </tbody>
            </table>
        </div>
