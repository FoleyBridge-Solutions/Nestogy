            ...
            <div class="card-datatable table-responsive container-fluid  pt-0">                <table id=responsive class="responsive table table-sm">
                    ...
                    while ($row = mysqli_fetch_array($sql_categories_income)) {
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?= numfmt_format_currency($currency_format, $payment_amount_for_quarter_one, $company_currency); ?></td>
                            ...
                            <td class="text-right"><?= numfmt_format_currency($currency_format, $payment_amount_for_quarter_two, $company_currency); ?></td>
                            ...
                            <td class="text-right"><?= numfmt_format_currency($currency_format, $payment_amount_for_quarter_three, $company_currency); ?></td>
                            ...
                            <td class="text-right"><?= numfmt_format_currency($currency_format, $payment_amount_for_quarter_four, $company_currency); ?></td>

                            <td class="text-right"><?= numfmt_format_currency($currency_format, $total_payments_for_all_four_quarters, $company_currency); ?></td>
                        </tr>
                    ...
                    <tr>
                        ...
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $payment_total_amount_for_quarter_one, $company_currency); ?></th>
                        ...
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $payment_total_amount_for_quarter_two, $company_currency); ?></th>
                        ...
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $payment_total_amount_for_quarter_three, $company_currency); ?></th>
                        ...
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $payment_total_amount_for_quarter_four, $company_currency); ?></th>

                        <th class="text-right"><?= numfmt_format_currency($currency_format, $total_payments_for_all_four_quarters, $company_currency); ?></th>
                    </tr>
                    ...
                    while ($row = mysqli_fetch_array($sql_categories_expense)) {
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?= numfmt_format_currency($currency_format, $expense_amount_for_quarter_one, $company_currency); ?></td>
                            ...
                            <td class="text-right"><?= numfmt_format_currency($currency_format, $expense_amount_for_quarter_two, $company_currency); ?></td>
                            ...
                            <td class="text-right"><?= numfmt_format_currency($currency_format, $expense_amount_for_quarter_three, $company_currency); ?></td>
                            ...
                            <td class="text-right"><?= numfmt_format_currency($currency_format, $expense_amount_for_quarter_four, $company_currency); ?></td>

                            <td class="text-right"><?= numfmt_format_currency($currency_format, $total_expenses_for_all_four_quarters, $company_currency); ?></td>
                        </tr>
                    ...
                    <tr>
                        ...
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $expense_total_amount_for_quarter_one, $company_currency); ?></th>
                        ...
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $expense_amount_for_quarter_two, $company_currency); ?></th>
                        ...
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $expense_total_amount_for_quarter_three, $company_currency); ?></th>
                        ...
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $expense_total_amount_for_quarter_four, $company_currency); ?></th>

                        <th class="text-right"><?= numfmt_format_currency($currency_format, $total_expenses_for_all_four_quarters, $company_currency); ?></th>
                    </tr>
                    <tr>
                        <?php
                        ...
                        <th>Net Profit</th>
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $net_profit_quarter_one, $company_currency); ?></th>
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $net_profit_quarter_two, $company_currency); ?></th>
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $net_profit_quarter_three, $company_currency); ?></th>
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $net_profit_quarter_four, $company_currency); ?></th>
                        <th class="text-right"><?= numfmt_format_currency($currency_format, $net_profit_year, $company_currency); ?></th>
                    </tr>
                    </tbody>
                </table>
            </div>
