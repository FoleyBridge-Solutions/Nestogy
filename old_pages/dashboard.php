...
if (isset($_GET['enable_financial'])) {
    ...
    mysqli_query($mysqli, "UPDATE user_settings SET user_config_dashboard_financial_enable = $enable_financial WHERE user_id = $user_id");
}

if (isset($_GET['enable_technical'])) {
    $enable_technical = intval($_GET['enable_technical']);
    mysqli_query($mysqli, "UPDATE user_settings SET user_config_dashboard_technical_enable = $enable_technical WHERE user_id = $user_id");
}

// Fetch User Dashboard Settings
$sql_user_dashboard_settings = mysqli_query($mysqli, "SELECT * FROM user_settings WHERE user_id = $user_id");
...
<div class="card card-body">
    <form class="form-inline">
        ...
        <?php if ($user_role >= 2 && $config_module_enable_ticketing == 1) { ?>
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-12">
            ...
            <a class="small-box bg-primary" href="payments.php?dtf=<?= $year; ?>-01-01&dtt=<?= $year; ?>-12-31">
                <div class="inner">
                    <h3><?= numfmt_format_currency($currency_format, $total_income, "$company_currency"); ?></h3>
                    <p>Income</p>
                    <hr>
                    <small>Receivables: <?= numfmt_format_currency($currency_format, $receivables, "$company_currency"); ?></h3></small>
                </div>
                <div class="icon">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            ...
            <a class="small-box bg-danger" href="expenses.php?dtf=<?= $year; ?>-01-01&dtt=<?= $year; ?>-12-31">
                <div class="inner">
                    <h3><?= numfmt_format_currency($currency_format, $total_expenses, "$company_currency"); ?></h3>
                    <p>Expenses</p>
                </div>
                <div class="icon">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            ...
            <a class="small-box bg-success" href="report_profit_loss.php">
                <div class="inner">
                    <h3><?= numfmt_format_currency($currency_format, $profit, "$company_currency"); ?></h3>
                    <p>Profit</p>
                </div>
                <div class="icon">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            ...
            <a class="small-box bg-info" href="report_recurring_by_client.php">
                <div class="inner">
                    <h3><?= numfmt_format_currency($currency_format, $recurring_monthly_total, "$company_currency"); ?></h3>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            ...
            <a class="small-box bg-pink" href="report_expense_by_vendor.php">
                <div class="inner">
                    <h3><?= numfmt_format_currency($currency_format, $recurring_expense_monthly_total, "$company_currency"); ?></h3>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    ?>
                                    <td class="text-right"><?= numfmt_format_currency($currency_format, $balance, "$company_currency"); ?></td>
                                </tr>
                            <?php
                            }
                            ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-right"><?= numfmt_format_currency($currency_format, $payment_amount, "$company_currency"); ?></td>
                                </tr>
                            <?php
                            }
                            ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $vendor_name; ?></td>
                                    <td><?= $category_name; ?></td>
                                    <td class="text-right"><?= numfmt_format_currency($currency_format, $expense_amount, "$company_currency"); ?></td>
                                </tr>
                            <?php
                            }
                            ?>
